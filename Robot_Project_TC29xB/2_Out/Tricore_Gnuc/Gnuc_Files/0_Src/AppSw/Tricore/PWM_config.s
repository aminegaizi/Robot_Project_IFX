...
.section .text.PWM3_config,"ax",@progbits
	.align 1
	.global	PWM3_config
	.type	PWM3_config, @function
PWM3_config:
.LFB277:
	.loc 1 101 0
	sub.a	%SP, 24
.LCFI2:
	...
	movh.a	%a2, hi:gtm
	ld.a	%a5, [%a2] lo:gtm
	movh.a	%a13, hi:Timer3Config
	lea	%a15, [%a13] lo:Timer3Config
	mov.aa	%a4, %a15
	call	IfxGtm_Tom_Timer_initConfig
.LVL8:
	.loc 1 111 0
...
.LVL11:
.LFE277:
	.size	PWM3_config, .-PWM3_config
.section .text.PWM4_config,"ax",@progbits
	.align 1
	.global	PWM4_config
	.type	PWM4_config, @function
PWM4_config:
.LFB278:
	.loc 1 132 0
	sub.a	%SP, 24
.LCFI3:
	...
	movh.a	%a2, hi:gtm
	ld.a	%a5, [%a2] lo:gtm
	movh.a	%a13, hi:Timer4Config
	lea	%a15, [%a13] lo:Timer4Config
	mov.aa	%a4, %a15
	call	IfxGtm_Tom_Timer_initConfig
.LVL12:
	.loc 1 142 0
...
gtm:
	.word	-267386880
	.global	Timer4Config
.section .bss.Timer4Config,"aw",@nobits
	.align 2
	.type	Timer4Config, @object
	.size	Timer4Config, 52
Timer4Config:
	.zero	52
	.global	Timer3Config
.section .bss.Timer3Config,"aw",@nobits
	.align 2
	.type	Timer3Config, @object
	.size	Timer3Config, 52
Timer3Config:
	.zero	52
	.global	Timer2Config
