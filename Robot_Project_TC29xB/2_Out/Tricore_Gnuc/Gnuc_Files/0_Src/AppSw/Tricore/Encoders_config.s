...
.LFB278:
	.loc 1 51 0
	.loc 1 52 0
	movh.a	%a15, hi:interrupt2_counter
	ld.w	%d15, [%a15] lo:interrupt2_counter
	add	%d15, 1
	st.w	[%a15] lo:interrupt2_counter, %d15
	rslcx
	rfe
.LFE278:
...
.LFB279:
	.loc 1 61 0
	.loc 1 62 0
	movh.a	%a15, hi:interrupt3_counter
	ld.w	%d15, [%a15] lo:interrupt3_counter
	add	%d15, 1
	st.w	[%a15] lo:interrupt3_counter, %d15
	rslcx
	rfe
.LFE279:
	.size	ISR_ENCODER_R, .-ISR_ENCODER_R
	.global	interrupt3_counter
.section .bss.interrupt3_counter,"aw",@nobits
	.align 2
	.type	interrupt3_counter, @object
	.size	interrupt3_counter, 4
interrupt3_counter:
	.zero	4
	.global	interrupt2_counter
.section .bss.interrupt2_counter,"aw",@nobits
	.align 2
	.type	interrupt2_counter, @object
	.size	interrupt2_counter, 4
interrupt2_counter:
	.zero	4
