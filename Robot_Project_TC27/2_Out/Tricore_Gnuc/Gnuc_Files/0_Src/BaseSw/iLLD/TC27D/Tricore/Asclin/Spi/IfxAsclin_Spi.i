# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Spi/IfxAsclin_Spi.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Spi/IfxAsclin_Spi.c"
# 29 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Spi/IfxAsclin_Spi.c"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Spi/IfxAsclin_Spi.h" 1
# 204 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Spi/IfxAsclin_Spi.h"
...
# 205 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Spi/IfxAsclin_Spi.h" 2
...
# 227 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Spi/IfxAsclin_Spi.h"
typedef struct
{
    float32 baudrate;
    uint16 prescaler;
...
{
    Ifx_ASCLIN *asclin;
    IfxAsclin_Spi_ErrorFlags errorFlags;
    IfxAsclin_Spi_Job txJob;
    IfxAsclin_Spi_Job rxJob;
...
typedef struct
{
    ...
    IfxAsclin_Spi_InputOutputControl inputOutput;
    IfxAsclin_Spi_Baudrate baudrate;
    IfxAsclin_Spi_BitSamplingControl bitSampling;
    IfxAsclin_Spi_FrameControl frame;
    IfxAsclin_DataLength dataLength;
    IfxAsclin_Spi_FifoControl fifo;
    IfxAsclin_Spi_InterruptConfig interrupt;
    const IfxAsclin_Spi_Pins *pins;
    IfxAsclin_ClockSource clockSource;
} IfxAsclin_Spi_Config;
# 362 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Spi/IfxAsclin_Spi.h"
extern void IfxAsclin_Spi_disableModule(IfxAsclin_Spi *asclin);
# 372 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Spi/IfxAsclin_Spi.h"
extern IfxAsclin_Status IfxAsclin_Spi_initModule(IfxAsclin_Spi *asclin, const IfxAsclin_Spi_Config *config);
# 382 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Spi/IfxAsclin_Spi.h"
extern void IfxAsclin_Spi_initModuleConfig(IfxAsclin_Spi_Config *config, Ifx_ASCLIN *asclin);
# 400 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Spi/IfxAsclin_Spi.h"
extern void IfxAsclin_Spi_isrError(IfxAsclin_Spi *asclin);





extern void IfxAsclin_Spi_isrReceive(IfxAsclin_Spi *asclin);





extern void IfxAsclin_Spi_isrTransmit(IfxAsclin_Spi *asclin);
# 433 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Spi/IfxAsclin_Spi.h"
extern IfxAsclin_Spi_Status IfxAsclin_Spi_exchange(IfxAsclin_Spi *asclin, void *src, void *dest, uint32 count);





extern void IfxAsclin_Spi_read(IfxAsclin_Spi *asclin);





extern void IfxAsclin_Spi_write(IfxAsclin_Spi *asclin);
# 457 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Spi/IfxAsclin_Spi.h"
extern IfxAsclin_Spi_Status IfxAsclin_Spi_getStatus(IfxAsclin_Spi *asclin);
# 30 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Spi/IfxAsclin_Spi.c" 2
# 39 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Spi/IfxAsclin_Spi.c"
static IfxAsclin_Spi_Status IfxAsclin_Spi_lock(IfxAsclin_Spi *asclin);





static void IfxAsclin_Spi_unlock(IfxAsclin_Spi *asclin);
...
IfxAsclin_Spi_Status IfxAsclin_Spi_exchange(IfxAsclin_Spi *asclin, void *src, void *dest, uint32 count)
{
    ...
    {
        asclin->transferInProgress = 1;
        asclin->txJob.data = src;
        asclin->txJob.pending = count;
        asclin->rxJob.data = dest;
        asclin->rxJob.pending = count;
...
IfxAsclin_Status IfxAsclin_Spi_initModule(IfxAsclin_Spi *asclin, const IfxAsclin_Spi_Config *config)
{
    ...
    IfxAsclin_SamplePointPosition samplePointPosition = (config->baudrate.oversampling + 1) / 2;


    status = (IfxAsclin_Status)IfxAsclin_setBitTiming(asclinSFR, config->baudrate.baudrate,
        config->baudrate.oversampling,
        samplePointPosition,
        config->bitSampling.medianFilter);

    IfxAsclin_setClockSource(asclinSFR, IfxAsclin_ClockSource_noClock);


    IfxAsclin_setRxInput(asclinSFR, config->inputOutput.alti);
    IfxAsclin_setClockPolarity(asclinSFR, config->inputOutput.cpol);
    IfxAsclin_setSlavePolarity(asclinSFR, config->inputOutput.spol);
    IfxAsclin_enableLoopBackMode(asclinSFR, config->inputOutput.loopBack);
    ...
    IfxAsclin_setDataLength(asclinSFR, config->dataLength);



    if (config->dataLength <= 8)
    {
        IfxAsclin_setTxFifoInletWidth(asclinSFR, IfxAsclin_TxFifoInletWidth_1);
        IfxAsclin_setRxFifoOutletWidth(asclinSFR, IfxAsclin_RxFifoOutletWidth_1);
        asclin->dataWidth = 1;
    }

    else
    {
        IfxAsclin_setTxFifoInletWidth(asclinSFR, IfxAsclin_TxFifoInletWidth_2);
        IfxAsclin_setRxFifoOutletWidth(asclinSFR, IfxAsclin_RxFifoOutletWidth_2);
        asclin->dataWidth = 2;
    }
    ...
    if (config->interrupt.rxPriority > 0)
    {
        ...
        IfxAsclin_enableRxFifoFillLevelFlag(asclinSFR, 1);
        IfxSrc_enable(src);
    }
    ...
    if (config->interrupt.txPriority > 0)
    {
        ...
        IfxAsclin_enableTxFifoFillLevelFlag(asclinSFR, 1);
        IfxSrc_enable(src);
    }
    ...
    if (config->interrupt.erPriority > 0)
    {
        ...
        IfxAsclin_enableFrameErrorFlag(asclinSFR, 1);
        IfxSrc_enable(src);
    }
    ...
    IfxAsclin_enableParity(asclinSFR, 0);
...
void IfxAsclin_Spi_initModuleConfig(IfxAsclin_Spi_Config *config, Ifx_ASCLIN *asclin)
{
    const IfxAsclin_Spi_Config defaultConfig = {
        ...
        .frameMode = IfxAsclin_FrameMode_spi,
        .clockSource = IfxAsclin_ClockSource_kernelClock,


        .inputOutput = {
            .alti = IfxAsclin_RxInputSelect_0,
        ...
        .bitSampling = {
            .medianFilter = IfxAsclin_SamplesPerBit_one,
        },


        .frame = {
            .idleDelay = IfxAsclin_IdleDelay_0,
            .leadDelay = IfxAsclin_LeadDelay_1,
            .stopBit = IfxAsclin_StopBit_1,
            .shiftDir = IfxAsclin_ShiftDirection_lsbFirst,
        },


        .dataLength = IfxAsclin_DataLength_8,


        .fifo = {
            .outWidth = IfxAsclin_RxFifoOutletWidth_1,
            .inWidth = IfxAsclin_TxFifoInletWidth_1,
            .buffMode = IfxAsclin_ReceiveBufferMode_rxFifo,
            .txFifoInterruptLevel = IfxAsclin_TxFifoInterruptLevel_15,
            .rxFifoInterruptLevel = IfxAsclin_RxFifoInterruptLevel_1,
        },
...
void IfxAsclin_Spi_read(IfxAsclin_Spi *asclin)
{
    ...
    uint32 count = (uint32)IfxAsclin_getRxFifoFillLevel(asclinSFR);
    count = __min(job->pending, count);

    if (job->data == ((void *)0))
    {
        uint32 i;
        job->pending = job->pending - count;

        for (i = 0; i < count; i++)
        {
            IfxAsclin_readRxData(asclinSFR);
        }
    }
    else if (job->pending > 0)
    {
        ...
        {
        case 1:
            IfxAsclin_read8(asclinSFR, job->data, count);
            job->data = &(((uint8 *)job->data)[count]);
            break;

        case 2:
            IfxAsclin_read16(asclinSFR, job->data, count);
    ...
    if (job->pending == 0)
    {
        asclin->transferInProgress = 0;
        IfxAsclin_Spi_unlock(asclin);
    }
}
...
void IfxAsclin_Spi_write(IfxAsclin_Spi *asclin)
{
    ...
    if (job->pending)
    {
        ...
        uint32 count = (uint32)(16 - IfxAsclin_getTxFifoFillLevel(asclinSFR));
        count = __min(job->pending, count);
        ...
        if (job->data == ((void *)0))
        {
            ...
            for (i = 0; i < count; i++)
            {
                IfxAsclin_writeTxData(asclinSFR, ~0);
            }
        }
        else
        {
            ...
            {
            case 1:
                IfxAsclin_write8(asclinSFR, job->data, count);
                job->data = &(((uint8 *)job->data)[count]);
                break;

            case 2:
                IfxAsclin_write16(asclinSFR, job->data, count);
                job->data = &(((uint16 *)job->data)[count]);
                break;
            }
        }
