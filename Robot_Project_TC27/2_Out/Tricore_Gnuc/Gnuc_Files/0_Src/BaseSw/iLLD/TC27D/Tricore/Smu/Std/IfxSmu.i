# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.c"
# 29 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.c"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.h" 1
# 39 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.h"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/_Impl/IfxSmu_cfg.h" 1
# 51 "0_Src/BaseSw/iLLD/TC27D/Tricore/_Impl/IfxSmu_cfg.h"
typedef enum
{
...
# 40 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.h" 2
...
# 41 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.h" 2
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/_PinMap/IfxSmu_PinMap.h" 1
# 31 "0_Src/BaseSw/iLLD/TC27D/Tricore/_PinMap/IfxSmu_PinMap.h"
# 1 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/IfxSmu_reg.h" 1
# 36 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/IfxSmu_reg.h"
# 1 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/IfxSmu_regdef.h" 1
# 39 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/IfxSmu_regdef.h"
# 1 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/Ifx_TypesReg.h" 1
# 40 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/IfxSmu_regdef.h" 2
...
# 715 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/IfxSmu_regdef.h"
...
# 37 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/IfxSmu_reg.h" 2
# 32 "0_Src/BaseSw/iLLD/TC27D/Tricore/_PinMap/IfxSmu_PinMap.h" 2
...
# 33 "0_Src/BaseSw/iLLD/TC27D/Tricore/_PinMap/IfxSmu_PinMap.h" 2
...
extern IfxSmu_Fsp_Out IfxSmu_FSP_P33_8_OUT;
...
extern const IfxSmu_Fsp_Out *IfxSmu_Fsp_Out_pinTable[1][1];
# 42 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.h" 2

# 1 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/IfxSmu_regdef.h" 1
# 44 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.h" 2
# 1 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/IfxSmu_bf.h" 1
# 45 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.h" 2
# 1 "0_Src/BaseSw/Service/CpuGeneric/_Utilities/Ifx_Assert.h" 1
# 46 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.h" 2
# 56 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.h"
typedef enum
{
    IfxSmu_AlarmConfig_noAction = 0,
    IfxSmu_AlarmConfig_interruptSet0 = 2,
    IfxSmu_AlarmConfig_interruptSet1 = 3,
    IfxSmu_AlarmConfig_interruptSet2 = 4,
    IfxSmu_AlarmConfig_nmi = 5,
    IfxSmu_AlarmConfig_scuReset = 6,
    IfxSmu_AlarmConfig_cpuIdle = 7
} IfxSmu_AlarmConfig;
...
{
    IfxSmu_Cmd_start = 0,
    IfxSmu_Cmd_activateFsp = 1,
    IfxSmu_Cmd_releaseFsp = 2,
    IfxSmu_Cmd_activatePes = 3,
    IfxSmu_Cmd_stopRecoveryTimer = 4,
    IfxSmu_Cmd_enableClearAlarmStatus = 5,
    IfxSmu_Cmd_triggerAlarm = 6
} IfxSmu_Cmd;

typedef enum
{
    IfxSmu_Fsp_Mode_bistable,
    IfxSmu_Fsp_Mode_timeSwitching
} IfxSmu_Fsp_Mode;
# 96 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.h"
typedef struct
{
    IfxSmu_Fsp_Mode mode;
    float32 faultStateTime;
    float32 faultFreeStateFrequencyMin;
    float32 faultFreeStateFrequencyMax;
    boolean emergencyStopEnabled;
    boolean enableFaultToRunStateTransition;
} IfxSmu_configFsp;
# 118 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.h"
static inline __attribute__ ((always_inline)) boolean IfxSmu_releaseFsp(Ifx_SMU *smu);





static inline __attribute__ ((always_inline)) void IfxSmu_initFspConfig(IfxSmu_configFsp *config);




static inline __attribute__ ((always_inline)) boolean IfxSmu_activateFsp(Ifx_SMU *smu);
# 146 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.h"
extern boolean IfxSmu_initFsp(Ifx_SMU *smu, IfxSmu_configFsp *config);




extern float32 IfxSmu_getFspFaultFreeFrequency(Ifx_SMU *smu);




extern float32 IfxSmu_getFspFaultStateTime(Ifx_SMU *smu);
...
extern void IfxSmu_enableAlarmFsp(Ifx_SMU *smu, IfxSmu_Alarm alarm, boolean enabled);
# 178 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.h"
static inline __attribute__ ((always_inline)) boolean IfxSmu_activatePes(Ifx_SMU *smu);





static inline __attribute__ ((always_inline)) boolean IfxSmu_stopRecoveryTimer(Ifx_SMU *smu, IfxSmu_RecoveryTimer timer);




static inline __attribute__ ((always_inline)) boolean IfxSmu_enableClearAlarmStatus(Ifx_SMU *smu);





static inline __attribute__ ((always_inline)) boolean IfxSmu_triggerAlarm(Ifx_SMU *smu, IfxSmu_Alarm alarm);




static inline __attribute__ ((always_inline)) boolean IfxSmu_start(Ifx_SMU *smu);
# 213 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.h"
extern boolean IfxSmu_cmd(Ifx_SMU *smu, uint8 cmd, uint8 arg);





extern boolean IfxSmu_unlock(Ifx_SMU *smu);
...
extern void IfxSmu_lock(Ifx_SMU *smu);
...
extern void IfxSmu_lockForever(Ifx_SMU *smu);
...
extern void IfxSmu_setAlarmConfig(Ifx_SMU *smu, IfxSmu_Alarm alarm, IfxSmu_AlarmConfig config);
...
extern boolean IfxSmu_isAlarmSet(Ifx_SMU *smu, IfxSmu_Alarm alarm);





extern IfxSmu_Alarm IfxSmu_getAlarm(Ifx_SMU *smu);
...
extern void IfxSmu_clearAlarm(Ifx_SMU *smu, IfxSmu_Alarm alarm);
...
static inline __attribute__ ((always_inline)) void IfxSmu_initFspConfig(IfxSmu_configFsp *config)
{
    config->emergencyStopEnabled = 0;
    config->enableFaultToRunStateTransition = 0;
...
# 30 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.c" 2
...
# 77 "0_Src/BaseSw/iLLD/TC27D/Tricore/Smu/Std/IfxSmu.c"
            tFspHigh = ((uint32)(config->faultStateTime / tSmuFs) - 1) >> (14u);



            if (
                (config->faultStateTime <= tSmuFs * (((tFspHigh << (14u)) | (smu->FSP.B.TFSP_LOW)) + 1))
                && (tFspHigh <= (0x3ffu))
                )
            {
                ok = 1;
...
float32 IfxSmu_getFspFaultStateTime(Ifx_SMU *smu)
{
    ...
    return tSmuFs * (((smu->FSP.B.TFSP_HIGH << (14u)) | (smu->FSP.B.TFSP_LOW)) + 1);
}
...
IfxSmu_Alarm IfxSmu_getAlarm(Ifx_SMU *smu)
{
    ...
    {
        index = __builtin_clz(smu->AG[group].U);
