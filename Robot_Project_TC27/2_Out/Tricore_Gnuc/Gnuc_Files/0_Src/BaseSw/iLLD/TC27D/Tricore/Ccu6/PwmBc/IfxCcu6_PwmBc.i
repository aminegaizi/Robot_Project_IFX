# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmBc/IfxCcu6_PwmBc.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmBc/IfxCcu6_PwmBc.c"
# 30 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmBc/IfxCcu6_PwmBc.c"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmBc/IfxCcu6_PwmBc.h" 1
# 244 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmBc/IfxCcu6_PwmBc.h"
...
# 245 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmBc/IfxCcu6_PwmBc.h" 2
# 1 "0_Src/BaseSw/Service/CpuGeneric/If/Ccu6If/PwmHl.h" 1
# 33 "0_Src/BaseSw/Service/CpuGeneric/If/Ccu6If/PwmHl.h"
...
typedef struct
{
    ...
    float32 t13Frequency;
    Ifx_TimerValue t13Period;
    Ifx_TimerValue phaseDelay;
    Ifx_TimerValue noiseFilter;

    Ifx_ActiveState activeState;
} PwmHl_Config;
# 246 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmBc/IfxCcu6_PwmBc.h" 2
# 255 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmBc/IfxCcu6_PwmBc.h"
typedef struct
{
...
typedef struct
{
    IfxCcu6_MultiChannelSwitchingSelect switchingSelect;
    IfxCcu6_MultiChannelSwitchingSync switchingSync;
...
typedef struct
{
    const IfxCcu6_Cc60_Out *cc60Out;
    const IfxCcu6_Cc61_Out *cc61Out;
    const IfxCcu6_Cc62_Out *cc62Out;
    const IfxCcu6_Cout60_Out *cout60;
    const IfxCcu6_Cout61_Out *cout61;
    const IfxCcu6_Cout62_Out *cout62;
    const IfxCcu6_Cout63_Out *cout63;
...
typedef struct
{
    ...
    IfxCcu6_ExternalTriggerMode t12ExtInputTriggerMode;
    IfxCcu6_T13hr_In *t13ExtInputTrigger;
    IfxCcu6_ExternalTriggerMode t13ExtInputTriggerMode;
    boolean t13InSyncWithT12;
    boolean outputTriggerEnabled;
    IfxCcu6_TrigOut outputLine;
    IfxCcu6_TrigSel outputTrigger;
...
typedef struct
{
    PwmHl base;
    Ifx_CCU6 *ccu6;
    IfxCcu6_PwmBc_TriggerConfig trigger;
    uint8 hallPatternIndex;
} IfxCcu6_PwmBc;
...
typedef struct
{
    PwmHl_Config base;
    Ifx_CCU6 *ccu6;
    IfxCcu6_PwmBc_Timer12 timer12;
    IfxCcu6_PwmBc_Timer13 timer13;
    uint8 hallPatternIndex;
    IfxCcu6_HallSensorTriggerMode hallSyncEvent;
    IfxCcu6_PwmBc_MultiChannelControl multiChannelControl;
    IfxCcu6_PwmBc_Pins *pins;
    IfxCcu6_PwmBc_InterruptConfig interrupt1;
    IfxCcu6_PwmBc_InterruptConfig interrupt2;
    IfxCcu6_PwmBc_InterruptConfig interrupt3;
    IfxCcu6_PwmBc_InterruptConfig interrupt4;
    IfxCcu6_PwmBc_TriggerConfig trigger;
} IfxCcu6_PwmBc_Config;
# 375 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmBc/IfxCcu6_PwmBc.h"
extern void IfxCcu6_PwmBc_initModule(IfxCcu6_PwmBc *pwmBc, const IfxCcu6_PwmBc_Config *config);
# 385 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmBc/IfxCcu6_PwmBc.h"
extern void IfxCcu6_PwmBc_initModuleConfig(IfxCcu6_PwmBc_Config *config, Ifx_CCU6 *ccu6);
# 403 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmBc/IfxCcu6_PwmBc.h"
extern void IfxCcu6_PwmBc_start(IfxCcu6_PwmBc *pwmBc);
# 412 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmBc/IfxCcu6_PwmBc.h"
extern void IfxCcu6_PwmBc_stop(IfxCcu6_PwmBc *pwmBc);
# 430 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmBc/IfxCcu6_PwmBc.h"
extern uint32 IfxCcu6_PwmBc_getMotorSpeed(IfxCcu6_PwmBc *pwmBc);
# 440 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmBc/IfxCcu6_PwmBc.h"
extern void IfxCcu6_PwmBc_updateHallPattern(IfxCcu6_PwmBc * pwmBc, uint8 controlTable[6][3]);
# 31 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmBc/IfxCcu6_PwmBc.c" 2
...
# 313 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/PwmBc/IfxCcu6_PwmBc.c"
}
...
void IfxCcu6_PwmBc_start(IfxCcu6_PwmBc *pwmBc)
{
    ...
    IfxCcu6_enableShadowTransfer(pwmBc->ccu6, 1, 1);


    if ((pwmBc->trigger.t13ExtInputTrigger == ((void *)0)) && (pwmBc->trigger.t12ExtInputTrigger == ((void *)0)))
    {

        if (pwmBc->trigger.t13InSyncWithT12)
        {
            IfxCcu6_startTimer(pwmBc->ccu6, 1, 0);
        }
        else
        {
            IfxCcu6_startTimer(pwmBc->ccu6, 1, 1);
        }
    }
    ...
    else
    {
        ...
        if (!(pwmBc->trigger.t13InSyncWithT12))
        {
            ...
            if (pwmBc->trigger.t13ExtInputTrigger != ((void *)0))
            {
            ...
            {
                IfxCcu6_startTimer(pwmBc->ccu6, 0, 1);
            }
        }
        else
        {}
        ...
        if (pwmBc->trigger.t12ExtInputTrigger != ((void *)0))
        {
...
{
    IfxCcu6_disableShadowTransfer(pwmBc->ccu6, 1, 1);
    ...
    IfxCcu6_stopTimer(pwmBc->ccu6, 1, 1);
