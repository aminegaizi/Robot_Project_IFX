# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.c"
# 30 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.c"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.h" 1
# 218 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.h"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Std/IfxCcu6.h" 1
# 44 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Std/IfxCcu6.h"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/_Impl/IfxCcu6_cfg.h" 1
# 41 "0_Src/BaseSw/iLLD/TC27D/Tricore/_Impl/IfxCcu6_cfg.h"
...
# 42 "0_Src/BaseSw/iLLD/TC27D/Tricore/_Impl/IfxCcu6_cfg.h" 2
...
# 39 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/IfxCcu6_regdef.h"
# 1 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/Ifx_TypesReg.h" 1
# 40 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/IfxCcu6_regdef.h" 2
...
# 43 "0_Src/BaseSw/iLLD/TC27D/Tricore/_Impl/IfxCcu6_cfg.h" 2
...
# 45 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Std/IfxCcu6.h" 2
...
# 46 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Std/IfxCcu6.h" 2
...
# 48 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Std/IfxCcu6.h" 2
...
# 39 "0_Src/BaseSw/iLLD/TC27D/Tricore/_PinMap/IfxCcu6_PinMap.h"
typedef const struct
{
    Ifx_CCU6* module;
    IfxPort_Pin pin;
...
# 51 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Std/IfxCcu6.h" 2
...
# 219 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.h" 2
# 1 "0_Src/BaseSw/Service/CpuGeneric/If/Ccu6If/Icu.h" 1
# 33 "0_Src/BaseSw/Service/CpuGeneric/If/Ccu6If/Icu.h"
...
# 220 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.h" 2
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.h" 1
# 204 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.h"
# 1 "0_Src/BaseSw/Service/CpuGeneric/If/Ccu6If/Timer.h" 1
# 33 "0_Src/BaseSw/Service/CpuGeneric/If/Ccu6If/Timer.h"
...
struct Timer_s
{
    float32 t12Frequency;
    Ifx_TimerValue t12Period;
    float32 t13Frequency;
    Ifx_TimerValue t13Period;
...
typedef struct
{
    ...
    float32 t13Frequency;
    Ifx_TimerValue t13Period;
    Ifx_TimerValue waitingTime;
    Ifx_TimerValue activeCount;
} Timer_Config;
# 205 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.h" 2
# 214 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.h"
typedef struct
{
    boolean t12ExtClockEnabled;
    IfxCcu6_T12hr_In *t12ExtClockInput;
    IfxCcu6_CountingInputMode t12countingInputMode;
    boolean t13ExtClockEnabled;
    IfxCcu6_T13hr_In *t13ExtClockInput;
    IfxCcu6_CountingInputMode t13countingInputMode;
} IfxCcu6_Timer_Clock;
...
{
    uint16 counterValue;
    IfxCcu6_T13TriggerEvent t12SyncEvent;
    IfxCcu6_T13TriggerDirection t12SyncDirection;
...
typedef struct
{
    IfxCcu6_T12hr_In *t12ExtInputTrigger;
    IfxCcu6_T13hr_In *t13ExtInputTrigger;
    IfxCcu6_ExternalTriggerMode extInputTriggerMode;
    boolean t13InSyncWithT12;
...
typedef struct
{
    const IfxCcu6_T12hr_In *t12hr;
    const IfxCcu6_T13hr_In *t13hr;
    IfxPort_InputMode t1xhrInputMode;
} IfxCcu6_Timer_Pins;
...
typedef struct
{
    ...
    IfxCcu6_Timer_TriggerConfig trigger;
} IfxCcu6_Timer;
...
typedef struct
{
    ...
    IfxCcu6_Timer_Clock clock;
    IfxCcu6_Timer_Timer12 timer12;
    IfxCcu6_Timer_Timer13 timer13;
    IfxCcu6_Timer_InterruptConfig interrupt1;
    IfxCcu6_Timer_InterruptConfig interrupt2;
    IfxCcu6_Timer_InterruptConfig interrupt3;
    IfxCcu6_Timer_InterruptConfig interrupt4;
    IfxCcu6_Timer_TriggerConfig trigger;
    IfxCcu6_Timer_Pins *pins;
} IfxCcu6_Timer_Config;
# 320 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.h"
extern void IfxCcu6_Timer_initModule(IfxCcu6_Timer *timer, const IfxCcu6_Timer_Config *config);
# 330 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.h"
extern void IfxCcu6_Timer_initModuleConfig(IfxCcu6_Timer_Config *config, Ifx_CCU6 *ccu6);
# 348 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.h"
extern void IfxCcu6_Timer_countOneStep(IfxCcu6_Timer *timer);
# 357 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.h"
extern void IfxCcu6_Timer_start(IfxCcu6_Timer *timer);
# 366 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.h"
extern void IfxCcu6_Timer_startSingleShotMode(IfxCcu6_Timer *timer);
# 375 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.h"
extern void IfxCcu6_Timer_stop(IfxCcu6_Timer *timer);
# 384 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.h"
extern void IfxCcu6_Timer_synchronousStart(IfxCcu6_Timer *timer);
# 393 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.h"
extern void IfxCcu6_Timer_synchronousStop(IfxCcu6_Timer *timer);
# 221 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.h" 2
# 230 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.h"
typedef struct
{
    boolean extClockEnabled;
    IfxCcu6_T12hr_In *extClockInput;
    IfxCcu6_CountingInputMode countingInputMode;
} IfxCcu6_Icu_Clock;
...
typedef struct
{
    const IfxCcu6_Cc60in_In *cc60In;
    const IfxCcu6_Cc61in_In *cc61In;
    const IfxCcu6_Cc62in_In *cc62In;
    const IfxCcu6_Ccpos0_In *ccpos0;
    const IfxCcu6_Ccpos1_In *ccpos1;
    const IfxCcu6_Ccpos2_In *ccpos2;
    IfxPort_InputMode cc6xInputMode;
    IfxPort_InputMode ccposxInputMode;
    const IfxCcu6_T12hr_In *t12hr;
    const IfxCcu6_T13hr_In *t13hr;
    IfxPort_InputMode t1xhrInputMode;
...
typedef struct
{
    IfxCcu6_T12hr_In *extInputTrigger;
    IfxCcu6_ExternalTriggerMode extInputTriggerMode;
...
typedef struct
{
    Icu base;
    Ifx_CCU6 *ccu6;
    IfxCcu6_Icu_TriggerConfig trigger;
    IfxCcu6_T12Channel channelId;
    IfxCcu6_T12ChannelMode channelMode;
} IfxCcu6_Icu_Channel;
...
typedef struct
{
    ...
    IfxCcu6_T12Channel channelId;
    IfxCcu6_T12ChannelMode channelMode;
    IfxCcu6_Icu_InterruptConfig interrupt1;
    IfxCcu6_Icu_InterruptConfig interrupt2;
    IfxCcu6_Icu_InterruptConfig interrupt3;
    IfxCcu6_Icu_InterruptConfig interrupt4;
    IfxCcu6_Icu_TriggerConfig trigger;
    IfxCcu6_Icu_Pins *pins;
    boolean multiInputCaptureEnabled;
    IfxCcu6_Timer timer;
...
typedef struct
{
    ...
    IfxCcu6_Icu_Clock clock;
    IfxCcu6_T12CountMode countMode;
    uint16 counterValue;
} IfxCcu6_Icu_Config;
# 342 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.h"
extern void IfxCcu6_Icu_initModule(IfxCcu6_Icu *icu, const IfxCcu6_Icu_Config *config);
# 352 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.h"
extern void IfxCcu6_Icu_initModuleConfig(IfxCcu6_Icu_Config *config, Ifx_CCU6 *ccu6);
# 370 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.h"
extern uint32 IfxCcu6_Icu_getTimeStamp(IfxCcu6_Icu_Channel *channel);
# 379 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.h"
extern void IfxCcu6_Icu_startCapture(IfxCcu6_Icu_Channel *channel);
# 388 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.h"
extern void IfxCcu6_Icu_stopCapture(IfxCcu6_Icu_Channel *channel);
# 407 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.h"
extern void IfxCcu6_Icu_initChannel(IfxCcu6_Icu_Channel *channel, const IfxCcu6_Icu_ChannelConfig *channelConfig);
# 417 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.h"
extern void IfxCcu6_Icu_initChannelConfig(IfxCcu6_Icu_ChannelConfig *channelConfig, Ifx_CCU6 *ccu6);
# 31 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Icu/IfxCcu6_Icu.c" 2
...
void IfxCcu6_Icu_initChannelConfig(IfxCcu6_Icu_ChannelConfig *channelConfig, Ifx_CCU6 *ccu6)
{
    ...
    channelConfig->channelId = IfxCcu6_T12Channel_0;
    channelConfig->channelMode = IfxCcu6_T12ChannelMode_doubleRegisterCaptureRising;
    ...
    channelConfig->interrupt1.priority = 0;
    channelConfig->interrupt1.typeOfService = IfxSrc_Tos_cpu0;
    ...
    channelConfig->interrupt2.priority = 0;
    channelConfig->interrupt2.typeOfService = IfxSrc_Tos_cpu0;
    ...
    channelConfig->interrupt3.priority = 0;
    channelConfig->interrupt3.typeOfService = IfxSrc_Tos_cpu0;
    ...
    channelConfig->interrupt4.priority = 0;
    channelConfig->interrupt4.typeOfService = IfxSrc_Tos_cpu0;
    ...
    channelConfig->pins = ((void *)0);

    channelConfig->multiInputCaptureEnabled = 0;
}
...
void IfxCcu6_Icu_initModule(IfxCcu6_Icu *icu, const IfxCcu6_Icu_Config *config)
{
    ...
    if (IfxCcu6_isModuleEnabled(ccu6SFR) == 0)
    {
    ...
    if (IfxCcu6_getTimerAvailabilityStatus(ccu6SFR, IfxCcu6_TimerId_t12) == 0)
    {
    ...
    if (config->clock.extClockEnabled)
    {
        ...
        if (config->clock.extClockInput != ((void *)0))
        {
...
void IfxCcu6_Icu_initModuleConfig(IfxCcu6_Icu_Config *config, Ifx_CCU6 *ccu6)
{
    ...
    config->clock.extClockEnabled = 0;
    config->clock.extClockInput = ((void *)0);
...
void IfxCcu6_Icu_startCapture(IfxCcu6_Icu_Channel *channel)
{
    if (IfxCcu6_getTimerRunStatus(channel->ccu6, IfxCcu6_TimerId_t12) != IfxCcu6_TimerRunStatus_running)
    {
        ...
        IfxCcu6_enableShadowTransfer(channel->ccu6, 1, 0);


        if (channel->trigger.extInputTrigger != ((void *)0))
        {
        ...
        else
        {
            ...
            IfxCcu6_startTimer(channel->ccu6, 1, 0);
        }
    }
...
void IfxCcu6_Icu_stopCapture(IfxCcu6_Icu_Channel *channel)
{
    ...
    IfxCcu6_disableShadowTransfer(channel->ccu6, 1, 0);
    ...
    IfxCcu6_stopTimer(channel->ccu6, 1, 0);
}
