# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Trig/IfxGtm_Trig.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Trig/IfxGtm_Trig.c"
# 29 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Trig/IfxGtm_Trig.c"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Trig/IfxGtm_Trig.h" 1
# 41 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Trig/IfxGtm_Trig.h"
...
# 42 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Trig/IfxGtm_Trig.h" 2
...
# 43 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Trig/IfxGtm_Trig.h" 2
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Std/IfxGtm_Tim.h" 1
# 42 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Std/IfxGtm_Tim.h"
...
# 43 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Std/IfxGtm_Tim.h" 2
...
# 44 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Trig/IfxGtm_Trig.h" 2
...
# 30 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Trig/IfxGtm_Trig.c" 2
# 1 "0_Src/BaseSw/Service/CpuGeneric/_Utilities/Ifx_Assert.h" 1
# 31 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Trig/IfxGtm_Trig.c" 2
# 39 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Trig/IfxGtm_Trig.c"
typedef struct
{
    sint8 config;
} IfxGtm_Trig_Channel;
...
static const IfxGtm_Trig_AdcTrig_Table IfxGtm_Trig_AdcTrig_tableAdc8 = {
    .trigger = {
        {.source = {
                  ...
                  {.channel = { {.config = 0x05}, {.config = 0x06}, {.config = 0x07 }, {.config = 0xFF }, {.config = 0xFF}, {.config = 0xFF}, {.config = 0xFF}}},
                  {.channel = { {.config = 0x0B}, {.config = 0x0C}, {.config = 0xFF }, {.config = 0xFF }, {.config = 0xFF}, {.config = 0xFF}, {.config = 0xFF}}},
                  {.channel = { {.config = 0xFF}, {.config = 0xFF}, {.config = 0xFF }, {.config = 0xFF }, {.config = 0xFF}, {.config = 0xFF}, {.config = 0xFF}}},
                  {.channel = { {.config = 0xFF}, {.config = 0xFF}, {.config = 0xFF }, {.config = 0xFF }, {.config = 0xFF}, {.config = 0xFF}, {.config = 0xFF}}},
                  {.channel = { {.config = 0xFF}, {.config = 0xFF}, {.config = 0xFF }, {.config = 0xFF }, {.config = 0xFF}, {.config = 0xFF}, {.config = 0xFF}}},
