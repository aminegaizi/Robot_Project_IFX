# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.c"
# 30 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.c"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h" 1
# 201 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h"
...
# 202 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h" 2
# 1 "0_Src/BaseSw/Service/CpuGeneric/If/Ccu6If/TPwm.h" 1
# 33 "0_Src/BaseSw/Service/CpuGeneric/If/Ccu6If/TPwm.h"
...
# 203 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h" 2
# 212 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h"
typedef struct
{
...
typedef struct
{
    ...
    IfxCcu6_TPwm_TriggerConfig trigger;
} IfxCcu6_TPwm;
...
typedef struct
{
    ...
    Ifx_CCU6 *ccu6;
    IfxCcu6_TimerId timer;
    IfxCcu6_TPwm_Clock clock;
    IfxCcu6_TPwm_Timer12 timer12;
    IfxCcu6_TPwm_Timer13 timer13;
    IfxCcu6_ChannelOut channelOut;
    IfxCcu6_TPwm_Pins *pins;
    IfxCcu6_TPwm_InterruptConfig interrupt1;
    IfxCcu6_TPwm_InterruptConfig interrupt2;
    IfxCcu6_TPwm_InterruptConfig interrupt3;
    IfxCcu6_TPwm_InterruptConfig interrupt4;
    IfxCcu6_TPwm_TriggerConfig trigger;
} IfxCcu6_TPwm_Config;
# 338 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h"
extern void IfxCcu6_TPwm_initModuleConfig(IfxCcu6_TPwm_Config *config, Ifx_CCU6 *ccu6);
# 357 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h"
extern void IfxCcu6_TPwm_initModule(IfxCcu6_TPwm *tPwm, const IfxCcu6_TPwm_Config *config);
# 366 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h"
extern void IfxCcu6_TPwm_pause(IfxCcu6_TPwm *tPwm);
# 375 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h"
extern void IfxCcu6_TPwm_resume(IfxCcu6_TPwm *tPwm);
# 384 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h"
extern void IfxCcu6_TPwm_start(IfxCcu6_TPwm *tPwm);
# 393 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.h"
extern void IfxCcu6_TPwm_stop(IfxCcu6_TPwm *tPwm);
# 31 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.c" 2
...
void IfxCcu6_TPwm_initModule(IfxCcu6_TPwm *tPwm, const IfxCcu6_TPwm_Config *config)
{
    ...
    if ((config->timer == IfxCcu6_TimerId_t12) || (config->trigger.t13InSyncWithT12))
    {
        ...
        if ((config->trigger.t13InSyncWithT12) && (config->base.waitingTime != 0))
        {
            ...
            {
                compareValue = config->base.waitingTime;
...
# 322 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TPwm/IfxCcu6_TPwm.c"
}
...
void IfxCcu6_TPwm_start(IfxCcu6_TPwm *tPwm)
{
    ...
    if (tPwm->timer == IfxCcu6_TimerId_t13)
    {
        ...
        IfxCcu6_enableShadowTransfer(tPwm->ccu6, 0, 1);


        if (!(tPwm->trigger.t13InSyncWithT12))
        {
            if (tPwm->trigger.t13ExtInputTrigger != ((void *)0))
            {
            ...
            else
            {
                ...
                IfxCcu6_startTimer(tPwm->ccu6, 0, 1);
            }
        }
        else
        {}
    ...
    if ((tPwm->timer == IfxCcu6_TimerId_t12) || (tPwm->trigger.t13InSyncWithT12))
    {
        ...
        IfxCcu6_enableShadowTransfer(tPwm->ccu6, 1, 0);


        if (tPwm->trigger.t12ExtInputTrigger != ((void *)0))
        {
        ...
        else
        {
            ...
            IfxCcu6_startTimer(tPwm->ccu6, 1, 0);
        }
    }
    else
    {}
...
void IfxCcu6_TPwm_stop(IfxCcu6_TPwm *tPwm)
{
    ...
    if ((tPwm->timer == IfxCcu6_TimerId_t13) || (tPwm->trigger.t13InSyncWithT12))
    {
        ...
        IfxCcu6_disableShadowTransfer(tPwm->ccu6, 0, 1);
        ...
        IfxCcu6_stopTimer(tPwm->ccu6, 0, 1);
    }
    ...
    else
    {
        ...
        IfxCcu6_disableShadowTransfer(tPwm->ccu6, 1, 0);
        ...
        IfxCcu6_stopTimer(tPwm->ccu6, 1, 0);
    }
