# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Std/IfxCcu6.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Std/IfxCcu6.c"
# 30 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Std/IfxCcu6.c"
...
# 31 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Std/IfxCcu6.c" 2
...
void IfxCcu6_disableModule(Ifx_CCU6 *ccu6)
{
    ...
    while (IfxCcu6_isModuleEnabled(ccu6) == 1)
    {}
}
...
void IfxCcu6_enableModule(Ifx_CCU6 *ccu6)
{
    ...
    while (IfxCcu6_isModuleEnabled(ccu6) == 0)
    {}
}
...
volatile Ifx_SRC_SRCR *IfxCcu6_getSrcAddress(Ifx_CCU6 *ccu6, IfxCcu6_ServiceRequest serviceRequest)
{
    ...
    srcr = &((*(Ifx_SRC*)0xF0038000u).CCU6.CCU6[moduleIdx].SR0);
...
float32 IfxCcu6_setT12Frequency(Ifx_CCU6 *ccu6, float32 frequency, Ifx_TimerValue resolution, IfxCcu6_T12CountMode countMode)
{
    ...
    if (prescaler < 16)
    {
        ...
        IfxCcu6_enableShadowTransfer(ccu6, 1, 0);
...
float32 IfxCcu6_setT13Frequency(Ifx_CCU6 *ccu6, float32 frequency, Ifx_TimerValue resolution)
{
    ...
    if (prescaler < 16)
    {
        ...
        IfxCcu6_enableShadowTransfer(ccu6, 0, 1);
