# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TimerWithTrigger/IfxCcu6_TimerWithTrigger.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TimerWithTrigger/IfxCcu6_TimerWithTrigger.c"
# 29 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TimerWithTrigger/IfxCcu6_TimerWithTrigger.c"
...
# 34 "0_Src/BaseSw/iLLD/TC27D/Tricore/_PinMap/IfxCcu6_PinMap.h" 2
...
# 45 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Std/IfxCcu6.h"
...
# 30 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TimerWithTrigger/IfxCcu6_TimerWithTrigger.c" 2

# 1 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-2.0\\lib\\gcc\\tricore\\4.9.4\\include\\stddef.h" 1 3 4
# 32 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TimerWithTrigger/IfxCcu6_TimerWithTrigger.c" 2
...
# 33 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/TimerWithTrigger/IfxCcu6_TimerWithTrigger.c" 2
...
{
    IfxCcu6_enableShadowTransfer(driver->ccu6, 1, 1);
}
...
boolean IfxCcu6_TimerWithTrigger_init(IfxCcu6_TimerWithTrigger *driver, IfxCcu6_TimerWithTrigger_Config *config)
{
    ...
    if (IfxCcu6_isModuleEnabled(module) == 0)
    {
    ...
    if (base->triggerEnabled)
    {
        ...
        IfxCcu6_setSingleShotModeEnable(module, 0, 1);
...

    {
        ...
        if (timerHasIrq || triggerHasIrq)
        {
            ...
            if (triggerHasIrq)
            {
                IfxCcu6_enableInterrupt(module, IfxCcu6_InterruptSource_t13CompareMatch);
...
{
    IfxCcu6_startTimer(driver->ccu6, 1, 0);
}
...
{
    IfxCcu6_stopTimer(driver->ccu6, 1, 1);
}
