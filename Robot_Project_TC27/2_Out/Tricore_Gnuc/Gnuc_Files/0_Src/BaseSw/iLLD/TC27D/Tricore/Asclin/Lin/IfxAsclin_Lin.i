# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.c"
# 29 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.c"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h" 1
# 215 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
...
# 41 "0_Src/BaseSw/iLLD/TC27D/Tricore/_Impl/IfxAsclin_cfg.h"
...
# 42 "0_Src/BaseSw/iLLD/TC27D/Tricore/_Impl/IfxAsclin_cfg.h" 2
...
# 39 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/IfxAsclin_regdef.h"
# 1 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/Ifx_TypesReg.h" 1
# 40 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/IfxAsclin_regdef.h" 2
...
# 47 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Std/IfxAsclin.h" 2
...
# 51 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Std/IfxAsclin.h" 2
...
# 216 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h" 2
# 234 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
typedef struct
{
    uint8 txHeaderEnd : 1;
    uint8 txResponseEnd : 1;
    uint8 rxHeaderEnd : 1;
    uint8 rxResponseEnd : 1;
...
typedef struct
{
    ...
    IfxAsclin_HeaderResponseSelect headerOnly;
    IfxAsclin_LinResponseTimeoutMode responseTimeoutMode;
    IfxAsclin_Checksum checksum;
...
{
    uint8 frameError : 1;
    uint8 headerTimeout : 1;
    uint8 responseTimeout : 1;
    uint8 breakDetected : 1;
    uint8 linParityError : 1;
    uint8 linAutobaudDetectionError : 1;
    uint8 linChecksumError : 1;
    uint8 collisionDetectionError : 1;
...
{
    Ifx_ASCLIN *asclin;
    IfxAsclin_LinMode linMode;
    IfxAsclin_Lin_AcknowledgementFlags acknowledgmentFlags;
    IfxAsclin_Lin_ErrorFlags errorFlagsStatus;
    boolean receiveIdEnable;
} IfxAsclin_Lin;
...
typedef struct
{
    ...
    IfxAsclin_LinMode linMode;
    IfxAsclin_Lin_BaudrateGeneration brg;
    IfxAsclin_Lin_BaudrateDetection brd;
    IfxAsclin_Lin_BitTimingControl btc;
    IfxAsclin_Lin_BitSamplingControl bsc;
    IfxAsclin_Lin_FrameControl frame;
    IfxAsclin_Lin_FifoControl fifo;
    IfxAsclin_Lin_DataControl data;
    IfxAsclin_Lin_LinControl lin;
    const IfxAsclin_Lin_Pins *pins;
    IfxAsclin_ClockSource clockSource;
    IfxAsclin_RxInputSelect alti;
    boolean receiveIdEnable;
} IfxAsclin_Lin_Config;
# 399 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
static inline __attribute__ ((always_inline)) void IfxAsclin_Lin_prepareHeaderReception(IfxAsclin_Lin *asclin);
# 409 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
static inline __attribute__ ((always_inline)) void IfxAsclin_Lin_prepareResponseReception(IfxAsclin_Lin *asclin, uint32 length);
# 419 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
static inline __attribute__ ((always_inline)) void IfxAsclin_Lin_readHeader(IfxAsclin_Lin *asclin, uint8 *id);
# 430 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
static inline __attribute__ ((always_inline)) void IfxAsclin_Lin_readResponse(IfxAsclin_Lin *asclin, uint8 *data, uint32 length);
# 443 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
extern void IfxAsclin_Lin_ignoreHeader(IfxAsclin_Lin *asclin);
# 453 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
extern void IfxAsclin_Lin_receiveHeader(IfxAsclin_Lin *asclin, uint8 *id);
# 464 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
extern void IfxAsclin_Lin_receiveResponse(IfxAsclin_Lin *asclin, uint8 *data, uint32 length);
# 474 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
extern void IfxAsclin_Lin_sendHeader(IfxAsclin_Lin *asclin, uint8 *id);
# 485 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
extern void IfxAsclin_Lin_sendResponse(IfxAsclin_Lin *asclin, uint8 *data, uint32 length);
# 500 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
extern void IfxAsclin_Lin_disableModule(IfxAsclin_Lin *asclin);
# 510 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
extern IfxAsclin_Status IfxAsclin_Lin_initModule(IfxAsclin_Lin *asclin, const IfxAsclin_Lin_Config *config);
# 520 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
extern void IfxAsclin_Lin_initModuleConfig(IfxAsclin_Lin_Config *config, Ifx_ASCLIN *asclin);
# 535 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.h"
extern void IfxAsclin_Lin_checkForReceivedHeaderFlags(IfxAsclin_Lin *asclin);





extern void IfxAsclin_Lin_checkForReceivedResponseFlags(IfxAsclin_Lin *asclin);





extern void IfxAsclin_Lin_checkForTransmittedHeaderFlags(IfxAsclin_Lin *asclin);





extern void IfxAsclin_Lin_checkForTransmittedResponseFlags(IfxAsclin_Lin *asclin);





extern void IfxAsclin_Lin_clearFlagsStatus(IfxAsclin_Lin *asclin);





extern boolean IfxAsclin_Lin_waitForReceivedHeader(IfxAsclin_Lin *asclin);





extern boolean IfxAsclin_Lin_waitForReceivedResponse(IfxAsclin_Lin *asclin);





extern boolean IfxAsclin_Lin_waitForTransmittedHeader(IfxAsclin_Lin *asclin);





extern boolean IfxAsclin_Lin_waitForTransmittedResponse(IfxAsclin_Lin *asclin);
...
static inline __attribute__ ((always_inline)) void IfxAsclin_Lin_prepareHeaderReception(IfxAsclin_Lin *asclin)
{
    ...
    IfxAsclin_enableTxFifoOutlet(asclinSFR, 0);
    IfxAsclin_enableRxFifoInlet(asclinSFR, 1);
}
...
{
    Ifx_ASCLIN *asclinSFR = asclin->asclin;
    IfxAsclin_read8(asclinSFR, id, 1U);
}
...
{
    Ifx_ASCLIN *asclinSFR = asclin->asclin;
    IfxAsclin_read8(asclinSFR, data, length);
}
# 30 "0_Src/BaseSw/iLLD/TC27D/Tricore/Asclin/Lin/IfxAsclin_Lin.c" 2
...
void IfxAsclin_Lin_checkForReceivedResponseFlags(IfxAsclin_Lin *asclin)
{
    ...
    if ((asclin->linMode == IfxAsclin_LinMode_slave) && (IfxAsclin_getBreakDetectedFlagStatus(asclinSFR)))
    {
...
{
    Ifx_ASCLIN *asclinSFR = asclin->asclin;
    IfxAsclin_enableRxFifoInlet(asclinSFR, 0);
...
{
    Ifx_ASCLIN *asclinSFR = config->asclin;
    ...
    IfxAsclin_setClockSource(asclinSFR, IfxAsclin_ClockSource_noClock);
    IfxAsclin_setFrameMode(asclinSFR, config->frameMode);
    IfxAsclin_setLinMode(asclinSFR, config->linMode);
    IfxAsclin_setRxInput(asclinSFR, config->alti);
    IfxAsclin_setPrescaler(asclinSFR, config->btc.prescaler);
    IfxAsclin_setClockSource(asclinSFR, config->clockSource);
    ...
    {
        IfxAsclin_enableAutoBaudrateDetection(asclinSFR, config->brd.abd);
        IfxAsclin_setBrdUpperlimt(asclinSFR, config->brd.upperLimit);
        IfxAsclin_setBrdLowerlimt(asclinSFR, config->brd.lowerLimit);
    }


    IfxAsclin_enableParity(asclinSFR, config->frame.parityEnable);
    IfxAsclin_setParityType(asclinSFR, config->frame.parityType);
    IfxAsclin_setStopBit(asclinSFR, config->frame.stopBit);
    IfxAsclin_enableCollisionDetection(asclinSFR, config->frame.collisionDetectionEnable);
    IfxAsclin_setShiftDirection(asclinSFR, config->frame.shiftDir);


    IfxAsclin_setDataLength(asclinSFR, config->data.dataLength);
    IfxAsclin_setHeaderResponseSelect(asclinSFR, config->data.headerOnly);
    IfxAsclin_setLinResponseTimeoutMode(asclinSFR, config->data.responseTimeoutMode);
    IfxAsclin_setChecksumMode(asclinSFR, config->data.checksum);
    IfxAsclin_setLinResponseTimeoutThreshold(asclinSFR, config->data.responseTimeout);


    IfxAsclin_enableHardwareChecksum(asclinSFR, config->lin.csEnable);
    IfxAsclin_setChecksumInjection(asclinSFR, config->lin.csi);


    if (config->linMode == IfxAsclin_LinMode_master)
    {
        IfxAsclin_setIdleDelay(asclinSFR, config->frame.idleDelay);
        IfxAsclin_setLeadDelay(asclinSFR, config->frame.leadDelay);
        IfxAsclin_setLinBreakLength(asclinSFR, config->lin.breakLength);
        IfxAsclin_setLinHeaderTimeout(asclinSFR, config->lin.headerTimeout);
        asclin->receiveIdEnable = config->receiveIdEnable;
    }
    ...
    IfxAsclin_setRxBufferMode(asclinSFR, config->fifo.buffMode);
    IfxAsclin_enableTxFifoOutlet(asclinSFR, 0);
    IfxAsclin_enableRxFifoInlet(asclinSFR, 0);
    IfxAsclin_flushRxFifo(asclinSFR);
...
void IfxAsclin_Lin_initModuleConfig(IfxAsclin_Lin_Config *config, Ifx_ASCLIN *asclin)
{
    ...
    config->frameMode = IfxAsclin_FrameMode_lin;
    config->linMode = IfxAsclin_LinMode_master;
    config->clockSource = IfxAsclin_ClockSource_kernelClock;
    config->alti = IfxAsclin_RxInputSelect_0;


    config->brg.baudrate = 19200.0;

    config->btc.prescaler = 4;
    config->btc.oversampling = IfxAsclin_OversamplingFactor_16;

    config->bsc.filterDepth = 24U;
    config->bsc.medianFilter = IfxAsclin_SamplesPerBit_one;
    config->bsc.samplePointPosition = IfxAsclin_SamplePointPosition_3;

    config->frame.parityEnable = 0;
    config->frame.parityType = IfxAsclin_ParityType_even;
    config->frame.stopBit = IfxAsclin_StopBit_1;
    config->frame.shiftDir = IfxAsclin_ShiftDirection_lsbFirst;
    config->frame.collisionDetectionEnable = 0;

    config->data.dataLength = IfxAsclin_DataLength_8;
    config->data.headerOnly = IfxAsclin_HeaderResponseSelect_headerAndResponse;
    config->data.responseTimeoutMode = IfxAsclin_LinResponseTimeoutMode_frameTimeout;
    config->data.checksum = IfxAsclin_Checksum_enhanced;
    config->data.responseTimeout = 255;

    config->fifo.outWidth = IfxAsclin_RxFifoOutletWidth_1;
    config->fifo.inWidth = IfxAsclin_TxFifoInletWidth_1;
    config->fifo.buffMode = IfxAsclin_ReceiveBufferMode_rxFifo;

    config->lin.csEnable = 1;
    config->lin.csi = IfxAsclin_ChecksumInjection_written;


    {
        config->receiveIdEnable = 0;
        config->frame.idleDelay = IfxAsclin_IdleDelay_2;
        config->frame.leadDelay = IfxAsclin_LeadDelay_1;

        config->lin.breakLength = 13;
        config->lin.headerTimeout = 56;
    }
...
void IfxAsclin_Lin_sendHeader(IfxAsclin_Lin *asclin, uint8 *id)
{
    ...
    IfxAsclin_flushTxFifo(asclinSFR);
    IfxAsclin_enableTxFifoOutlet(asclinSFR, 1);
...
void IfxAsclin_Lin_sendResponse(IfxAsclin_Lin *asclin, uint8 *data, uint32 length)
{
    boolean result = 0;
    Ifx_ASCLIN *asclinSFR = asclin->asclin;
    IfxAsclin_setDataLength(asclinSFR, length - 1);
    IfxAsclin_clearAllFlags(asclinSFR);
    IfxAsclin_flushTxFifo(asclinSFR);
    IfxAsclin_enableRxFifoInlet(asclinSFR, 0);
    IfxAsclin_enableTxFifoOutlet(asclinSFR, 1);
