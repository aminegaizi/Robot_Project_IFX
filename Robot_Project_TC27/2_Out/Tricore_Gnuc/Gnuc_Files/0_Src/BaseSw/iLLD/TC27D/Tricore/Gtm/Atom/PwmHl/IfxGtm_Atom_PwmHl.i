# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c"
# 29 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h" 1
# 80 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h"
...
# 81 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h" 2
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h" 1
# 73 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h"
...
# 74 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h" 2

# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Std/IfxGtm_Cmu.h" 1
# 76 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h" 2
# 1 "0_Src/BaseSw/Service/CpuGeneric/StdIf/IfxStdIf_Timer.h" 1
# 77 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h" 2
# 86 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h"
typedef struct
{
...
# 143 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h"
...
# 159 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h"
...
# 283 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h"
...
# 82 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h" 2
# 95 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h"
...
# 111 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h"
typedef struct
{
...
typedef struct
{
    ...
    IfxGtm_Atom atom;
    const IfxGtm_Atom_ToutMapP *ccx;
    const IfxGtm_Atom_ToutMapP *coutx;
...
typedef struct
{
    Ifx_Pwm_Mode mode;
    boolean inverted;
    IfxGtm_Atom_PwmHl_Update update;
    IfxGtm_Atom_PwmHl_UpdateShift updateAndShift;
    IfxGtm_Atom_PwmHl_UpdatePulse updatePulse;
...
struct IfxGtm_Atom_PwmHl_s
{
    ...
    Ifx_GTM_ATOM *atom;
    Ifx_GTM_ATOM_AGC *agc;
    IfxGtm_Atom_Ch ccx[(8)];
    IfxGtm_Atom_Ch coutx[(8)];
    IfxGtm_Atom_Ch *ccxTemp;
    IfxGtm_Atom_Ch *coutxTemp;
};
# 182 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h"
extern boolean IfxGtm_Atom_PwmHl_init(IfxGtm_Atom_PwmHl *driver, const IfxGtm_Atom_PwmHl_Config *config);





extern void IfxGtm_Atom_PwmHl_initConfig(IfxGtm_Atom_PwmHl_Config *config);
# 204 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h"
extern float32 IfxGtm_Atom_PwmHl_getDeadtime(IfxGtm_Atom_PwmHl *driver);
...
extern float32 IfxGtm_Atom_PwmHl_getMinPulse(IfxGtm_Atom_PwmHl *driver);
...
extern Ifx_Pwm_Mode IfxGtm_Atom_PwmHl_getMode(IfxGtm_Atom_PwmHl *driver);
...
extern boolean IfxGtm_Atom_PwmHl_setDeadtime(IfxGtm_Atom_PwmHl *driver, float32 deadtime);
...
extern boolean IfxGtm_Atom_PwmHl_setMinPulse(IfxGtm_Atom_PwmHl *driver, float32 minPulse);
...
extern boolean IfxGtm_Atom_PwmHl_setMode(IfxGtm_Atom_PwmHl *driver, Ifx_Pwm_Mode mode);
...
extern void IfxGtm_Atom_PwmHl_setOnTime(IfxGtm_Atom_PwmHl *driver, Ifx_TimerValue *tOn);
...
extern void IfxGtm_Atom_PwmHl_setOnTimeAndShift(IfxGtm_Atom_PwmHl *driver, Ifx_TimerValue *tOn, Ifx_TimerValue *shift);
...
extern void IfxGtm_Atom_PwmHl_setPulse(IfxGtm_Atom_PwmHl *driver, float32 *tOn, float32 *offset);
# 275 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.h"
extern void IfxGtm_Atom_PwmHl_setupChannels(IfxGtm_Atom_PwmHl *driver, boolean *activeCh, boolean *stuckSt);
...
extern boolean IfxGtm_Atom_PwmHl_stdIfPwmHlInit(IfxStdIf_PwmHl *stdif, IfxGtm_Atom_PwmHl *driver);
# 30 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c" 2
# 1 "0_Src/BaseSw/Service/CpuGeneric/_Utilities/Ifx_Assert.h" 1
# 31 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c" 2
# 1 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-2.0\\lib\\gcc\\tricore\\4.9.4\\include\\stddef.h" 1 3 4
# 32 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c" 2
...
# 33 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c" 2
# 44 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c"
static inline __attribute__ ((always_inline)) Ifx_ActiveState IfxGtm_Atom_PwmHl_invertActiveState(Ifx_ActiveState activeState);
# 56 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/PwmHl/IfxGtm_Atom_PwmHl.c"
static void IfxGtm_Atom_PwmHl_updateAndShiftOff(IfxGtm_Atom_PwmHl *driver, Ifx_TimerValue *tOn, Ifx_TimerValue *shift);
...
static void IfxGtm_Atom_PwmHl_updatePulse(IfxGtm_Atom_PwmHl *driver, float32 *tOn, float32 *offset);
...
static void IfxGtm_Atom_PwmHl_updatePulseOff(IfxGtm_Atom_PwmHl *driver, float32 *tOn, float32 *offset);
...
static void IfxGtm_Atom_PwmHl_updateShiftCenterAligned(IfxGtm_Atom_PwmHl *driver, Ifx_TimerValue *tOn, Ifx_TimerValue *shift);
...
static const IfxGtm_Atom_PwmHl_Mode IfxGtm_Atom_PwmHl_modes[Ifx_Pwm_Mode_off + 1] = {
    {Ifx_Pwm_Mode_centerAligned, 0, &IfxGtm_Atom_PwmHl_updateCenterAligned, &IfxGtm_Atom_PwmHl_updateShiftCenterAligned, &IfxGtm_Atom_PwmHl_updatePulse },
    {Ifx_Pwm_Mode_centerAlignedInverted, 1, &IfxGtm_Atom_PwmHl_updateCenterAligned, &IfxGtm_Atom_PwmHl_updateShiftCenterAligned, &IfxGtm_Atom_PwmHl_updatePulse },
    {Ifx_Pwm_Mode_leftAligned, 0, &IfxGtm_Atom_PwmHl_updateEdgeAligned, &IfxGtm_Atom_PwmHl_updateAndShiftOff, &IfxGtm_Atom_PwmHl_updatePulse },
    {Ifx_Pwm_Mode_rightAligned, 1, &IfxGtm_Atom_PwmHl_updateEdgeAligned, &IfxGtm_Atom_PwmHl_updateAndShiftOff, &IfxGtm_Atom_PwmHl_updatePulse },
    {Ifx_Pwm_Mode_off, 0, &IfxGtm_Atom_PwmHl_updateOff, &IfxGtm_Atom_PwmHl_updateAndShiftOff, &IfxGtm_Atom_PwmHl_updatePulseOff},
};
...
boolean IfxGtm_Atom_PwmHl_init(IfxGtm_Atom_PwmHl *driver, const IfxGtm_Atom_PwmHl_Config *config)
{
    ...
    IfxGtm_Atom_Agc_enableChannelsOutput(driver->agc, channelsMask, 0, 1);
    IfxGtm_Atom_Agc_enableChannels(driver->agc, channelsMask, 0, 1);

    IfxGtm_Atom_PwmHl_setMode(driver, Ifx_Pwm_Mode_off);

    Ifx_TimerValue tOn[(8)] = {0};
    IfxGtm_Atom_PwmHl_updateOff(driver, tOn);
...
boolean IfxGtm_Atom_PwmHl_setMode(IfxGtm_Atom_PwmHl *driver, Ifx_Pwm_Mode mode)
{
    ...
    if (base->mode != mode)
    {
        if ((mode > Ifx_Pwm_Mode_off) || (IfxGtm_Atom_PwmHl_modes[mode].update == ((void *)0)))
        {
...
static void IfxGtm_Atom_PwmHl_updateAndShiftOff(IfxGtm_Atom_PwmHl *driver, Ifx_TimerValue *tOn, Ifx_TimerValue *shift)
{
    IfxGtm_Atom_PwmHl_updateOff(driver, ((void *)0));
}
