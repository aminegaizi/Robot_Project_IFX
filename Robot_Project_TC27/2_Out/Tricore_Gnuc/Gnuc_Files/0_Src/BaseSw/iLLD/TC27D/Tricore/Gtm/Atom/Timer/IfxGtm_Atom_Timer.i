# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c"
# 29 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c"
...
# 30 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c" 2
# 1 "0_Src/BaseSw/Service/CpuGeneric/_Utilities/Ifx_Assert.h" 1
# 31 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c" 2

# 1 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-2.0\\lib\\gcc\\tricore\\4.9.4\\include\\stddef.h" 1 3 4
# 33 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c" 2
...
# 34 "0_Src/BaseSw/iLLD/TC27D/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.c" 2
...
void IfxGtm_Atom_Timer_addToChannelMask(IfxGtm_Atom_Timer *driver, IfxGtm_Atom_Ch channel)
{
    ...
    driver->agcDisableUpdate = IfxGtm_Atom_Agc_buildFeature(0, driver->channelsMask, (16u));
    driver->agcApplyUpdate = IfxGtm_Atom_Agc_buildFeature(driver->channelsMask, 0, (16u));
}
...
boolean IfxGtm_Atom_Timer_init(IfxGtm_Atom_Timer *driver, const IfxGtm_Atom_Timer_Config *config)
{
    ...
    if (base->triggerEnabled)
    {
        ...
        if (triggerChannel != driver->timerChannel)
        {
            ...
            IfxGtm_Atom_Agc_enableChannels(driver->agc, triggerChannelMask, 0, 0);
        ...
        IfxGtm_Atom_Agc_enableChannelsOutput(driver->agc, triggerChannelMask, 0, 0);
...

    {
        ...
        else
        {
            ...
            if (timerHasIrq)
            {
                IfxGtm_Atom_Ch_setNotification(driver->atom, driver->timerChannel, irqMode, 1, 0);
                src = IfxGtm_Atom_Ch_getSrcPointer(driver->gtm, config->atom, driver->timerChannel);
            ...
            if (triggerHasIrq)
            {
                IfxGtm_Atom_Ch_setNotification(driver->atom, driver->triggerChannel, irqMode, 0, 1);
...
{
    IfxGtm_Atom_Agc_enableChannels(driver->agc, driver->channelsMask, 0, 1);
}
...
{
    IfxGtm_Atom_Agc_enableChannels(driver->agc, 0, driver->channelsMask, 1);
}
