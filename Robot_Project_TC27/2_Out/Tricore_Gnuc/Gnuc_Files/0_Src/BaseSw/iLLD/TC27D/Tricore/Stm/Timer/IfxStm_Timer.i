# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Timer/IfxStm_Timer.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Timer/IfxStm_Timer.c"
# 29 "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Timer/IfxStm_Timer.c"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Timer/IfxStm_Timer.h" 1
# 98 "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Timer/IfxStm_Timer.h"
...
# 43 "0_Src/BaseSw/iLLD/TC27D/Tricore/_Impl/IfxStm_cfg.h"
...
# 44 "0_Src/BaseSw/iLLD/TC27D/Tricore/_Impl/IfxStm_cfg.h" 2
...
# 39 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/IfxStm_regdef.h"
# 1 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/Ifx_TypesReg.h" 1
# 40 "0_Src/BaseSw/Infra/Sfr/TC27D/_Reg/IfxStm_regdef.h" 2
...
# 45 "0_Src/BaseSw/iLLD/TC27D/Tricore/_Impl/IfxStm_cfg.h" 2
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Cpu/Std/Ifx_Types.h" 1
# 46 "0_Src/BaseSw/iLLD/TC27D/Tricore/_Impl/IfxStm_cfg.h" 2
...
# 121 "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Std/IfxStm.h" 2
...
# 99 "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Timer/IfxStm_Timer.h" 2
...
# 100 "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Timer/IfxStm_Timer.h" 2
# 109 "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Timer/IfxStm_Timer.h"
typedef struct
{
...
typedef struct
{
    IfxStm_Timer_Base base;
    Ifx_STM *stm;
    IfxStm_Comparator comparator;
    uint32 comparatorValue;
    uint8 comparatorShift;
} IfxStm_Timer;
...
# 156 "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Timer/IfxStm_Timer.h"
extern boolean IfxStm_Timer_acknowledgeTimerIrq(IfxStm_Timer *driver);
...
extern float32 IfxStm_Timer_getFrequency(IfxStm_Timer *driver);
...
extern float32 IfxStm_Timer_getInputFrequency(IfxStm_Timer *driver);
...
extern Ifx_TimerValue IfxStm_Timer_getPeriod(IfxStm_Timer *driver);
...
extern float32 IfxStm_Timer_getResolution(IfxStm_Timer *driver);
...
extern void IfxStm_Timer_run(IfxStm_Timer *driver);
...
extern boolean IfxStm_Timer_setFrequency(IfxStm_Timer *driver, float32 frequency);
...
extern boolean IfxStm_Timer_setPeriod(IfxStm_Timer *driver, Ifx_TimerValue period);
...
extern void IfxStm_Timer_setSingleMode(IfxStm_Timer *driver, boolean enabled);
...
extern boolean IfxStm_Timer_stdIfTimerInit(IfxStdIf_Timer *stdif, IfxStm_Timer *driver);
...
extern void IfxStm_Timer_stop(IfxStm_Timer *driver);
...
extern void IfxStm_Timer_updateInputFrequency(IfxStm_Timer *driver);
...
extern boolean IfxStm_Timer_init(IfxStm_Timer *driver, const IfxStm_Timer_Config *config);
...
extern void IfxStm_Timer_initConfig(IfxStm_Timer_Config *config, Ifx_STM *stm);
# 30 "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Timer/IfxStm_Timer.c" 2
...
boolean IfxStm_Timer_init(IfxStm_Timer *driver, const IfxStm_Timer_Config *config)
{
    ...
    driver->comparatorShift = 32 - __builtin_clz((uint32)(config->base.minResolution * IfxStm_getFrequency(driver->stm)));
