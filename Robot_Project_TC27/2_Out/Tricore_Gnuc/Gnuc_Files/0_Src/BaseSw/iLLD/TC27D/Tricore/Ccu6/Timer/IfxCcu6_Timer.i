# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.c"
# 30 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.c"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.h" 1
# 203 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.h"
...
# 204 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.h" 2
...
# 31 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.c" 2
...
void IfxCcu6_Timer_initModule(IfxCcu6_Timer *timer, const IfxCcu6_Timer_Config *config)
{
    ...
    if ((config->timer == IfxCcu6_TimerId_t13) || (config->synchronousOperation))
    {
        ...
        if (IfxCcu6_getTimerAvailabilityStatus(ccu6SFR, IfxCcu6_TimerId_t13) == 0)
        {
        ...
        if (config->clock.t13ExtClockEnabled)
        {

            if (config->clock.t13ExtClockInput != ((void *)0))
            {
    ...
    if ((config->timer == IfxCcu6_TimerId_t12) || (config->trigger.t13InSyncWithT12) || (config->synchronousOperation))
    {
        ...
        if ((config->trigger.t13InSyncWithT12) && (!(config->synchronousOperation)) && (config->base.waitingTime != 0))
        {
            ...
            {
                period = config->base.waitingTime;
            }
        }
        else
        {
        ...
        if (config->clock.t12ExtClockEnabled)
        {

            if (config->clock.t12ExtClockInput != ((void *)0))
            {
...
# 260 "0_Src/BaseSw/iLLD/TC27D/Tricore/Ccu6/Timer/IfxCcu6_Timer.c"
}
...
void IfxCcu6_Timer_initModuleConfig(IfxCcu6_Timer_Config *config, Ifx_CCU6 *ccu6)
{
    const IfxCcu6_Timer_Config defaultConfig = {
        ...
        .synchronousOperation = 0,

        .pins = ((void *)0),

        .clock = {
            .t12ExtClockEnabled = 0,
            .t12ExtClockInput = ((void *)0),
            .t12countingInputMode = IfxCcu6_CountingInputMode_internal,

            .t13ExtClockEnabled = 0,
            .t13ExtClockInput = ((void *)0),
        ...
        .trigger = {
            .t12ExtInputTrigger = ((void *)0),
            .t13ExtInputTrigger = ((void *)0),
...
void IfxCcu6_Timer_start(IfxCcu6_Timer *timer)
{
    ...
    if (timer->timer == IfxCcu6_TimerId_t13)
    {
        ...
        {
            if (timer->trigger.t13ExtInputTrigger != ((void *)0))
            {
            ...
            else
            {
                ...
                IfxCcu6_startTimer(timer->ccu6, 0, 1);
            }
        }
        else
        {}
    ...
    if ((timer->timer == IfxCcu6_TimerId_t12) || (timer->trigger.t13InSyncWithT12))
    {
        ...
        if (timer->trigger.t12ExtInputTrigger != ((void *)0))
        {
        ...
        else
        {
            ...
            IfxCcu6_startTimer(timer->ccu6, 1, 0);
        }
    }
    else
    {}
...
void IfxCcu6_Timer_stop(IfxCcu6_Timer *timer)
{
    ...
    if ((timer->timer == IfxCcu6_TimerId_t13) || (timer->trigger.t13InSyncWithT12))
    {
        ...
        IfxCcu6_disableShadowTransfer(timer->ccu6, 0, 1);
        ...
        IfxCcu6_stopTimer(timer->ccu6, 0, 1);
    }
    ...
    else
    {
        ...
        IfxCcu6_disableShadowTransfer(timer->ccu6, 1, 0);
        ...
        IfxCcu6_stopTimer(timer->ccu6, 1, 0);
    }
}
...
void IfxCcu6_Timer_synchronousStart(IfxCcu6_Timer *timer)
{
    ...
    IfxCcu6_enableShadowTransfer(timer->ccu6, 1, 1);


    IfxCcu6_startTimer(timer->ccu6, 1, 1);
}
...
void IfxCcu6_Timer_synchronousStop(IfxCcu6_Timer *timer)
{
    ...
    IfxCcu6_disableShadowTransfer(timer->ccu6, 1, 1);


    IfxCcu6_stopTimer(timer->ccu6, 1, 1);
}
