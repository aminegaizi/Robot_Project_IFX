# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Std/IfxStm.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Std/IfxStm.c"
# 29 "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Std/IfxStm.c"
...
# 30 "0_Src/BaseSw/iLLD/TC27D/Tricore/Stm/Std/IfxStm.c" 2
...
volatile Ifx_SRC_SRCR *IfxStm_getSrcPointer(Ifx_STM *stm, IfxStm_Comparator comparator)
{
    ...
    return comparator == IfxStm_Comparator_0 ? &(*(Ifx_SRC*)0xF0038000u).STM.STM[index].SR0 : &(*(Ifx_SRC*)0xF0038000u).STM.STM[index].SR1;
}
...
boolean IfxStm_initCompare(Ifx_STM *stm, const IfxStm_CompareConfig *config)
{
    ...
    if (config->triggerPriority > 0)
    {
        ...
        {
            srcr = &((*(Ifx_SRC*)0xF0038000u).STM.STM[index].SR0);
        }
        else
        {
            srcr = &((*(Ifx_SRC*)0xF0038000u).STM.STM[index].SR1);
        }
