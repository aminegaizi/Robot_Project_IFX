# 1 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_LutSincosF32.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_LutSincosF32.c"
# 25 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_LutSincosF32.c"
# 1 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_LutSincosF32.h" 1
# 35 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_LutSincosF32.h"
# 1 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_Cf32.h" 1
# 31 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_Cf32.h"
...
# 32 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_Cf32.h" 2
...
# 33 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_Cf32.h" 2
...
# 36 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_LutSincosF32.h" 2
...
# 37 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_LutSincosF32.h" 2





extern const float32 Ifx_g_LutSincosF32_table[(((1 << (12)) / 2) / 2) + 1];





extern void Ifx_LutSincosF32_init(void);
...
extern float32 Ifx_LutSincosF32_sin(Ifx_Lut_FxpAngle fxpAngle);
...
static inline __attribute__ ((always_inline)) float32 Ifx_LutSincosF32_cos(Ifx_Lut_FxpAngle fxpAngle)
{
    return Ifx_LutSincosF32_sin((((1 << (12)) / 2) / 2) - fxpAngle);
}
# 77 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_LutSincosF32.h"
static inline __attribute__ ((always_inline)) cfloat32 Ifx_LutSincosF32_cossin(Ifx_Lut_FxpAngle fxpAngle)
{
    cfloat32 result;
    result.imag = Ifx_LutSincosF32_sin(fxpAngle);
    result.real = Ifx_LutSincosF32_sin((((1 << (12)) / 2) / 2) - fxpAngle);
    return result;
}
# 26 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_LutSincosF32.c" 2



void Ifx_LutSincosF32_init(void)
{
# 41 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_LutSincosF32.c"
}
...
{
    float32 result;
    fxpAngle = fxpAngle & ((1 << (12)) - 1);

    if (fxpAngle < (((1 << (12)) / 2) / 2))
    {
        result = Ifx_g_LutSincosF32_table[fxpAngle];
    }
    else if (fxpAngle < ((1 << (12)) / 2))
    {
        fxpAngle = ((1 << (12)) / 2) - fxpAngle;
        result = Ifx_g_LutSincosF32_table[fxpAngle];
    }
    else if (fxpAngle < (((1 << (12)) / 2) / 2 * 3))
    {
        fxpAngle = fxpAngle - ((1 << (12)) / 2);
        result = -Ifx_g_LutSincosF32_table[fxpAngle];
    }
    else
    {
        fxpAngle = (1 << (12)) - fxpAngle;
        result = -Ifx_g_LutSincosF32_table[fxpAngle];
    }
