...
# 1 "<command-line>"
# 1 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_LutAtan2F32.c"
# 25 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_LutAtan2F32.c"
...
# 26 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_LutAtan2F32.c" 2
...
# 28 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_LutAtan2F32.c" 2

void Ifx_LutAtan2F32_init(void)
{
# 43 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_LutAtan2F32.c"
}


static inline __attribute__ ((always_inline)) Ifx_Lut_FxpAngle Ifx_LutAtan2F32_fxpAnglePrivate(float32 valf)
{
    uint32 vali;
    valf = (1024) * valf;
    vali = (uint32)valf;
...
static inline __attribute__ ((always_inline)) float32 Ifx_LutAtan2F32_float32Private(float32 val)
{
    return Ifx_g_LutAtan2F32_table[(int)(val * (1024))];
}
...
Ifx_Lut_FxpAngle Ifx_LutAtan2F32_fxpAngle(float32 x, float32 y)
{
    ...
    if (y < 0)
    {
        if (x < 0)
        {
            if (-y < -x)
            {
                angle = -((1 << (12)) / 2) + Ifx_LutAtan2F32_fxpAnglePrivate(-fy / -fx);
            }
            else
            {
                angle = -(((1 << (12)) / 2) / 2) - Ifx_LutAtan2F32_fxpAnglePrivate(-fx / -fy);
            }
        }
        else
        {
            if (-y < x)
            {
                angle = -Ifx_LutAtan2F32_fxpAnglePrivate(-fy / fx);
            }
            else
            {
                angle = -(((1 << (12)) / 2) / 2) + Ifx_LutAtan2F32_fxpAnglePrivate(fx / -fy);
...
float32 Ifx_LutAtan2F32_float32(float32 y, float32 x)
{
    ...
    if (y < 0)
    {
        if (x < 0)
        {
            if (-y < -x)
            {
                angle = -(3.1415926535897932384626433832795f) + Ifx_LutAtan2F32_float32Private(-y / -x);
            }
            else
            {
                angle = -((3.1415926535897932384626433832795f) / 2) - Ifx_LutAtan2F32_float32Private(-x / -y);
            }
        }
        else
        {
            if (-y < x)
            {
                angle = -Ifx_LutAtan2F32_float32Private(-y / x);
            }
            else
            {
                angle = -((3.1415926535897932384626433832795f) / 2) + Ifx_LutAtan2F32_float32Private(x / -y);
