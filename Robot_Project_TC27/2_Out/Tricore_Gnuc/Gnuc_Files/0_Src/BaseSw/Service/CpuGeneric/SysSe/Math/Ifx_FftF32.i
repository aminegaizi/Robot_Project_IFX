# 1 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_FftF32.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_FftF32.c"
# 26 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_FftF32.c"
# 1 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_FftF32.h" 1
# 35 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_FftF32.h"
...
# 36 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_FftF32.h" 2
# 46 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_FftF32.h"
extern const uint16 Ifx_g_FftF32_bitReverseTable[(1U << (14))];


extern const cfloat32 Ifx_g_FftF32_twiddleTable[(1U << (14)) / 2];
# 59 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_FftF32.h"
...
# 27 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_FftF32.c" 2
...
cfloat32 *Ifx_FftF32_generateTwiddleFactor(cfloat32 *TF, short nX)
{
    ...
    for (i = 0; i < nX / 2; i++)
    {
        Theta = 2 * (3.1415926535897932384626433832795f) * i / nX;
...
{
# 84 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Math/Ifx_FftF32.c"
    ...
    for (P = 0; P < p; P++)
    {
        ...
        for (b = 0; b < Bp; b++)
        {
            ...
            for (k = 0; k < Npx; k++)
            {
                ...
                bot = IFX_Cf32_mul(&R[BaseB + k], &top);
                top = R[BaseT + k];
                R[BaseT + k] = IFX_Cf32_add(&top, &bot);
                R[BaseB + k] = IFX_Cf32_sub(&top, &bot);
            }
...
{
    unsigned int logN = 31 - __builtin_clz(nX);
    unsigned short n, k;
