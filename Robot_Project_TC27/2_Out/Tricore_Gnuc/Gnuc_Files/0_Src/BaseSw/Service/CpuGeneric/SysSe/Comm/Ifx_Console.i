# 1 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.c"
# 1 "C:\\Users\\Gaizi\\Desktop\\Robot_Project_IFX\\Robot_Project_TC27//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.c"
# 25 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.c"
...
# 26 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.c" 2
...
# 27 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.c" 2
# 1 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-2.0\\lib\\gcc\\tricore\\4.9.4\\include\\stdarg.h" 1 3 4
# 98 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-2.0\\lib\\gcc\\tricore\\4.9.4\\include\\stdarg.h" 3 4
typedef __gnuc_va_list va_list;
# 28 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.c" 2

# 1 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.h" 1
# 31 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.h"
...
# 32 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.h" 2
...
# 60 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.h"
static inline __attribute__ ((always_inline)) IfxStdIf_DPipe *Ifx_Console_getIo(void)
{
...
extern void Ifx_Console_init(IfxStdIf_DPipe *standardIo);
extern boolean Ifx_Console_print(pchar format, ...);
extern boolean Ifx_Console_printAlign(pchar format, ...);





static inline __attribute__ ((always_inline)) void Ifx_Console_decrAlign(sint16 value)
{
    value = (sint16)(Ifx_g_console.align - ((value == 0U) ? (4) : value));
...
static inline __attribute__ ((always_inline)) void Ifx_Console_incrAlign(sint16 value)
{
    Ifx_g_console.align += ((value == 0) ? (sint16)(4) : value);
}
# 30 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.c" 2
# 1 "0_Src/BaseSw/Service/CpuGeneric/_Utilities/Ifx_Assert.h" 1
# 31 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.c" 2
...
# 32 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.c" 2
...
# 52 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.c"
boolean Ifx_Console_print(pchar format, ...)
{
    if (!Ifx_g_console.standardIo->txDisabled)
    {
        ...
        return IfxStdIf_DPipe_write(Ifx_g_console.standardIo, (void *)message, &count, ((Ifx_TickTime)0x7FFFFFFFFFFFFFFFLL));
    }
    else
    {
        return 1;
...
# 81 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Comm/Ifx_Console.c"
boolean Ifx_Console_printAlign(pchar format, ...)
{
    if (!Ifx_g_console.standardIo->txDisabled)
    {
        ...
        while (align > 0)
        {
            ...
            IfxStdIf_DPipe_write(Ifx_g_console.standardIo, (void *)spaces, &scount, ((Ifx_TickTime)0x7FFFFFFFFFFFFFFFLL));
            align = align - scount;
        }
