 ...
 * Scans for results in ADC0 to ADC4 (currently used ADC0 and ADC2 input pins AN0 and AN2)
 * Calculates the value of the current consumption in real time
 */
