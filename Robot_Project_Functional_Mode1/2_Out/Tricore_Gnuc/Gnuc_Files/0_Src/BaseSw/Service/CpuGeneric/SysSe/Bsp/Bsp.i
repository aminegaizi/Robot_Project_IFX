# 1 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Bsp.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Bsp.c"
# 26 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Bsp.c"
# 1 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Bsp.h" 1
# 33 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Bsp.h"
# 1 "0_Src/AppSw/CpuGeneric/Config/Ifx_Cfg.h" 1
# 34 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Bsp.h" 2
...
# 27 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Bsp.c" 2

Ifx_TickTime TimeConst[(11)];
# 37 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Bsp.c"
void initTime(void)
{
    sint32 Fsys = IfxStm_getFrequency((&(*(Ifx_STM*)0xF0000000u)));

    TimeConst[(0)] = Fsys / (1000000000 / 10);
    TimeConst[(1)] = Fsys / (1000000000 / 100);
    TimeConst[(2)] = Fsys / (1000000 / 1);
    TimeConst[(3)] = Fsys / (1000000 / 10);
    TimeConst[(4)] = Fsys / (1000000 / 100);
    TimeConst[(5)] = Fsys / (1000 / 1);
    TimeConst[(6)] = Fsys / (1000 / 10);
    TimeConst[(7)] = Fsys / (1000 / 100);
    TimeConst[(8)] = Fsys * (1);
    TimeConst[(9)] = Fsys * (10);
    TimeConst[(10)] = Fsys * (100);
}
# 61 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Bsp.c"
void waitPoll(void)
{}
# 73 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Bsp.c"
