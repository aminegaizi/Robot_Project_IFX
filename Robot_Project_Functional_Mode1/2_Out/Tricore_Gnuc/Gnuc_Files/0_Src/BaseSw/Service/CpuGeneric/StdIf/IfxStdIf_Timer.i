# 1 "0_Src/BaseSw/Service/CpuGeneric/StdIf/IfxStdIf_Timer.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/Service/CpuGeneric/StdIf/IfxStdIf_Timer.c"
# 26 "0_Src/BaseSw/Service/CpuGeneric/StdIf/IfxStdIf_Timer.c"
# 1 "0_Src/BaseSw/Service/CpuGeneric/StdIf/IfxStdIf_Timer.h" 1
# 49 "0_Src/BaseSw/Service/CpuGeneric/StdIf/IfxStdIf_Timer.h"
...
# 50 "0_Src/BaseSw/Service/CpuGeneric/StdIf/IfxStdIf_Timer.h" 2
...
# 27 "0_Src/BaseSw/Service/CpuGeneric/StdIf/IfxStdIf_Timer.c" 2
...
void IfxStdIf_Timer_initConfig(IfxStdIf_Timer_Config *config)
{
    ...
    config->trigger.risingEdgeAtPeriod = 0;
    config->trigger.outputEnabled = 0;
    config->trigger.enabled = 0;
...
static float32 IfxStdIf_Timer_nopGetFrequency(IfxStdIf_InterfaceDriver driver)
{
 return 0.0;
}
static Ifx_TimerValue IfxStdIf_Timer_nopGetPeriod(IfxStdIf_InterfaceDriver driver)
{
 return 0;
}
static float32 IfxStdIf_Timer_nopGetResolution(IfxStdIf_InterfaceDriver driver)
{
 return 0.0;
}
static Ifx_TimerValue IfxStdIf_Timer_nopGetTrigger(IfxStdIf_InterfaceDriver driver)
{
 return 0;
}
static boolean IfxStdIf_Timer_nopSetFrequency(IfxStdIf_InterfaceDriver driver, float32 frequency)
{
 return 0;
}
static void IfxStdIf_Timer_nopUpdateInputFrequency(IfxStdIf_InterfaceDriver driver)
{
}
static void IfxStdIf_Timer_nopApplyUpdate(IfxStdIf_InterfaceDriver driver)
{
}
static void IfxStdIf_Timer_nopDisableUpdate(IfxStdIf_InterfaceDriver driver)
{
}
static float32 IfxStdIf_Timer_nopGetInputFrequency(IfxStdIf_InterfaceDriver driver)
{
 return 0.0;
}
static void IfxStdIf_Timer_nopRun(IfxStdIf_InterfaceDriver driver)
{
}
static boolean IfxStdIf_Timer_nopSetPeriod(IfxStdIf_InterfaceDriver driver, Ifx_TimerValue period)
{
 return 0;
}
static void IfxStdIf_Timer_nopSetSingleMode(IfxStdIf_InterfaceDriver driver, boolean enabled)
{
}
static void IfxStdIf_Timer_nopSetTrigger(IfxStdIf_InterfaceDriver driver, Ifx_TimerValue triggerPoint)
{
}
static void IfxStdIf_Timer_nopStop(IfxStdIf_InterfaceDriver driver)
{
}
static boolean IfxStdIf_Timer_nopAckTimerIrq(IfxStdIf_InterfaceDriver driver)
{
 return 0;
}
static boolean IfxStdIf_Timer_nopAckTriggerIrq(IfxStdIf_InterfaceDriver driver)
{
 return 0;
}
