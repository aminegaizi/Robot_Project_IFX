# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Qspi/Std/IfxQspi.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Qspi/Std/IfxQspi.c"
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/Qspi/Std/IfxQspi.c"
...
# 45 "0_Src/BaseSw/iLLD/TC29B/Tricore/Qspi/Std/IfxQspi.h" 2
# 1 "0_Src/BaseSw/Service/CpuGeneric/If/SpiIf.h" 1
# 34 "0_Src/BaseSw/Service/CpuGeneric/If/SpiIf.h"
...
# 35 "0_Src/BaseSw/Service/CpuGeneric/If/SpiIf.h" 2
...
# 47 "0_Src/BaseSw/iLLD/TC29B/Tricore/Qspi/Std/IfxQspi.h" 2
...
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Qspi/Std/IfxQspi.c" 2
...
uint32 IfxQspi_calculateExtendedConfigurationValue(Ifx_QSPI *qspi, const uint8 cs, const SpiIf_ChConfig *chConfig)
{
    ...
    int abcMin = (2);
    int abcMax = (4 + 0 + 4);
    int q, bestQ = 1, abc, bestAbc = abcMax;
    ...
    for (abc = abcMax; abc >= abcMin; abc--)
    {
        ...
        tBaudTmp = tTmp * q;
        error = ( ((tBaudTmp - tBaud) < 0.0) ? -(tBaudTmp - tBaud) : (tBaudTmp - tBaud) );
...
uint32 IfxQspi_calculatePrescaler(Ifx_QSPI *qspi, float baudrate)
{
    ...
    for (i = 0; i < 8; i++)
    {
        ...
        error = ( ((tempHalfBaud - halfBaud) < 0.0) ? -(tempHalfBaud - halfBaud) : (tempHalfBaud - halfBaud) );
...
uint32 IfxQspi_calculateTimeQuantumLength(Ifx_QSPI *qspi, float maxBaudrate)
{
    ...
    bestTq = __max((uint32)((((realTQ) - (sint32)(realTQ)) > 0.5) ? (1 + (sint32)(realTQ)) : ((sint32)(realTQ))), 1);
    bestDelta = ( ((maxBaudrate - (fQspi / bestTq)) < 0.0) ? -(maxBaudrate - (fQspi / bestTq)) : (maxBaudrate - (fQspi / bestTq)) );

    for (abcq = (4); abcq <= (8 * 63); abcq++)
    {
        realTQ = fQspi / (maxBaudrate * abcq);
        tq = (uint32)(realTQ + 0.5);
        achievedMax = fQspi / (tq * abcq);
        deltaMax = ( ((maxBaudrate - achievedMax) < 0.0) ? -(maxBaudrate - achievedMax) : (maxBaudrate - achievedMax) );

        if (( !((deltaMax) > (bestDelta)) ) && (tq >= 1))
        {
            bestDelta = deltaMax;
            bestTq = tq;
        }
...
void IfxQspi_resetModule(Ifx_QSPI *qspi)
{
    ...
    while (0 == qspi->KRST0.B.RSTSTAT)

    {}

    IfxScuWdt_clearCpuEndinit(passwd);
    qspi->KRSTCLR.B.CLR = 1;
    IfxScuWdt_setCpuEndinit(passwd);
}
...
void IfxQspi_calculateDelayConstants(const Ifx_QSPI *qspi, const IfxQspi_ChannelId channelId, const SpiIf_ChMode *chMode, IfxQspi_DelayConst *delayConst)
{
    ...
    for (index = 0; index < 3; index++)
    {
        ...
        {
            delayTemp = (uint8)((scaleTemp / (1 << (2 * preTemp))) + 0.5);
