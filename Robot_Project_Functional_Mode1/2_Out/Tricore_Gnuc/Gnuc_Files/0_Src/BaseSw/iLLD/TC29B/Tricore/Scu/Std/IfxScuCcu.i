# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuCcu.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuCcu.c"
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuCcu.c"
...
# 31 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuCcu.c" 2
# 44 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuCcu.c"
...
# 61 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuCcu.c"
...
static uint32 IfxScuCcu_xtalFrequency = (20000000);
...
const IfxScuCcu_Config IfxScuCcu_defaultClockConfig = {
    ...
    { {(uint32)( (((1) * 2) << (0u)) | (((1)) << (4u)) | (((1)) << (8u)) | (((1) * 2) << (16u)) | (((1)) << (20u)) | (((1) * 2) << (24u))), ( ((0xfu) << (0u)) | ((0xfu) << (4u)) | ((0xfu) << (8u)) | ((0xfu) << (16u)) | ((0x3u) << (20u)) | ((0x3u) << (24u)))}, {(uint32)( (((1) * 2) << (0u)) | (((1)) << (4u)) | (((1) * 2) << (8u)) | (((1) * 2) << (12u)) | (((1) * 4) << (16u)) | (((1)) << (20u)) | (((1) * 2) << (24u))), ( ((0xfu) << (0u)) | ((0xfu) << (4u)) | ((0xfu) << (8u)) | ((0xfu) << (12u)) | ((0xfu) << (16u)) | ((0xfu) << (20u)) | ((0xfu) << (24u)))}, {(uint32)( ((((1)) * 2) << (0u))), ( ((0xfu) << (0u)))}, {(uint32)( ((1) << (0u))), ( ((0xfu) << (0u)))}, {(uint32)( ((0) << (0u))), ( ((0x3fu) << (0u)))}, {(uint32)( ((0) << (0u))), ( ((0x3fu) << (0u)))}, {(uint32)( ((0) << (0u))), ( ((0x3fu) << (0u)))} },
    {( ((6 - 1) << (0u)) | ((2 - 1) << (4u)) | ((20 - 1) << (6u)) | ((2 - 1) << (12u))), ( ((0xfu) << (0u)) | ((0x3u) << (4u)) | ((0x3fu) << (6u)) | ((0x7u) << (12u)))},
    (20000000),
};
...
boolean IfxScuCcu_calculateSysPllDividers(IfxScuCcu_Config *cfg, uint32 fPll)
{
    ...
    {
        const uint32 fPllMax = 300000000;
        ...
        const uint8 pMax = 16;
        const uint8 k2Min = 1;
        const uint8 k2Max = 128;
        const uint8 nMin = 1;
        const uint8 nMax = 128;
...
EXITCALC_LOOP:
        ...
        if ((fPllLeastError) < ((fPll * deviationAllowed) / 100))
        {
            ...
            cfg->sysPll.pllInitialStep.waitTime = 0;
            cfg->sysPll.numOfPllDividerSteps = 0;
        }
        else
        {
            retVal = 1;
...
{
    float32 frequency;
    Ifx_SCU_CCUCON0 ccucon0 = (*(volatile Ifx_SCU_CCUCON0*)0xF0036030u);
...
float32 IfxScuCcu_getBbbFrequency(void)
{
    ...
    switch ((*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.LPDIV)
    {
    case 0:

        if ((*(volatile Ifx_SCU_CCUCON2*)0xF0036040u).B.BBBDIV == 0)
        {
            bbbFrequency = 0.0;
        }
        else
        {
            bbbFrequency = sourceFrequency / (*(volatile Ifx_SCU_CCUCON2*)0xF0036040u).B.BBBDIV;
        }
...
float32 IfxScuCcu_getCpuFrequency(const IfxCpu_ResourceCpu cpu)
{
    ...
    case IfxCpu_ResourceCpu_0:
        cpuDiv = (*(volatile Ifx_SCU_CCUCON6*)0xF0036080u).U;
        break;
    case IfxCpu_ResourceCpu_1:
        cpuDiv = (*(volatile Ifx_SCU_CCUCON7*)0xF0036084u).U;
        break;
    case IfxCpu_ResourceCpu_2:
        cpuDiv = (*(volatile Ifx_SCU_CCUCON8*)0xF0036088u).U;
        break;
    default:
        frequency = 0.0;
        break;
...
float32 IfxScuCcu_getMaxFrequency(void)
{
    ...
    case 0:
        ...
        if ((*(volatile Ifx_SCU_CCUCON5*)0xF003604Cu).B.MAXDIV == 0)
        {
            maxFrequency = sourceFrequency;
        }
        else
        {
            maxFrequency = sourceFrequency / (*(volatile Ifx_SCU_CCUCON5*)0xF003604Cu).B.MAXDIV;
        }
...
float32 IfxScuCcu_getModuleFrequency(void)
{
    ...
    float32 moduleFreq;
    Ifx_SCU_FDR scuFdr;
    scuFdr = (*(volatile Ifx_SCU_FDR*)0xF0036038u);
...
float32 IfxScuCcu_getOscFrequency(void)
{
    ...
    if ((*(volatile Ifx_SCU_CCUCON1*)0xF0036034u).B.INSEL == IfxScu_CCUCON1_INSEL_fOsc1)
    {
        freq = (100000000.0);
    }
    else if ((*(volatile Ifx_SCU_CCUCON1*)0xF0036034u).B.INSEL == IfxScu_CCUCON1_INSEL_fOsc0)
    {
...
float32 IfxScuCcu_getPllErayFrequency(void)
{
    ...
    else if (scu->PLLERAYSTAT.B.FINDIS == 1)
    {
        ...
        freq = (100000000.0) / (scu->PLLERAYCON1.B.K2DIV + 1);
    }
    else
    {
...
float32 IfxScuCcu_getPllErayVcoFrequency(void)
{
    ...
    if ((*(volatile Ifx_SCU_PLLERAYSTAT*)0xF0036024u).B.FINDIS == 1)
    {
    ...
    else
    {
        ...
        vcoFreq = (IfxScuCcu_getOscFrequency() * ((*(volatile Ifx_SCU_PLLERAYCON0*)0xF0036028u).B.NDIV + 1)) / ((*(volatile Ifx_SCU_PLLERAYCON0*)0xF0036028u).B.PDIV + 1);
    }
...
float32 IfxScuCcu_getPllFrequency(void)
{
    ...
    else if (scu->PLLSTAT.B.FINDIS == 1)
    {
        ...
        freq = (100000000.0) / (scu->PLLCON1.B.K2DIV + 1);
    }
    else
    {
...
float32 IfxScuCcu_getPllVcoFrequency(void)
{
    ...
    if ((*(volatile Ifx_SCU_PLLSTAT*)0xF0036014u).B.FINDIS == 1)
    {
    ...
    else
    {
        ...
        vcoFreq = (IfxScuCcu_getOscFrequency() * ((*(volatile Ifx_SCU_PLLCON0*)0xF0036018u).B.NDIV + 1)) / ((*(volatile Ifx_SCU_PLLCON0*)0xF0036018u).B.PDIV + 1);
    }
...
float32 IfxScuCcu_getSourceFrequency(void)
{
    ...
    switch ((*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.CLKSEL)
    {
...
float32 IfxScuCcu_getSpbFrequency(void)
{
    ...
    case 0:
        ...
        if ((*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.SPBDIV == 0)
        {
            spbFrequency = 0.0;
        }
        else
        {
            spbFrequency = sourceFrequency / (*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.SPBDIV;
        }
...
float32 IfxScuCcu_getSriFrequency(void)
{
    ...
    case 0:
        ...
        if ((*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.SRIDIV == 0)
        {
            sriFrequency = 0.0;
        }
        else
        {
            sriFrequency = sourceFrequency / (*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.SRIDIV;
        }
...
boolean IfxScuCcu_init(const IfxScuCcu_Config *cfg)
{
...

    {
        ...
        smuTrapEnable = (*(volatile Ifx_SCU_TRAPDIS*)0xF0036130u).B.SMUT;
        (*(volatile Ifx_SCU_TRAPDIS*)0xF0036130u).B.SMUT = 1U;
...

    {
        ...
        (*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.CLKSEL = 0;
        (*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.UP = 1;


        (*(volatile Ifx_SCU_PLLCON0*)0xF0036018u).B.SETFINDIS = 1;
        ...
        (*(volatile Ifx_SCU_CCUCON1*)0xF0036034u).B.INSEL = 1;
        (*(volatile Ifx_SCU_CCUCON1*)0xF0036034u).B.UP = 1;
    ...
    if (status == 0)
    {
        ...
        {
            {
                ...
                while ((*(volatile Ifx_SCU_PLLSTAT*)0xF0036014u).B.K2RDY == 0U)
                {


                }

                (*(volatile Ifx_SCU_PLLCON1*)0xF003601Cu).B.K2DIV = cfg->sysPll.pllInitialStep.k2Initial;

                {

                    (*(volatile Ifx_SCU_PLLCON0*)0xF0036018u).B.PDIV = cfg->sysPll.pllInitialStep.pDivider;
                    (*(volatile Ifx_SCU_PLLCON0*)0xF0036018u).B.NDIV = cfg->sysPll.pllInitialStep.nDivider;



                    (*(volatile Ifx_SCU_PLLCON0*)0xF0036018u).B.OSCDISCDIS = 1;

                    (*(volatile Ifx_SCU_PLLCON0*)0xF0036018u).B.PLLPWD = 0;

                    (*(volatile Ifx_SCU_PLLCON0*)0xF0036018u).B.CLRFINDIS = 1;
                    (*(volatile Ifx_SCU_PLLCON0*)0xF0036018u).B.PLLPWD = 1;


                    (*(volatile Ifx_SCU_PLLCON0*)0xF0036018u).B.RESLD = 1;

                    IfxScuCcu_wait(0.000050F);

                    while ((*(volatile Ifx_SCU_PLLSTAT*)0xF0036014u).B.VCOLOCK == 0U)
                    {


                    }

                    (*(volatile Ifx_SCU_PLLCON0*)0xF0036018u).B.VCOBYP = 0;
                    ...
                    (*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.CLKSEL = 0x01;
                    ...
                    IfxScuCcu_wait(cfg->sysPll.pllInitialStep.waitTime);

                    {
                        Ifx_SCU_CCUCON0 ccucon0;
                        ccucon0.U = (*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).U & ~cfg->clockDistribution.ccucon0.mask;

                        ccucon0.U |= (cfg->clockDistribution.ccucon0.mask & cfg->clockDistribution.ccucon0.value);
                        ccucon0.B.CLKSEL = 0x01;
                        ccucon0.B.UP = 1;
                        (*(volatile Ifx_SCU_CCUCON0*)0xF0036030u) = ccucon0;
                    }
...

                    {
                        ...
                        Ifx_SCU_CCUCON1 ccucon1;
                        ccucon1.U = (*(volatile Ifx_SCU_CCUCON1*)0xF0036034u).U & ~cfg->clockDistribution.ccucon1.mask;

                        ccucon1.U |= (cfg->clockDistribution.ccucon1.mask & cfg->clockDistribution.ccucon1.value);
                        ccucon1.B.INSEL = 1;
                        ccucon1.B.UP = 1;
                        (*(volatile Ifx_SCU_CCUCON1*)0xF0036034u) = ccucon1;
                    }
...

                    {
                        ...
                        Ifx_SCU_CCUCON2 ccucon2;
                        ccucon2.U = (*(volatile Ifx_SCU_CCUCON2*)0xF0036040u).U & ~cfg->clockDistribution.ccucon2.mask;

                        ccucon2.U |= (cfg->clockDistribution.ccucon2.mask & cfg->clockDistribution.ccucon2.value);
                        ccucon2.B.UP = 1;
                        (*(volatile Ifx_SCU_CCUCON2*)0xF0036040u) = ccucon2;
                    }
                    ...
                    {
                        Ifx_SCU_CCUCON5 ccucon5;
                        ccucon5.U = (*(volatile Ifx_SCU_CCUCON5*)0xF003604Cu).U & ~cfg->clockDistribution.ccucon5.mask;

                        ccucon5.U |= (cfg->clockDistribution.ccucon5.mask & cfg->clockDistribution.ccucon5.value);
                        ccucon5.B.UP = 1;
                        (*(volatile Ifx_SCU_CCUCON5*)0xF003604Cu) = ccucon5;
                    }

                    {
                        Ifx_SCU_CCUCON6 ccucon6;
                        ccucon6.U = (*(volatile Ifx_SCU_CCUCON6*)0xF0036080u).U & ~cfg->clockDistribution.ccucon6.mask;

                        ccucon6.U |= (cfg->clockDistribution.ccucon6.mask & cfg->clockDistribution.ccucon6.value);
                        (*(volatile Ifx_SCU_CCUCON6*)0xF0036080u) = ccucon6;
                    }

                    {

                        Ifx_SCU_CCUCON7 ccucon7;
                        ccucon7.U = (*(volatile Ifx_SCU_CCUCON7*)0xF0036084u).U & ~cfg->clockDistribution.ccucon7.mask;

                        ccucon7.U |= (cfg->clockDistribution.ccucon7.mask & cfg->clockDistribution.ccucon7.value);
                        (*(volatile Ifx_SCU_CCUCON7*)0xF0036084u) = ccucon7;
                    }

                    {

                        Ifx_SCU_CCUCON8 ccucon8;
                        ccucon8.U = (*(volatile Ifx_SCU_CCUCON8*)0xF0036088u).U & ~cfg->clockDistribution.ccucon8.mask;

                        ccucon8.U |= (cfg->clockDistribution.ccucon8.mask & cfg->clockDistribution.ccucon8.value);
                        (*(volatile Ifx_SCU_CCUCON8*)0xF0036088u) = ccucon8;
                    }
                }
        ...
        {
            Ifx_FLASH_FCON fcon;
            fcon.U = (*(volatile Ifx_FLASH_FCON*)0xF8002014u).U & ~cfg->flashFconWaitStateConfig.mask;
            ...
            {
                IfxScuWdt_clearCpuEndinit(endinit_pw);
                (*(volatile Ifx_FLASH_FCON*)0xF8002014u) = fcon;
                IfxScuWdt_setCpuEndinit(endinit_pw);
            }
        }
        ...
        {
            {
                ...
                (*(volatile Ifx_SCU_PLLCON1*)0xF003601Cu).B.K2DIV = cfg->sysPll.pllDividerStep[pllStepsCount].k2Step;
                IfxScuWdt_setSafetyEndinit(endinitSfty_pw);
            }
    ...
    {
        IfxScuWdt_clearSafetyEndinit(endinitSfty_pw);
        (*(volatile Ifx_SCU_PLLCON0*)0xF0036018u).B.OSCDISCDIS = 0U;
        IfxScuWdt_setSafetyEndinit(endinitSfty_pw);
    }
    {

        IfxScuWdt_clearCpuEndinit(endinit_pw);
        (*(volatile Ifx_SCU_TRAPCLR*)0xF003612Cu).B.SMUT = 1U;
        (*(volatile Ifx_SCU_TRAPDIS*)0xF0036130u).B.SMUT = smuTrapEnable;
        IfxScuWdt_setCpuEndinit(endinit_pw);
    }
    return status;
}
...
boolean IfxScuCcu_initErayPll(const IfxScuCcu_ErayPllConfig *cfg)
{
    ...
    if (!(*(volatile Ifx_SCU_PLLERAYCON0*)0xF0036028u).B.PLLPWD || (*(volatile Ifx_SCU_PLLERAYCON0*)0xF0036028u).B.VCOPWD || (*(volatile Ifx_SCU_PLLERAYSTAT*)0xF0036024u).B.PWDSTAT)
    {

        (*(volatile Ifx_SCU_PLLERAYCON0*)0xF0036028u).B.PLLPWD = 1;
        (*(volatile Ifx_SCU_PLLERAYCON0*)0xF0036028u).B.VCOPWD = 0;

        while ((*(volatile Ifx_SCU_PLLERAYSTAT*)0xF0036024u).B.PWDSTAT)
        {}
    ...
    if (!(*(volatile Ifx_SCU_PLLERAYSTAT*)0xF0036024u).B.VCOBYST)
    {
        while (!(*(volatile Ifx_SCU_PLLERAYSTAT*)0xF0036024u).B.K1RDY)
        {}

        (*(volatile Ifx_SCU_PLLERAYCON1*)0xF003602Cu).B.K1DIV = 3;


        (*(volatile Ifx_SCU_PLLERAYCON0*)0xF0036028u).B.VCOBYP = 1;
    }

    while (!(*(volatile Ifx_SCU_PLLERAYSTAT*)0xF0036024u).B.K2RDY)
    {}

    (*(volatile Ifx_SCU_PLLERAYCON1*)0xF003602Cu).B.K2DIV = cfg->pllInitialStep.k2Initial;
    (*(volatile Ifx_SCU_PLLERAYCON0*)0xF0036028u).B.PDIV = cfg->pllInitialStep.pDivider;
    (*(volatile Ifx_SCU_PLLERAYCON0*)0xF0036028u).B.NDIV = cfg->pllInitialStep.nDivider;
    ...
    (*(volatile Ifx_SCU_PLLERAYCON0*)0xF0036028u).B.RESLD = 1U;
    (*(volatile Ifx_SCU_PLLERAYCON0*)0xF0036028u).B.CLRFINDIS = 1U;

    IfxScuWdt_setSafetyEndinit(endinitSfty_pw);


    uint32 time_out_ctr = 50000;

    while (--time_out_ctr && !(*(volatile Ifx_SCU_PLLERAYSTAT*)0xF0036024u).B.VCOLOCK)
    {}
    ...
    (*(volatile Ifx_SCU_PLLERAYCON0*)0xF0036028u).B.VCOBYP = 0U;


    while ((*(volatile Ifx_SCU_PLLERAYSTAT*)0xF0036024u).B.VCOBYST)
    {}

    if (!(*(volatile Ifx_SCU_PLLERAYSTAT*)0xF0036024u).B.VCOLOCK)
    {
        status = 1;
    }
...
static boolean IfxScuCcu_isOscillatorStable(void)
{
    ...
    (*(volatile Ifx_SCU_OSCCON*)0xF0036010u).B.MODE = 0U;





    (*(volatile Ifx_SCU_OSCCON*)0xF0036010u).B.OSCVAL = ((uint32)IfxScuCcu_xtalFrequency / 2500000) - 1;


    (*(volatile Ifx_SCU_OSCCON*)0xF0036010u).B.OSCRES = 1U;
...
float32 IfxScuCcu_setCpuFrequency(IfxCpu_ResourceCpu cpu, float32 cpuFreq)
{
...

    {
        ...
        {
        case IfxCpu_ResourceCpu_0:
            (*(volatile Ifx_SCU_CCUCON6*)0xF0036080u).U = cpuDiv;
            break;
        case IfxCpu_ResourceCpu_1:
            (*(volatile Ifx_SCU_CCUCON7*)0xF0036084u).U = cpuDiv;
            break;
        case IfxCpu_ResourceCpu_2:
            (*(volatile Ifx_SCU_CCUCON8*)0xF0036088u).U = cpuDiv;
            break;
...
{
    uint16 l_SEndInitPW;
    Ifx_SCU_CCUCON1 ccucon1 = (*(volatile Ifx_SCU_CCUCON1*)0xF0036034u);

    float32 inputFreq = IfxScuCcu_getSourceFrequency();
    uint32 gtmDiv = (uint32)((((inputFreq / gtmFreq) - (sint32)(inputFreq / gtmFreq)) > 0.5) ? (1 + (sint32)(inputFreq / gtmFreq)) : ((sint32)(inputFreq / gtmFreq)));
...
float32 IfxScuCcu_setPll2ErayFrequency(float32 pll2ErayFreq)
{
    ...
    uint32 pll2Div = (uint32)((IfxScuCcu_getPllErayVcoFrequency() / pll2ErayFreq) - 1);
    {
        ...
        (*(volatile Ifx_SCU_PLLERAYCON1*)0xF003602Cu).B.K3DIV = pll2Div;
...
float32 IfxScuCcu_setPll2Frequency(float32 pll2Freq)
{
    ...
    {
        IfxScuWdt_clearSafetyEndinit(endinitSfty_pw);
        (*(volatile Ifx_SCU_PLLCON1*)0xF003601Cu).B.K3DIV = pll2Div;
        IfxScuWdt_setSafetyEndinit(endinitSfty_pw);
    }
...
float32 IfxScuCcu_setSpbFrequency(float32 spbFreq)
{
    ...
    (*(volatile Ifx_SCU_TRAPDIS*)0xF0036130u).U = (*(volatile Ifx_SCU_TRAPDIS*)0xF0036130u).U | 0x3E0U;
    ...
    ccucon0.U = (*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).U;
    ...
    IfxScuWdt_clearCpuEndinit(l_EndInitPW);
    (*(volatile Ifx_SCU_TRAPDIS*)0xF0036130u).U = (*(volatile Ifx_SCU_TRAPDIS*)0xF0036130u).U & (uint32)~0x3E0UL;
    IfxScuWdt_setCpuEndinit(l_EndInitPW);
...
float32 IfxScuCcu_setSriFrequency(float32 sriFreq)
{
    ...
    Ifx_SCU_CCUCON0 ccucon0;
    uint16 l_SEndInitPW;
    uint32 sriDiv = (uint32)((((source / sriFreq) - (sint32)(source / sriFreq)) > 0.5) ? (1 + (sint32)(source / sriFreq)) : ((sint32)(source / sriFreq)));
...
void IfxScuCcu_switchToBackupClock(const IfxScuCcu_Config *cfg)
{
    ...
    if ((*(volatile Ifx_SCU_CCUCON0*)0xF0036030u).B.CLKSEL == 0)
    {
        return;
    }
    ...
    {
        {
            ...
            (*(volatile Ifx_SCU_PLLCON1*)0xF003601Cu).B.K2DIV = cfg->sysPll.pllDividerStep[pllStepsCount - 1].k2Step;
...
static void IfxScuCcu_wait(float32 timeSec)
{
    ...
    uint32 stmCountBegin = (*(volatile Ifx_STM_TIM0*)0xF0000010u).U;

    while ((uint32)((*(volatile Ifx_STM_TIM0*)0xF0000010u).U - stmCountBegin) < stmCount)
    {
