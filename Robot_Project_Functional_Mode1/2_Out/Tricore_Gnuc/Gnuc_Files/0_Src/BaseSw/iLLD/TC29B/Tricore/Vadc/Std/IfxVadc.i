# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Vadc/Std/IfxVadc.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Vadc/Std/IfxVadc.c"
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/Vadc/Std/IfxVadc.c"
...
# 58 "0_Src/BaseSw/iLLD/TC29B/Tricore/Vadc/Std/IfxVadc.h" 2
...
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Vadc/Std/IfxVadc.c" 2
...
boolean IfxVadc_isPostCalibration(Ifx_VADC *vadc, IfxVadc_GroupId group)
{
    ...
    case IfxVadc_GroupId_7: pcEnabled = vadc->GLOBCFG.B.DPCAL7 == 0;
        break;
    case IfxVadc_GroupId_8: pcEnabled = vadc->GLOBCFG.B.DPCAL8 == 0;
        break;
    case IfxVadc_GroupId_9: pcEnabled = vadc->GLOBCFG.B.DPCAL9 == 0;
        break;
    case IfxVadc_GroupId_10: pcEnabled = vadc->GLOBCFG.B.DPCAL10 == 0;
        break;
    default: pcEnabled = 0;
        break;
    }
...
void IfxVadc_startupCalibration(Ifx_VADC *vadc)
{
    ...
    do
    {
        ...
        for (adcCalGroupNum = 0; adcCalGroupNum < (11); adcCalGroupNum++)
        {
