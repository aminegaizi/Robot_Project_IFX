# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.c"
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.c"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h" 1
# 40 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Impl/IfxFlash_cfg.h" 1
# 39 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Impl/IfxFlash_cfg.h"
...
# 40 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Impl/IfxFlash_cfg.h" 2
# 119 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Impl/IfxFlash_cfg.h"
typedef enum
{
...
extern const IfxFlash_flashSector IfxFlash_dFlashTableEepLog[(96)];

extern const IfxFlash_flashSector IfxFlash_dFlashTableHsmLog[(8)];
...
extern const IfxFlash_flashSector IfxFlash_pFlashTableLog[((4) * 27)];

extern const IfxFlash_flashSector IfxFlash_pFlashTablePhys[((4) * 4)];
# 41 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h" 2
...
# 42 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h" 2
...
# 39 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxFlash_regdef.h"
# 1 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/Ifx_TypesReg.h" 1
# 40 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxFlash_regdef.h" 2
...
# 43 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h" 2
# 52 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
typedef enum
{
...
typedef enum
{
    ...
    IfxFlash_PortId_PortId_2 = 2,
    IfxFlash_PortId_PortId_3 = 3
} IfxFlash_PortId;
# 81 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
typedef struct
{
    uint32 address;
    IfxFlash_ErrorTracking errorType;
} IfxFlash_ErrorTracking_Address;
# 100 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
static inline __attribute__ ((always_inline)) void IfxFlash_clearStatus(uint32 flash);
# 117 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
static inline __attribute__ ((always_inline)) uint8 IfxFlash_enterPageMode(uint32 pageAddr);
# 133 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
static inline __attribute__ ((always_inline)) void IfxFlash_eraseMultiplePhysicalSectors(uint32 sectorAddr, uint32 numSector);
# 149 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
static inline __attribute__ ((always_inline)) void IfxFlash_eraseMultipleSectors(uint32 sectorAddr, uint32 numSector);
# 165 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
static inline __attribute__ ((always_inline)) void IfxFlash_erasePhysicalSector(uint32 sectorAddr);
# 187 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
static inline __attribute__ ((always_inline)) void IfxFlash_eraseSector(uint32 sectorAddr);
...
static inline __attribute__ ((always_inline)) void IfxFlash_eraseVerifyMultipleSectors(uint32 sectorAddr, uint32 numSector);





static inline __attribute__ ((always_inline)) void IfxFlash_eraseVerifySector(uint32 sectorAddr);
# 219 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
static inline __attribute__ ((always_inline)) void IfxFlash_loadPage(uint32 pageAddr, uint32 wordL, uint32 wordU);
# 238 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
static inline __attribute__ ((always_inline)) void IfxFlash_loadPage2X32(uint32 pageAddr, uint32 wordL, uint32 wordU);
# 253 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
static inline __attribute__ ((always_inline)) void IfxFlash_resetToRead(uint32 flash);





static inline __attribute__ ((always_inline)) void IfxFlash_resumeProtection(uint32 flash);
...
static inline __attribute__ ((always_inline)) void IfxFlash_suspendResumeMultipleSectors(uint32 sectorAddr, uint32 numSector);





static inline __attribute__ ((always_inline)) void IfxFlash_suspendResumeSector(uint32 sectorAddr);
# 288 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
static inline __attribute__ ((always_inline)) uint8 IfxFlash_waitUnbusy(uint32 flash, IfxFlash_FlashType flashType);
# 303 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
static inline __attribute__ ((always_inline)) void IfxFlash_writeBurst(uint32 pageAddr);
# 318 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
static inline __attribute__ ((always_inline)) void IfxFlash_writePage(uint32 pageAddr);
# 333 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
static inline __attribute__ ((always_inline)) void IfxFlash_writePageOnce(uint32 pageAddr);
# 345 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
extern void IfxFlash_disableWriteProtection(uint32 flash, IfxFlash_UcbType ucb, uint32 *password);
# 360 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
...
# 405 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
...
# 430 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
...
# 457 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
extern void IfxFlash_selectCorrectableErrorTracking(IfxFlash_PortId portId, IfxFlash_ErrorTracking errorTracking);
# 467 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
extern void IfxFlash_selectUncorrectableErrorTracking(IfxFlash_PortId portId, IfxFlash_ErrorTracking errorTracking);
# 478 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
static inline __attribute__ ((always_inline)) boolean IfxFlash_waitUnbusyAll(void);
...
# 698 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.h"
    else
    {
        return 1;
    }
...
static inline __attribute__ ((always_inline)) boolean IfxFlash_waitUnbusyAll(void)
{
    while ((*(volatile Ifx_FLASH_FSR*)0xF8002010u).U & 0x7EU)
    {}

    __dsync();
    return 0;
}
# 31 "0_Src/BaseSw/iLLD/TC29B/Tricore/Flash/Std/IfxFlash.c" 2
