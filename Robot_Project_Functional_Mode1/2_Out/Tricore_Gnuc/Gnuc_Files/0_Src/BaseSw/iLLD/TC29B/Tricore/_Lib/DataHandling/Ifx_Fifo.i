# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_Fifo.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_Fifo.c"
# 26 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_Fifo.c"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_Fifo.h" 1
# 33 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_Fifo.h"
# 1 "0_Src/AppSw/CpuGeneric/Config/Ifx_Cfg.h" 1
# 34 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_Fifo.h" 2
...
# 35 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_Fifo.h" 2
...
# 27 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_Fifo.c" 2
...
# 12 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-2.0\\tricore\\include\\stdlib.h" 2 3
...
# 18 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-2.0\\tricore\\include\\stdlib.h" 2 3
...
# 28 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_Fifo.c" 2
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_CircularBuffer.h" 1
# 49 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_CircularBuffer.h"
...
# 67 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_CircularBuffer.h"
void *Ifx_CircularBuffer_read8(Ifx_CircularBuffer *buffer, void *data, Ifx_SizeT count);
# 77 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_CircularBuffer.h"
void *Ifx_CircularBuffer_read32(Ifx_CircularBuffer *buffer, void *data, Ifx_SizeT count);
# 87 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_CircularBuffer.h"
const void *Ifx_CircularBuffer_write8(Ifx_CircularBuffer *buffer, const void *data, Ifx_SizeT count);
# 97 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_CircularBuffer.h"
const void *Ifx_CircularBuffer_write32(Ifx_CircularBuffer *buffer, const void *data, Ifx_SizeT count);
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_Fifo.c" 2
...
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_Fifo.c" 2
...
# 31 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_Fifo.c" 2
# 1 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Bsp.h" 1
# 39 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Bsp.h"
...
# 32 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_Fifo.c" 2
# 51 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Lib/DataHandling/Ifx_Fifo.c"
Ifx_Fifo *Ifx_Fifo_create(Ifx_SizeT size, Ifx_SizeT elementSize)
{
    Ifx_Fifo *fifo = ((void *)0);
...
Ifx_Fifo *Ifx_Fifo_init(void *buffer, Ifx_SizeT size, Ifx_SizeT elementSize)
{
...

    {
        ...
        fifo->eventReader = 0;
        fifo->eventWriter = 1;
        fifo->buffer = (uint8 *)((((((uint32)fifo) + sizeof(Ifx_Fifo)) + ((8) - 1)) & (~((8) - 1))));
        fifo->shared.count = 0;
...
boolean Ifx_Fifo_canReadCount(Ifx_Fifo *fifo, Ifx_SizeT count, Ifx_TickTime timeout)
{
    ...
    else
    {
        ...
        else
        {
            ...
            while ((fifo->eventReader == 0) && (isDeadLine(DeadLine) == 0))
            {}

            result = fifo->eventReader == 1;
        }
    }
...
Ifx_SizeT Ifx_Fifo_read(Ifx_Fifo *fifo, void *data, Ifx_SizeT count, Ifx_TickTime timeout)
{
    ...
    if (count != 0)
    {
        ...
        do
        {
            ...
            if ((Stop != 0) || (isDeadLine(DeadLine) != 0))
            {
                break;
            }
...
boolean Ifx_Fifo_canWriteCount(Ifx_Fifo *fifo, Ifx_SizeT count, Ifx_TickTime timeout)
{
    ...
    else
    {
        ...
        else
        {
            ...
            while ((fifo->eventWriter == 0) && (isDeadLine(DeadLine) == 0))
            {}

            result = fifo->eventWriter == 1;
        }
    }
...
static Ifx_SizeT Ifx_Fifo_endWrite(Ifx_Fifo *fifo, Ifx_SizeT count, Ifx_SizeT blockSize)
{
    ...
    fifo->shared.count += blockSize;
    fifo->shared.maxcount = __max(fifo->shared.maxcount, fifo->shared.count);
...
Ifx_SizeT Ifx_Fifo_write(Ifx_Fifo *fifo, const void *data, Ifx_SizeT count, Ifx_TickTime timeout)
{
    ...
    if (count != 0)
    {
        buffer.base = fifo->buffer;
        buffer.length = (uint16)fifo->size;
        buffer.index = (uint16)fifo->endIndex;
        DeadLine = getDeadLine(timeout);
