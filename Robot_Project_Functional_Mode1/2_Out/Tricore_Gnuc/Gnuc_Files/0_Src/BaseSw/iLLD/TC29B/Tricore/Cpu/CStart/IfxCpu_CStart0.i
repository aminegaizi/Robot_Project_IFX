# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart0.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart0.c"
# 27 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart0.c"
# 1 "0_Src/AppSw/CpuGeneric/Config/Ifx_Cfg.h" 1
# 28 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart0.c" 2
...
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart0.c" 2
...
# 31 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart0.c" 2

# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart.h" 1
# 61 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart.h"
void _Core1_start(void);
void _Core2_start(void);
# 33 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart0.c" 2
# 69 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart0.c"
...
# 87 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart0.c"
...
{
    uint32 pcxi;
    uint16 cpuWdtPassword = IfxScuWdt_getCpuWatchdogPasswordInline(&(*(Ifx_SCU*)0xF0036000u).WDTCPU[0]);

    ;


    { uint32 reg_val= (uint32)__USTACK0; __asm__ volatile (" mov.a\t %%""sp"",%0"::"d"(reg_val)); };
    __dsync();
    ...
    pcxi = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFE00" : "=d" (__res) :: "memory"); __res; }));
    pcxi &= (0xfff00000u);
    do { unsigned __newval = (unsigned) (pcxi); __asm__ volatile ("mtcr LO:" "0xFE00" ", %0" :: "d" (__newval) : "memory"); } while (0);
    ...
    IfxScuWdt_clearCpuEndinitInline(&(*(Ifx_SCU*)0xF0036000u).WDTCPU[0], cpuWdtPassword);


    do { unsigned __newval = (unsigned) ((uint32)__TRAPTAB_CPU0); __asm__ volatile ("mtcr LO:" "0xFE24" ", %0" :: "d" (__newval) : "memory"); } while (0);


    do { unsigned __newval = (unsigned) ((uint32)__INTTAB_CPU0); __asm__ volatile ("mtcr LO:" "0xFE20" ", %0" :: "d" (__newval) : "memory"); } while (0);


    do { unsigned __newval = (unsigned) ((uint32)__ISTACK0); __asm__ volatile ("mtcr LO:" "0xFE28" ", %0" :: "d" (__newval) : "memory"); } while (0);

    IfxScuWdt_setCpuEndinitInline(&(*(Ifx_SCU*)0xF0036000u).WDTCPU[0], cpuWdtPassword);


    { uint32 reg_val= (uint32)__A0_MEM; __asm__ volatile (" mov.a\t %%""a0"",%0"::"d"(reg_val)); };
    { uint32 reg_val= (uint32)__A1_MEM; __asm__ volatile (" mov.a\t %%""a1"",%0"::"d"(reg_val)); };


    { uint32 reg_val= (uint32)__A8_MEM; __asm__ volatile (" mov.a\t %%""a8"",%0"::"d"(reg_val)); };
    { uint32 reg_val= (uint32)__A9_MEM; __asm__ volatile (" mov.a\t %%""a9"",%0"::"d"(reg_val)); };


    IfxCpu_initCSA((uint32 *)__CSA0, (uint32 *)__CSA0_END);
    ...
    (void)IfxScuCcu_init(&IfxScuCcu_defaultClockConfig);;



    (void)IfxCpu_startCore(&(*(Ifx_CPU*)0xF8830000u), (uint32)&_Core1_start);


    (void)IfxCpu_startCore(&(*(Ifx_CPU*)0xF8850000u), (uint32)&_Core2_start);
# 170 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart0.c"
    __asm__ volatile ("ji %0"::"a"(core0_main));
}
...
# 191 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart0.c"
void _START(void)
{
    __asm__ volatile ("ji %0"::"a"(_Core0_start));
}
...
#pragma section
# 216 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart0.c"
#pragma section
#pragma section ".bmhd_0" a
# 229 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart0.c"
...
#pragma section
# 255 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart0.c"
#pragma section
#pragma section ".bmhd_1" a
# 269 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart0.c"
