# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Atom.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Atom.c"
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Atom.c"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Atom.h" 1
# 43 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Atom.h"
...
# 44 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Atom.h" 2
...
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Atom.c" 2
# 1 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxGtm_bf.h" 1
# 31 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Atom.c" 2
# 44 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Atom.c"
...
void IfxGtm_Atom_Agc_enableChannel(Ifx_GTM_ATOM_AGC *agc, IfxGtm_Atom_Ch channel, boolean enabled, boolean immediate)
{
    ...
    value = IfxGtm_Atom_Agc_buildFeatureForChannel(channel, enabled, (0u));
...
{
    agc->GLB_CTRL.U = IfxGtm_Atom_Agc_buildFeatureForChannel(channel, enabled, (16u));
}
...
void IfxGtm_Atom_Agc_enableChannels(Ifx_GTM_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask, boolean immediate)
{
    ...
    value = IfxGtm_Atom_Agc_buildFeature(enableMask, disableMask, (0u));
...
{
    agc->INT_TRIG.U = IfxGtm_Atom_Agc_buildFeature(enableMask, disableMask, (0u));
}


void IfxGtm_Atom_Agc_enableChannelsUpdate(Ifx_GTM_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask)
{
    agc->GLB_CTRL.U = IfxGtm_Atom_Agc_buildFeature(enableMask, disableMask, (16u));
}
...
void IfxGtm_Atom_Agc_setChannelForceUpdate(Ifx_GTM_ATOM_AGC *agc, IfxGtm_Atom_Ch channel, boolean enabled, boolean resetEnabled)
{
    ...
    regEnable = IfxGtm_Atom_Agc_buildFeatureForChannel(channel, enabled, (0u));
    regReset = IfxGtm_Atom_Agc_buildFeatureForChannel(channel, resetEnabled, (16u));
...
void IfxGtm_Atom_Agc_setChannelsForceUpdate(Ifx_GTM_ATOM_AGC *agc, uint16 enableMask, uint16 disableMask, uint16 resetEnableMask, uint16 resetDisableMask)
{
    ...
    regEnable = IfxGtm_Atom_Agc_buildFeature(enableMask, disableMask, (0u));
    regReset = IfxGtm_Atom_Agc_buildFeature(resetEnableMask, resetDisableMask, (16u));
...
float32 IfxGtm_Atom_Ch_getClockFrequency(Ifx_GTM *gtm, Ifx_GTM_ATOM *atom, IfxGtm_Atom_Ch channel)
{
    ...
    return IfxGtm_Cmu_getClkFrequency(gtm, clock, 1);
}
...
{
    return &(*(Ifx_SRC*)0xF0038000u).GTM.GTM[0].ATOM[atom][channel / 2];
}


volatile uint32 *IfxGtm_Atom_Ch_getTimerPointer(Ifx_GTM_ATOM *atom, IfxGtm_Atom_Ch channel)
{
    return (volatile uint32 *)((uint32)&(atom->CH0.CN0.U) + channel * (__builtin_offsetof (Ifx_GTM_ATOM, CH1) - __builtin_offsetof (Ifx_GTM_ATOM, CH0)));
}
...
void IfxGtm_Atom_Ch_setNotification(Ifx_GTM_ATOM *atom, IfxGtm_Atom_Ch channel, IfxGtm_IrqMode mode, boolean interruptOnCompareZero, boolean interruptOnCompareOne)
{
    ...
    atomCh->IRQ_EN.U = (0x0000000000000000U);
