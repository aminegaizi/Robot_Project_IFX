# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Multican/Std/IfxMultican.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Multican/Std/IfxMultican.c"
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/Multican/Std/IfxMultican.c"
...
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Multican/Std/IfxMultican.c" 2
# 42 "0_Src/BaseSw/iLLD/TC29B/Tricore/Multican/Std/IfxMultican.c"
...
static void IfxMultican_MsgObj_doReadLongFrame(Ifx_CAN *mcan, IfxMultican_MsgObjId msgObjId, IfxMultican_Message *msg, uint32 *data)
{
    ...
    if (lengthCode > IfxMultican_DataLengthCode_0)
    {
        *data++ = hwObj->DATAL.U;
        *data++ = hwObj->DATAH.U;
    }
...
IfxMultican_Status IfxMultican_MsgObj_readLongFrame(Ifx_CAN *mcan, IfxMultican_MsgObjId msgObjId, IfxMultican_Message *msg, uint32 *data)
{
    ...
    boolean longFrame = (hwObj->FCR.B.FDF != 0) ? 1 : 0;
...
IfxMultican_Status IfxMultican_MsgObj_sendLongFrame(Ifx_CAN *mcan, IfxMultican_MsgObjId msgObjId, IfxMultican_Message *msg, uint32 *data)
{
    ...
    if (longFrame)
    {
        ...
        else
        {
            ...
            if (msg->lengthCode > IfxMultican_DataLengthCode_0)
            {
                hwObj->DATAL.U = *data++;
                hwObj->DATAH.U = *data++;
            }
...
IfxMultican_Status IfxMultican_MsgObj_sendMessage(Ifx_CAN_MO *hwObj, const IfxMultican_Message *msg)
{
    ...
    else
    {
        ...
        hwObj->DATAL.U = msg->data[0];
        hwObj->DATAH.U = msg->data[1];
...
{
    sint32 maxBRP = (0x3fu) + 1;
    sint32 minBRP = 1;
    sint32 maxTSEG1 = (0xfu) + 1;
    sint32 minTSEG1 = 3;
    sint32 maxTSEG2 = (0x7u) + 1;
    sint32 minTSEG2 = 2;
...
# 649 "0_Src/BaseSw/iLLD/TC29B/Tricore/Multican/Std/IfxMultican.c"
    bestError = baudrate * 0.05;
    ...
    for (tempBRP = 1; tempBRP <= maxBRP; tempBRP++)
    {
        ...
        float32 error = ( ((tempBaudrate - baudrate) < 0.0) ? -(tempBaudrate - baudrate) : (tempBaudrate - baudrate) );
    ...
    for (tempTSEG1 = maxTSEG1; tempTSEG1 >= minTSEG1; tempTSEG1--)
    {
        ...
        sint32 error = __builtin_abs(tempSamplePoint - samplePoint);
    ...
    for (tempSJW = 1; tempSJW <= bestTSEG2; tempSJW++)
    {
        ...
        sint32 error = __builtin_abs(tempSynchJumpWidth - synchJumpWidth);
...
void IfxMultican_Node_setFastBitTiming(Ifx_CAN_N *hwNode, float32 moduleFreq, uint32 baudrate, uint16 samplePoint, uint16 synchJumpWidth)
{
    ...
    float32 bestError = 10000.0;
    boolean baudrateTooLow, baudrateTooHigh, samplepointNotSuitable;
# 815 "0_Src/BaseSw/iLLD/TC29B/Tricore/Multican/Std/IfxMultican.c"
    bestError = baudrate * 0.05;
...
void IfxMultican_Node_setNominalBitTiming(Ifx_CAN_N *hwNode, float32 moduleFreq, uint32 baudrate, uint16 samplePoint, uint16 synchJumpWidth)
{
    sint32 maxBRP = (0x3fu) + 1;
    sint32 minBRP = 1;
    sint32 maxTSEG1 = (0x3fu) + 1;
    sint32 minTSEG1 = 3;
    sint32 maxTSEG2 = (0x1fu) + 1;
    sint32 minTSEG2 = 2;
    sint32 maxTBAUD = maxTSEG1 + maxTSEG2 + 1;
    sint32 minTBAUD = 8;
    ...
    float32 bestError = 10000.0;
    boolean baudrateTooLow, baudrateTooHigh, samplepointNotSuitable;
# 979 "0_Src/BaseSw/iLLD/TC29B/Tricore/Multican/Std/IfxMultican.c"
    bestError = baudrate * 0.05;
...
void IfxMultican_deinit(Ifx_CAN *mcan)
{
    ...
    for (i = 0; i < numSrcs; i++)
    {
        if (mcan == &(*(Ifx_CAN*)0xF0028000u))
        {
            (*(Ifx_SRC*)0xF0038000u).CANR.CANR[0].RINT[i].U = 0x00000000;
        }
        else
        {
            (*(Ifx_SRC*)0xF0038000u).CAN.CAN[0].INT[i].U = 0x00000000;
        }
    }
...
{
    volatile Ifx_SRC_SRCR *srcSFR = ((void *)0);

    if (mcan == &(*(Ifx_CAN*)0xF0028000u))
    {
        if (srcId <= IfxMultican_SrcId_7)
        {
            srcSFR = &((*(Ifx_SRC*)0xF0038000u).CANR.CANR[0].RINT[srcId]);
        }
        else
        {
            ((void)0);
    ...
    {
        srcSFR = &((*(Ifx_SRC*)0xF0038000u).CAN.CAN[0].INT[srcId]);
    }
