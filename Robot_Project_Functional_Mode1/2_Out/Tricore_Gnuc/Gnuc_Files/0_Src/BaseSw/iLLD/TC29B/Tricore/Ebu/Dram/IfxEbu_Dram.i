# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/Dram/IfxEbu_Dram.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/Dram/IfxEbu_Dram.c"
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/Dram/IfxEbu_Dram.c"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/Dram/IfxEbu_Dram.h" 1
# 92 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/Dram/IfxEbu_Dram.h"
...
# 93 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/Dram/IfxEbu_Dram.h" 2
...
# 94 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/Dram/IfxEbu_Dram.h" 2
# 103 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/Dram/IfxEbu_Dram.h"
typedef enum
{
    IfxEbu_Dram_SDRAMDevice_64Mx16bit = 0,
    IfxEbu_Dram_SDRAMDevice_32Mx16bit,
    IfxEbu_Dram_SDRAMDevice_16Mx16,
    IfxEbu_Dram_SDRAMDevice_8Mx16,
    IfxEbu_Dram_SDRAMDevice_4Mx16,
    IfxEbu_Dram_SDRAMDevice_1Mx16,
...
# 125 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/Dram/IfxEbu_Dram.h"
typedef struct
{
    Ifx_EBU *ebu;
...
# 165 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/Dram/IfxEbu_Dram.h"
extern void IfxEbu_Dram_initMemory(IfxEbu_Dram *dram, const IfxEbu_Dram_Config *config);




extern void IfxEbu_Dram_initMemoryConfig(IfxEbu_Dram_Config *config, Ifx_EBU *ebu);
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/Dram/IfxEbu_Dram.c" 2
...
void IfxEbu_Dram_initMemory(IfxEbu_Dram *dram, const IfxEbu_Dram_Config *config)
{
...

    {
        ...
        for (pin = 2; pin < 16; ++pin)
        {
            if (pin < 8)
            {
                IfxPort_setPinMode(&(*(Ifx_P*)0xF003C100u), pin, IfxPort_OutputIdx_alt6);
            }
            else
            {
                IfxPort_setPinMode(&(*(Ifx_P*)0xF003C500u), pin, IfxPort_OutputIdx_alt6);
            }
        }


        IfxPort_setPinMode(&(*(Ifx_P*)0xF003C100u), 0, IfxPort_OutputIdx_alt7);
        IfxPort_setPinMode(&(*(Ifx_P*)0xF003C100u), 1, IfxPort_OutputIdx_alt7);
    }
    ...
    if (config->syncReadAccessParameter.externalClock == 0)
    {
        ...
        busrcon.U = 0;
        busrcon.B.PORTW = deviceInterface;
    ...
    if (config->syncWriteAccessParameter.externalClock == 0)
    {
        ...
        buswcon.U = 0;
        buswcon.B.PORTW = deviceInterface;
...
void IfxEbu_Dram_initMemoryConfig(IfxEbu_Dram_Config *config, Ifx_EBU *ebu)
{
    ...
    config->sdramControlConfig.columnAddressWidth = IfxEbu_ColumnAddressWidth_1;
    config->sdramControlConfig.rowToColumnDelay = 3;
    config->sdramControlConfig.refreshCycleTime = 0x13;
    config->sdramControlConfig.maskForBankTag = IfxEbu_MaskForBankTag_4;
    ...
    config->sdramModConfig.extendedBankSelect = 0;
