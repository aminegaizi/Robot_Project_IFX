# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tom.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tom.c"
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tom.c"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tom.h" 1
# 43 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tom.h"
...
# 44 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tom.h" 2
...
# 45 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tom.h" 2
...
# 46 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tom.h" 2
...
# 47 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tom.h" 2
...
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tom.c" 2
# 1 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxGtm_bf.h" 1
# 31 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tom.c" 2
...
# 32 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tom.c" 2
...
float32 IfxGtm_Tom_Ch_getClockFrequency(Ifx_GTM *gtm, Ifx_GTM_TOM *tom, IfxGtm_Tom_Ch channel)
{
    ...
    {
        return IfxGtm_Cmu_getFxClkFrequency(gtm, clkIndex[clock], 1);
    }
}
...
{
    return &(*(Ifx_SRC*)0xF0038000u).GTM.GTM[0].TOM[tom][channel / 2];
}
...
void IfxGtm_Tom_Ch_setNotification(Ifx_GTM_TOM *tom, IfxGtm_Tom_Ch channel, IfxGtm_IrqMode mode, boolean interruptOnCompareZero, boolean interruptOnCompareOne)
{
    ...
    tomCh->IRQ_EN.U = (0x0000000000000000U);
...
void IfxGtm_Tom_Tgc_enableChannel(Ifx_GTM_TOM_TGC *tgc, IfxGtm_Tom_Ch channel, boolean enabled, boolean immediate)
{
    ...
    value = IfxGtm_Tom_Tgc_buildFeatureForChannel(channel, enabled, (0u));
...
{
    tgc->GLB_CTRL.U = IfxGtm_Tom_Tgc_buildFeatureForChannel(channel, enabled, (16u));
}
...
void IfxGtm_Tom_Tgc_enableChannels(Ifx_GTM_TOM_TGC *tgc, uint16 enableMask, uint16 disableMask, boolean immediate)
{
    ...
    value = IfxGtm_Tom_Tgc_buildFeature(enableMask, disableMask, (0u));
...
{
    tgc->INT_TRIG.U = IfxGtm_Tom_Tgc_buildFeature(enableMask, disableMask, (0u));
}


void IfxGtm_Tom_Tgc_enableChannelsUpdate(Ifx_GTM_TOM_TGC *tgc, uint16 enableMask, uint16 disableMask)
{
    tgc->GLB_CTRL.U = IfxGtm_Tom_Tgc_buildFeature(enableMask, disableMask, (16u));
}
...
void IfxGtm_Tom_Tgc_setChannelForceUpdate(Ifx_GTM_TOM_TGC *tgc, IfxGtm_Tom_Ch channel, boolean enabled, boolean resetEnabled)
{
    ...
    regEnable = IfxGtm_Tom_Tgc_buildFeatureForChannel(channel, enabled, (0u));
    regReset = IfxGtm_Tom_Tgc_buildFeatureForChannel(channel, resetEnabled, (16u));
...
void IfxGtm_Tom_Tgc_setChannelsForceUpdate(Ifx_GTM_TOM_TGC *tgc, uint16 enableMask, uint16 disableMask, uint16 resetEnableMask, uint16 resetDisableMask)
{
    ...
    regEnable = IfxGtm_Tom_Tgc_buildFeature(enableMask, disableMask, (0u));
    regReset = IfxGtm_Tom_Tgc_buildFeature(resetEnableMask, resetDisableMask, (16u));
