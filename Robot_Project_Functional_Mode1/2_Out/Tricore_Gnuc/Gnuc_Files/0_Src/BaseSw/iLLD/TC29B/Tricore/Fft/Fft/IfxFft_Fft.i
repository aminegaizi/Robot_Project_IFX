# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.c"
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.c"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h" 1
# 190 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h"
# 1 "0_Src/BaseSw/Service/CpuGeneric/_Utilities/Ifx_Assert.h" 1
# 33 "0_Src/BaseSw/Service/CpuGeneric/_Utilities/Ifx_Assert.h"
# 1 "0_Src/AppSw/CpuGeneric/Config/Ifx_Cfg.h" 1
# 34 "0_Src/BaseSw/Service/CpuGeneric/_Utilities/Ifx_Assert.h" 2
...
# 191 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h" 2
# 1 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxFft_bf.h" 1
# 192 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h" 2
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Std/IfxFft.h" 1
# 37 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Std/IfxFft.h"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Impl/IfxFft_cfg.h" 1
# 38 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Std/IfxFft.h" 2
...
# 39 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Std/IfxFft.h" 2
...
# 40 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Std/IfxFft.h" 2
# 1 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxFft_reg.h" 1
# 36 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxFft_reg.h"
# 1 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxFft_regdef.h" 1
# 45 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxFft_regdef.h"
...
typedef struct _Ifx_FFT_CSR_Bits
{
    ...
    volatile unsigned int LENGTH:4;
    volatile unsigned int IFFT:1;
    volatile unsigned int WIN_BYP:1;
    volatile unsigned int reserved_14:2;
    volatile unsigned int IN_FMT:2;
    volatile unsigned int OUT_FMT:1;
    volatile unsigned int BUSY:1;
    volatile unsigned int RFS:1;
...
# 240 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxFft_regdef.h"
typedef volatile struct _Ifx_FFT
{
    Ifx_FFT_CLC CLC;
    unsigned char reserved_4[4];
    Ifx_FFT_ID ID;
    unsigned char reserved_C[52];
    Ifx_FFT_CSR CSR;
    unsigned char reserved_44[28];
    Ifx_FFT_HISTORY0 HISTORY0;
    unsigned char reserved_64[12];
    Ifx_FFT_HISTORY1 HISTORY1;
    unsigned char reserved_74[112];
    Ifx_FFT_ODA ODA;
    Ifx_FFT_OCS OCS;
    Ifx_FFT_KRSTCLR KRSTCLR;
    Ifx_FFT_KRST1 KRST1;
    Ifx_FFT_KRST0 KRST0;
    unsigned char reserved_F8[8];
} Ifx_FFT;
# 37 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxFft_reg.h" 2
# 41 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Std/IfxFft.h" 2
# 1 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxLmu_reg.h" 1
# 36 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxLmu_reg.h"
# 1 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxLmu_regdef.h" 1
# 45 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxLmu_regdef.h"
...
# 286 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxLmu_regdef.h"
...
# 305 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxLmu_regdef.h"
...
# 37 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxLmu_reg.h" 2
# 42 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Std/IfxFft.h" 2
...
# 43 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Std/IfxFft.h" 2
# 53 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Std/IfxFft.h"
typedef enum
{
    IfxFft_Input_complexSInt32 = 0,
    IfxFft_Input_realSInt32 = 1,
    IfxFft_Input_complexSInt16 = 2,
    IfxFft_Input_realSInt16 = 3
} IfxFft_Input;
...
typedef enum
{
    IfxFft_Operation_fft = 0,
    IfxFft_Operation_ifft = 1
} IfxFft_Operation;
...
typedef enum
{
    IfxFft_Output_complexSInt32 = 0,
    IfxFft_Output_complexSInt16 = 1
} IfxFft_Output;
...
typedef enum
{
    IfxFft_SuspendMode_none = 0,
    IfxFft_SuspendMode_hard = 1,
    IfxFft_SuspendMode_soft = 2
} IfxFft_SuspendMode;
# 118 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Std/IfxFft.h"
static inline __attribute__ ((always_inline)) void IfxFft_disableModule(Ifx_FFT *fft, Ifx_LMU *lmu);
...
static inline __attribute__ ((always_inline)) void IfxFft_enableModule(Ifx_FFT *fft, Ifx_LMU *lmu);





static inline __attribute__ ((always_inline)) IfxFft_Input IfxFft_getInputFormat(Ifx_FFT *fft);





static inline __attribute__ ((always_inline)) IfxFft_Length IfxFft_getLength(Ifx_FFT *fft);





static inline __attribute__ ((always_inline)) IfxFft_Length IfxFft_getLengthCode(uint16 length);





static inline __attribute__ ((always_inline)) uint16 IfxFft_getLengthFromCode(IfxFft_Length length);





static inline __attribute__ ((always_inline)) IfxFft_Output IfxFft_getOutputFormat(Ifx_FFT *fft);





static inline __attribute__ ((always_inline)) volatile Ifx_SRC_SRCR *IfxFft_getSrcPointerDone(Ifx_FFT *fft);





static inline __attribute__ ((always_inline)) volatile Ifx_SRC_SRCR *IfxFft_getSrcPointerRfs(Ifx_FFT *fft);





static inline __attribute__ ((always_inline)) uint16 IfxFft_getTransformLength(Ifx_FFT *fft);





static inline __attribute__ ((always_inline)) boolean IfxFft_isEngineBusy(Ifx_FFT *fft);





static inline __attribute__ ((always_inline)) boolean IfxFft_isModuleEnabled(Ifx_FFT *fft);
...
static inline __attribute__ ((always_inline)) boolean IfxFft_isModuleSuspended(Ifx_FFT *fft);





static inline __attribute__ ((always_inline)) boolean IfxFft_isReadyForStart(Ifx_FFT *fft);
...
static inline __attribute__ ((always_inline)) void IfxFft_setSuspendMode(Ifx_FFT *fft, IfxFft_SuspendMode mode);
...
static inline __attribute__ ((always_inline)) IfxFft_Length IfxFft_getLengthCode(uint16 length)
{
    return (IfxFft_Length)(31 - __builtin_clz((uint32)length));
}
...
static inline __attribute__ ((always_inline)) volatile Ifx_SRC_SRCR *IfxFft_getSrcPointerDone(Ifx_FFT *fft)
{
    ...
    return &(*(Ifx_SRC*)0xF0038000u).FFT.FFT[0].DONE;
}
...
static inline __attribute__ ((always_inline)) volatile Ifx_SRC_SRCR *IfxFft_getSrcPointerRfs(Ifx_FFT *fft)
{
    ...
    return &(*(Ifx_SRC*)0xF0038000u).FFT.FFT[0].RFS;
}
...
# 193 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h" 2
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Dma/IfxDma_Dma.h" 1
# 431 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Dma/IfxDma_Dma.h"
...
# 432 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Dma/IfxDma_Dma.h" 2
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h" 1
# 50 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
# 1 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxDma_bf.h" 1
# 51 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h" 2

# 1 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxDma_reg.h" 1
# 36 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxDma_reg.h"
# 1 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxDma_regdef.h" 1
# 45 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxDma_regdef.h"
...
# 1040 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxDma_regdef.h"
...
# 1074 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxDma_regdef.h"
...
# 1107 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxDma_regdef.h"
...
# 37 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxDma_reg.h" 2
# 53 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h" 2
...
# 56 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h" 2
# 66 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
typedef enum
{
...
# 415 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 432 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 448 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 505 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 519 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 529 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 543 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 619 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 704 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 715 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 730 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 806 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 852 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 1068 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 1085 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 1102 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 1141 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 1154 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 1174 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Std/IfxDma.h"
...
# 433 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Dma/IfxDma_Dma.h" 2
# 443 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Dma/IfxDma_Dma.h"
typedef struct
{
    Ifx_DMA *dma;
} IfxDma_Dma;
...
# 529 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Dma/IfxDma_Dma.h"
...
# 672 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Dma/IfxDma_Dma.h"
...
# 682 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Dma/IfxDma_Dma.h"
...
# 691 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dma/Dma/IfxDma_Dma.h"
...
# 194 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h" 2
# 211 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h"
typedef struct IfxFft_Fft_Job_s IfxFft_Fft_Job;
# 221 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h"
typedef struct
{
    Ifx_FFT *fft;
    Ifx_LMU *lmu;
    IfxDma_Dma_Channel inputDmaChannel;
    IfxDma_Dma_Channel outputDmaChannel;
    IfxDma_Dma_Channel discardDmaChannel;
    uint32 flags;
    uint32 inputIdx;
    uint32 intraIdx;
    Ifx_SRC_SRCR_Bits srcrOutDis;
    Ifx_SRC_SRCR_Bits srcrOutEnd;
    IfxFft_Fft_Job *job[2];
} IfxFft_Fft;
...
typedef struct
{
    Ifx_FFT *fft;
    Ifx_LMU *lmu;
    Ifx_Priority inputPriority;
    Ifx_Priority intraPriority;
    Ifx_Priority outputPriority;
    IfxSrc_Tos typeOfService;
    IfxDma_ChannelId inputDmaChannelId;
    IfxDma_ChannelId outputDmaChannelId;
    IfxDma_ChannelId discardDmaChannelId;
} IfxFft_Fft_Config;
...
typedef struct
{
    ...
    uint16 inputLength;
    uint16 outputLength;
    IfxFft_Length fftLength;
    IfxFft_Input inputFormat;
    IfxFft_Output outputFormat;
    IfxFft_Operation operation;
    boolean useWindowFunction;
    const void *inputPtr;
    void *outputPtr;
...
struct IfxFft_Fft_Job_s
{
    ...
    const void *inputPtr;
    void *outputPtr;
    IfxFft_Fft_Count64 count64;
    IfxFft_Fft_Job *nextJob;
};
# 310 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h"
extern void IfxFft_Fft_initModule(IfxFft_Fft *fft, const IfxFft_Fft_Config *config);
# 321 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h"
extern void IfxFft_Fft_initModuleConfig(IfxFft_Fft_Config *config, Ifx_FFT *fft, Ifx_LMU *lmu);
# 336 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h"
extern void IfxFft_Fft_isrInput(IfxFft_Fft *fft);





extern void IfxFft_Fft_isrOutput(IfxFft_Fft *fft);
# 358 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h"
extern void IfxFft_Fft_cloneAndLinkJobs(IfxFft_Fft_Job *originalJob, IfxFft_Fft_Job *newJob);
# 368 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h"
extern void IfxFft_Fft_initJob(IfxFft_Fft_Job *job, const IfxFft_Fft_JobConfig *jobConfig);
# 378 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h"
extern void IfxFft_Fft_initJobConfig(IfxFft_Fft_JobConfig *config, IfxFft_Fft *fft);
...
extern void IfxFft_Fft_initWindow(IfxFft_Fft *fft, const uint64 *windowData);
...
extern void IfxFft_Fft_modifyDataPointers(IfxFft_Fft_Job *job, const void *inputPtr, void *outputPtr);
# 402 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h"
extern boolean IfxFft_Fft_startJob(IfxFft_Fft_Job *job);
# 413 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h"
static inline __attribute__ ((always_inline)) void IfxFft_Fft_triggerEngine(Ifx_FFT *fft, uint32 csr);
# 422 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.h"
extern void IfxFft_Fft_isrIntra(IfxFft_Fft *fft);
...
extern void IfxFft_Fft_initDma(IfxFft_Fft *fft, const IfxFft_Fft_Config *config);
...
static inline __attribute__ ((always_inline)) void IfxFft_Fft_triggerEngine(Ifx_FFT *fft, uint32 csr)
{
    ...
    fft->CSR.U = csr | ((0x1u) << (0u));

}
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.c" 2
# 70 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.c"
static uint32 IfxFft_Fft_calcCSR(const IfxFft_Fft_JobConfig *config);
# 85 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.c"
static void IfxFft_Fft_unloadOutput(IfxFft_Fft_Job *job);





static void IfxFft_Fft_loadInput(IfxFft_Fft_Job *job);
# 104 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.c"
static void IfxFft_Fft_calcCounters(IfxFft_Fft_Job *job, const IfxFft_Fft_JobConfig *jobConfig);





static uint64 IfxFft_Fft_dummy256[4];
...
static uint32 IfxFft_Fft_calcCSR(const IfxFft_Fft_JobConfig *config)
{
    uint32 csr =
        (config->fftLength << (8u)) |
        (config->inputFormat << (16u)) |
        (config->outputFormat << (18u)) |
        (config->operation << (12u)) |
        ((config->useWindowFunction ? 0U : 1U) << (13u));
    return csr;
}
...
static void IfxFft_Fft_unloadOutput(IfxFft_Fft_Job *job)
{
    ...
    IfxDma_setChannelDestinationAddress(dmaSFR, (dmaOutput->channelId), job->outputPtr);
    IfxDma_setChannelTransferCount(dmaSFR, (dmaOutput->channelId), job->count64.output);
    ...
    if (discardCount > 0)
    {
        ...
        IfxDma_setChannelDestinationAddress(dmaSFR, (dmaDiscard->channelId), IfxFft_Fft_dummy256);
        IfxDma_setChannelTransferCount(dmaSFR, (dmaDiscard->channelId), discardCount);





        srcr = IfxDma_getSrcPointer(dmaSFR, (dmaOutput->channelId));
    ...
    IfxDma_startChannelTransaction(dmaSFR, (dmaOutput->channelId));
# 212 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.c"
}
...
void IfxFft_Fft_initJobConfig(IfxFft_Fft_JobConfig *config, IfxFft_Fft *fft)
{
    ...
    config->useWindowFunction = 0;
    config->inputPtr = ((void *)0);
    config->outputPtr = ((void *)0);
}
...
void IfxFft_Fft_initModule(IfxFft_Fft *fft, const IfxFft_Fft_Config *config)
{
    ...
    if (IfxFft_isModuleEnabled(fftSFR) == 0)
    {
...
# 308 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.c"
}
...
void IfxFft_Fft_initModuleConfig(IfxFft_Fft_Config *config, Ifx_FFT *fft, Ifx_LMU *lmu)
{
    ...
    config->fft = fft;
    config->lmu = lmu;
# 324 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.c"
    config->fft = fft;
    config->lmu = lmu;
...
void IfxFft_Fft_initWindow(IfxFft_Fft *fft, const uint64 *windowData)
{
    ...
    uint64 *wmem = (uint64 *)0xBE100000U;

    for (i = 0; i < ((2048 / 2) / (sizeof(uint64) / sizeof(uint16))); i++)
    {
        *(wmem++) = *(ptr++);
    }
}
...
# 466 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.c"
}
...
# 485 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.c"
    IfxDma_setChannelSourceAddress(dmaSFR, (dmaInput->channelId), job->inputPtr);
    IfxDma_setChannelTransferCount(dmaSFR, (dmaInput->channelId), job->count64.input);
    IfxDma_startChannelTransaction(dmaSFR, (dmaInput->channelId));
# 505 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.c"
}
...
static void IfxFft_Fft_calcCounters(IfxFft_Fft_Job *job, const IfxFft_Fft_JobConfig *jobConfig)
{
    ...
    job->count64.input = (jobConfig->inputLength >> shift) / 4;
    job->count64.expect = (fftLength >> shift) / 4;
    ...
    job->count64.result = (fftLength >> shift) / 4;
    job->count64.output = (jobConfig->outputLength >> shift) / 4;
...
# 642 "0_Src/BaseSw/iLLD/TC29B/Tricore/Fft/Fft/IfxFft_Fft.c"
    IfxDma_Dma dma;
    ...
    dmaCfg.moveSize = IfxDma_ChannelMoveSize_256bit;
...

    {
        ...
        dmaCfg.sourceAddress = 0xBE000000U;
    ...
    }
    {
        ...
        dmaCfg.hardwareRequestEnabled = 1;
    ...
    }
    {
        ...
        dmaCfg.destinationAddress = 0xBE000000U;
