# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dsadc/Dsadc/IfxDsadc_Dsadc.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dsadc/Dsadc/IfxDsadc_Dsadc.c"
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dsadc/Dsadc/IfxDsadc_Dsadc.c"
...
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dsadc/Dsadc/IfxDsadc_Dsadc.c" 2
# 40 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dsadc/Dsadc/IfxDsadc_Dsadc.c"
static sint32 IfxDsadc_Dsadc_calcDIVx(float32 sourceFreq, float32 *targetFreq);
...
static void IfxDsadc_Dsadc_initAuxFilter(IfxDsadc_Dsadc_Channel *channel, const IfxDsadc_Dsadc_AuxFilterConfig *config);
...
static void IfxDsadc_Dsadc_initCombFilter(IfxDsadc_Dsadc_Channel *channel, const IfxDsadc_Dsadc_CombFilterConfig *config);
...
static void IfxDsadc_Dsadc_initDemodulator(IfxDsadc_Dsadc_Channel *channel, const IfxDsadc_Dsadc_DemodulatorConfig *config);
...
static void IfxDsadc_Dsadc_initFirFilter(IfxDsadc_Dsadc_Channel *channel, const IfxDsadc_Dsadc_FirFilterConfig *config);
...
static void IfxDsadc_Dsadc_initIntegrator(IfxDsadc_Dsadc_Channel *channel, const IfxDsadc_Dsadc_IntegratorConfig *config);
...
static void IfxDsadc_Dsadc_initModulator(IfxDsadc_Dsadc_Channel *channel, const IfxDsadc_Dsadc_ModulatorConfig *config);
...
static void IfxDsadc_Dsadc_initRectifier(IfxDsadc_Dsadc_Channel *channel, const IfxDsadc_Dsadc_RectifierConfig *config);
...
static sint32 IfxDsadc_Dsadc_calcDIVx(float32 sourceFreq, float32 *targetFreq)
{
    ...
    for (i = 2; i <= 32; i += 2)
    {
        ...
        float32 error = ( ((freq - *targetFreq) < 0.0) ? -(freq - *targetFreq) : (freq - *targetFreq) );
...
void IfxDsadc_Dsadc_initCarrierGen(IfxDsadc_Dsadc *dsadc, const IfxDsadc_Dsadc_CarrierGenConfig *config)
{
    ...
    cgcfg.B.SIGPOL = (config->inverted == 0) ? 0 : 1;
    cgcfg.B.BREV = (config->bitReversed == 0) ? 0 : 1;
...
static void IfxDsadc_Dsadc_initCombFilter(IfxDsadc_Dsadc_Channel *channel, const IfxDsadc_Dsadc_CombFilterConfig *config)
{
    ...
    fcfgc.B.CFEN = (config->bypassed == 0) ? 1 : 0;
...
static void IfxDsadc_Dsadc_initFirFilter(IfxDsadc_Dsadc_Channel *channel, const IfxDsadc_Dsadc_FirFilterConfig *config)
{
    ...
    fcfgm.B.FIR0EN = (config->fir0Enabled != 0) ? 1 : 0;
    fcfgm.B.FIR1EN = (config->fir1Enabled != 0) ? 1 : 0;
    fcfgm.B.OCEN = (config->offsetCompensation != 0) ? 1 : 0;
...
void IfxDsadc_Dsadc_initCarrierGenConfig(IfxDsadc_Dsadc_CarrierGenConfig *config)
{
    ...
    config->pinNeg = ((void *)0);
    config->pinPos = ((void *)0);
}
