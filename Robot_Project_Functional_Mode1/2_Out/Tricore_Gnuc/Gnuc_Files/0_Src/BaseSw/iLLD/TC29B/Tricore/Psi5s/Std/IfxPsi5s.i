# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Psi5s/Std/IfxPsi5s.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Psi5s/Std/IfxPsi5s.c"
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/Psi5s/Std/IfxPsi5s.c"
...
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Psi5s/Std/IfxPsi5s.c" 2
...
{
    uint32 enableChannels = ((((psi5s->GCR.U >> (8u)) & ~mask) | channels) << (8u));

    psi5s->GCR.U = (psi5s->GCR.U & ~(((1 << 8) - 1) << 8)) | enableChannels;
}


void IfxPsi5s_enableDisableChannels(Ifx_PSI5S *psi5s, uint32 channels, uint32 mask)
{
    uint32 enableChannels = ((((psi5s->GCR.U >> (16u)) & ~mask) | channels) << (16u));

    psi5s->GCR.U = (psi5s->GCR.U & ~(((1 << 8) - 1) << 16)) | enableChannels;
}
