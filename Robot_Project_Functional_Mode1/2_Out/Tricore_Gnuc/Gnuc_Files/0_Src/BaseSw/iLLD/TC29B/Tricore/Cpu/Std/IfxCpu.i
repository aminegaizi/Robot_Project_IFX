# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/Std/IfxCpu.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/Std/IfxCpu.c"
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/Std/IfxCpu.c"
...
# 31 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/Std/IfxCpu.c" 2
...
IfxCpu_CoreMode IfxCpu_getCoreMode(Ifx_CPU *cpu)
{
    ...
    {
        dbgsr.U = (__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFD00" : "=d" (__res) :: "memory"); __res; }));
    }
    ...
    else
    {
        if (dbgsr.B.HALT == (uint32)IfxCpu_DBGST_HALT_run)
        {
            ...
            pmcsr_val = &(*(Ifx_SCU*)0xF0036000u).PMCSR[index];
...
{
# 142 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/Std/IfxCpu.c"
    uint32 x = *seed;
    ...
    uint32 m = 0xfffffffb;
    uint32 result;
# 163 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/Std/IfxCpu.c"
...
# 217 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/Std/IfxCpu.c"
    * seed = result;
...
{
# 363 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/Std/IfxCpu.c"
    uint8 reqslp;
    boolean retValue;
    IfxCpu_ResourceCpu index = IfxCpu_getIndex(cpu);
    ...
    if (retValue == 1)
    {
        ...
        if (IfxCpu_getCoreIndex() != index)
        {
            ...
            (*(Ifx_SCU*)0xF0036000u).PMCSR[(uint32)IfxCpu_getIndex(cpu)].B.REQSLP = reqslp;
        ...
        else
        {
            ...
            (*(Ifx_SCU*)0xF0036000u).PMCSR[(uint32)index].B.REQSLP = reqslp;
...
{
    volatile uint32 *sync = (volatile uint32 *)((((((unsigned)(event) & 0xF0000000) == 0xD0000000) ? ((((unsigned)(event) & 0x000fffff) | 0x70000000) - (((__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFE1C" : "=d" (__res) :: "memory"); __res; }))) * 0x10000000)) : (unsigned)(event))));
    ...
    while ((*sync & (0x7)) != (0x7))
    {
        ...
        if ((uint32)((*(volatile Ifx_STM_TIM0*)0xF0000010u).U - stmCountBegin) >= stmCount)
        {
            errorcnt = 1;
            break;
        }
...
{
    {long long tmp; __asm__("imask %A0,%1,%2,%3" :"=d"((long long)tmp) :"d"(1),"d"((__extension__({ unsigned __res; __asm__ volatile ("mfcr %0, LO:" "0xFE1C" : "=d" (__res) :: "memory"); __res; }))),"i"(1): "memory"); __asm__("ldmst [%0]0,%A1"::"a"(event),"d"(tmp): "memory");};
}
