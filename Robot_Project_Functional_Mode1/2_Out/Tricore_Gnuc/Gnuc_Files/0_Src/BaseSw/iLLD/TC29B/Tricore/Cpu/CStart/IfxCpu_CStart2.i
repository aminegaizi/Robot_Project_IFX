# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart2.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart2.c"
# 28 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart2.c"
# 1 "0_Src/AppSw/CpuGeneric/Config/Ifx_Cfg.h" 1
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart2.c" 2
...
# 31 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart2.c" 2
...
# 32 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart2.c" 2
...
# 33 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart2.c" 2
# 51 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart2.c"
extern unsigned int __A0_MEM[]; extern unsigned int __A1_MEM[]; extern unsigned int __A8_MEM[]; extern unsigned int __A9_MEM[];
extern unsigned int __USTACK2[]; extern unsigned int __ISTACK2[]; extern unsigned int __INTTAB_CPU2[]; extern unsigned int __TRAPTAB_CPU2[]; extern unsigned int __CSA2[]; extern unsigned int __CSA2_END[];

extern void core2_main(void);
# 68 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/CStart/IfxCpu_CStart2.c"
...
{
    uint32 pcxi;
    uint16 wdtPassword = IfxScuWdt_getCpuWatchdogPasswordInline(&(*(Ifx_SCU*)0xF0036000u).WDTCPU[2]);

    ;


    { uint32 reg_val= (uint32)__USTACK2; __asm__ volatile (" mov.a\t %%""sp"",%0"::"d"(reg_val)); };
    __dsync();
    ...
    IfxScuWdt_clearCpuEndinitInline(&(*(Ifx_SCU*)0xF0036000u).WDTCPU[2], wdtPassword);


    do { unsigned __newval = (unsigned) ((uint32)__TRAPTAB_CPU2); __asm__ volatile ("mtcr LO:" "0xFE24" ", %0" :: "d" (__newval) : "memory"); } while (0);


    do { unsigned __newval = (unsigned) ((uint32)__INTTAB_CPU2); __asm__ volatile ("mtcr LO:" "0xFE20" ", %0" :: "d" (__newval) : "memory"); } while (0);


    do { unsigned __newval = (unsigned) ((uint32)__ISTACK2); __asm__ volatile ("mtcr LO:" "0xFE28" ", %0" :: "d" (__newval) : "memory"); } while (0);

    IfxScuWdt_setCpuEndinitInline(&(*(Ifx_SCU*)0xF0036000u).WDTCPU[2], wdtPassword);
    ...
    IfxCpu_initCSA((uint32 *)__CSA2, (uint32 *)__CSA2_END);


    __asm__ volatile ("ji %0"::"a"(core2_main));
}
