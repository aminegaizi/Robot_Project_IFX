# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Atom/Pwm/IfxGtm_Atom_Pwm.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Atom/Pwm/IfxGtm_Atom_Pwm.c"
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Atom/Pwm/IfxGtm_Atom_Pwm.c"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Atom/Pwm/IfxGtm_Atom_Pwm.h" 1
# 106 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Atom/Pwm/IfxGtm_Atom_Pwm.h"
...
# 107 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Atom/Pwm/IfxGtm_Atom_Pwm.h" 2

# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Cmu.h" 1
# 109 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Atom/Pwm/IfxGtm_Atom_Pwm.h" 2
...
# 110 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Atom/Pwm/IfxGtm_Atom_Pwm.h" 2
# 119 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Atom/Pwm/IfxGtm_Atom_Pwm.h"
typedef struct
{
    boolean ccu0Enabled;
    boolean ccu1Enabled;
...
typedef struct
{
    ...
    IfxGtm_Atom_Pwm_Interrupt interrupt;
    IfxGtm_Atom_Pwm_pin pin;
...
# 185 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Atom/Pwm/IfxGtm_Atom_Pwm.h"
extern boolean IfxGtm_Atom_Pwm_init(IfxGtm_Atom_Pwm_Driver *driver, const IfxGtm_Atom_Pwm_Config *config);
...
extern void IfxGtm_Atom_Pwm_initConfig(IfxGtm_Atom_Pwm_Config *config, Ifx_GTM *gtm);
...
extern void IfxGtm_Atom_Pwm_start(IfxGtm_Atom_Pwm_Driver *driver, boolean immediate);
...
extern void IfxGtm_Atom_Pwm_stop(IfxGtm_Atom_Pwm_Driver *driver, boolean immediate);
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Atom/Pwm/IfxGtm_Atom_Pwm.c" 2
...
boolean IfxGtm_Atom_Pwm_init(IfxGtm_Atom_Pwm_Driver *driver, const IfxGtm_Atom_Pwm_Config *config)
{
    ...
    {
        IfxGtm_Atom_Agc_enableChannelUpdate(agc, config->atomChannel, 1);
    }

    IfxGtm_Atom_Agc_setChannelForceUpdate(agc, config->atomChannel, 1, 1);
    ...
    if (config->pin.outputPin != ((void *)0))
    {
    ...
    IfxGtm_Atom_Agc_enableChannel(agc, config->atomChannel, 1, 0);
    IfxGtm_Atom_Agc_enableChannelOutput(agc, config->atomChannel, 1, 0);

    if (config->immediateStartEnabled == 1)
    {
...
void IfxGtm_Atom_Pwm_initConfig(IfxGtm_Atom_Pwm_Config *config, Ifx_GTM *gtm)
{
    ...
    config->oneShotModeEnabled = 0;
    config->synchronousUpdateEnabled = 0;
    config->immediateStartEnabled = 1;
    config->interrupt.ccu0Enabled = 0;
    config->interrupt.ccu1Enabled = 0;
...
void IfxGtm_Atom_Pwm_start(IfxGtm_Atom_Pwm_Driver *driver, boolean immediate)
{
    ...
    IfxGtm_Atom_Agc_enableChannel(driver->agc, driver->atomChannel, 1, immediate);
    IfxGtm_Atom_Agc_enableChannelOutput(driver->agc, driver->atomChannel, 1, immediate);
...
void IfxGtm_Atom_Pwm_stop(IfxGtm_Atom_Pwm_Driver *driver, boolean immediate)
{
    ...
    IfxGtm_Atom_Agc_enableChannel(driver->agc, driver->atomChannel, 0, immediate);
    IfxGtm_Atom_Agc_enableChannelOutput(driver->agc, driver->atomChannel, 0, immediate);
