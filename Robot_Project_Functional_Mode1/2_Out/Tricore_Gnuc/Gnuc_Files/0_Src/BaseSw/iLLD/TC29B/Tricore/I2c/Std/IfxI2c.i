# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/I2c/Std/IfxI2c.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/I2c/Std/IfxI2c.c"
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/I2c/Std/IfxI2c.c"
...
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/I2c/Std/IfxI2c.c" 2
...
void IfxI2c_configureAsMaster(Ifx_I2C *i2c)
{
    ...
    i2c->ADDRCFG.U = 0;
    i2c->ADDRCFG.B.MnS = 1;
    i2c->ADDRCFG.B.SONA = 0;
    i2c->ADDRCFG.B.SOPE = 0;
    i2c->ADDRCFG.B.TBAM = 0;
    i2c->FIFOCFG.U = 0;
    i2c->FIFOCFG.B.TXFC = 1;
    i2c->FIFOCFG.B.RXFC = 1;
    i2c->FIFOCFG.B.TXBS = 0;
    i2c->FIFOCFG.B.RXBS = 0;
    i2c->FIFOCFG.B.TXFA = 0;
    i2c->FIFOCFG.B.RXFA = 0;
}
...
void IfxI2c_initSclSdaPin(const IfxI2c_Scl_InOut *scl, const IfxI2c_Sda_InOut *sda, IfxPort_PadDriver padDriver)
{
    ...
    IfxI2c_setPinSelection(scl->module, (IfxI2c_PinSelect)scl->inSelect);
}
