# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/BFlashSt/IfxEbu_BFlashSt.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/BFlashSt/IfxEbu_BFlashSt.c"
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/BFlashSt/IfxEbu_BFlashSt.c"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/BFlashSt/IfxEbu_BFlashSt.h" 1
# 101 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/BFlashSt/IfxEbu_BFlashSt.h"
...
# 102 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/BFlashSt/IfxEbu_BFlashSt.h" 2
...
# 104 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/BFlashSt/IfxEbu_BFlashSt.h" 2
...
# 183 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/BFlashSt/IfxEbu_BFlashSt.h"
extern void IfxEbu_BFlashSt_initMemory(IfxEbu_BFlashSt *bflash, const IfxEbu_BFlashSt_Config *config);





extern void IfxEbu_BFlashSt_initMemoryConfig(IfxEbu_BFlashSt_Config *config, Ifx_EBU *ebu);
# 205 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/BFlashSt/IfxEbu_BFlashSt.h"
extern void IfxEbu_BFlashSt_eraseBlock(const IfxEbu_BFlashSt *bflash, uint32 blockAddress);
...
extern void IfxEbu_BFlashSt_programWord(const void *bflash, uint32 address, uint32 data);





extern boolean IfxEbu_BFlashSt_waitForReady(const IfxEbu_BFlashSt *bflash);
# 235 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/BFlashSt/IfxEbu_BFlashSt.h"
extern void IfxEbu_BFlashSt_cmdBlockErase(const IfxEbu_BFlashSt *bflash, uint32 blockAddress);
...
extern void IfxEbu_BFlashSt_cmdClearBlockProtection(const IfxEbu_BFlashSt *bflash, uint32 blockAddress);





extern void IfxEbu_BFlashSt_cmdClearStatusRegister(const IfxEbu_BFlashSt *bflash);





extern void IfxEbu_BFlashSt_cmdEraseAllMainBlocks(const IfxEbu_BFlashSt *bflash);





extern void IfxEbu_BFlashSt_cmdProgramEraseResume(const IfxEbu_BFlashSt *bflash);





extern void IfxEbu_BFlashSt_cmdProgramEraseSuspend(const IfxEbu_BFlashSt *bflash);





extern void IfxEbu_BFlashSt_cmdProgramTuningProtection(const IfxEbu_BFlashSt *bflash);
...
extern void IfxEbu_BFlashSt_cmdProgramWord(const IfxEbu_BFlashSt *bflash, uint32 address, uint32 data);





extern uint32 IfxEbu_BFlashSt_cmdReadElectronicSignature(const IfxEbu_BFlashSt *bflash, uint32 signatureOffset);





extern void IfxEbu_BFlashSt_cmdReadMemoryArray(const IfxEbu_BFlashSt *bflash);





extern void IfxEbu_BFlashSt_cmdReadQuery(const IfxEbu_BFlashSt *bflash);





extern uint32 IfxEbu_BFlashSt_cmdReadStatus(const IfxEbu_BFlashSt *bflash);
...
extern void IfxEbu_BFlashSt_cmdSetBlockProtection(const IfxEbu_BFlashSt *bflash, uint32 blockAddress);
...
extern void IfxEbu_BFlashSt_cmdSetBurstConfig(const IfxEbu_BFlashSt *bflash, IfxEbu_BFlashSt_BurstCfg burstCfg);





extern void IfxEbu_BFlashSt_cmdUnlockTuningProtection(const IfxEbu_BFlashSt *bflash);
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Ebu/BFlashSt/IfxEbu_BFlashSt.c" 2
...
void IfxEbu_BFlashSt_eraseBlock(const IfxEbu_BFlashSt *bflash, uint32 blockAddress)
{
    ...
    if (bflash->hasTuningProtection != 0)
    {
...
void IfxEbu_BFlashSt_initMemory(IfxEbu_BFlashSt *bflash, const IfxEbu_BFlashSt_Config *config)
{
...

    {
        ...
        addrsel.B.BASE = (config->memoryRegionConfig.baseAddress >> 12);
    ...
    if (config->syncReadAccessParameter.externalClock == 0)
    {
...

        {
            ...
            busrap.U = 0;
            busrap.B.ADDRC = config->asyncReadAccessParameter.addressCycle;
            busrap.B.AHOLDC = config->asyncReadAccessParameter.addressHold;
            busrap.B.CMDDELAY = config->asyncReadAccessParameter.commandDelay;
...
void IfxEbu_BFlashSt_initMemoryConfig(IfxEbu_BFlashSt_Config *config, Ifx_EBU *ebu)
{
    ...
    config->memoryRegionConfig.regionEnabled = 1;
    config->memoryRegionConfig.alternateSegmentEnabled = 1;
    config->memoryRegionConfig.writeProtection = 0;
    config->memoryRegionConfig.combinedChipSelect = 0;
