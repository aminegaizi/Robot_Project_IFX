# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tbu.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tbu.c"
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tbu.c"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tbu.h" 1
# 39 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tbu.h"
...
# 40 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tbu.h" 2
...
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tbu.c" 2
...
# 31 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Tbu.c" 2
...
float32 IfxGtm_Tbu_getClockFrequency(Ifx_GTM *gtm, IfxGtm_Tbu_Ts channel)
{
    ...
    {
        result = IfxGtm_Cmu_getClkFrequency(gtm, gtm->TBU.CH0_CTRL.B.CH_CLK_SRC, 1);
    }
    else if (channel == IfxGtm_Tbu_Ts_1)
    {
        result = IfxGtm_Cmu_getClkFrequency(gtm, gtm->TBU.CH1_CTRL.B.CH_CLK_SRC, 1);
    }
    else if (channel == IfxGtm_Tbu_Ts_2)
    {
        result = IfxGtm_Cmu_getClkFrequency(gtm, gtm->TBU.CH2_CTRL.B.CH_CLK_SRC, 1);
    }
