# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Port/Std/IfxPort.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Port/Std/IfxPort.c"
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/Port/Std/IfxPort.c"
...
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Port/Std/IfxPort.c" 2
...
boolean IfxPort_disableEmergencyStop(Ifx_P *port, uint8 pinIndex)
{
    ...
    for (portIndex = 0; portIndex < (21); portIndex++)
    {
...
Ifx_P *IfxPort_getAddress(IfxPort_Index port)
{
    ...
    if (port < (21))
    {
        module = (Ifx_P *)IfxPort_cfg_indexMap[port].module;
    }
    else
    {
        module = ((void *)0);
...
void IfxPort_setPinModeLvdsMedium(Ifx_P *port, uint8 pinIndex, IfxPort_PadDriver lvdsPadDriver, IfxPort_PadSupply padSupply)
{
    ...
    IfxScuWdt_clearCpuEndinit(passwd);
    {
        pdr[pdrOffset].U = (lvdsPadDriver << shift);
