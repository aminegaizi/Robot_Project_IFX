# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuWdt.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuWdt.c"
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuWdt.c"
...
# 31 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuWdt.c" 2
...
# 32 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuWdt.c" 2
# 45 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuWdt.c"
...
void IfxScuWdt_initConfig(IfxScuWdt_Config *config)
{
    ...
    config->disableWatchdog = 0;
    config->enableSmuRestriction = 0;
    config->enableAutomaticPasswordChange = 0;
    config->enableTimerCheck = 0;
    config->enableTimerCheckTolerance = 0;
    config->clrInternalResetFlag = 0;
}
...
boolean IfxScuWdt_enableWatchdogWithDebugger(void)
{
    ...
    boolean oenNotEnabled = 1, watchdogNotEnabled = 1;
    uint32 ostateValue;
