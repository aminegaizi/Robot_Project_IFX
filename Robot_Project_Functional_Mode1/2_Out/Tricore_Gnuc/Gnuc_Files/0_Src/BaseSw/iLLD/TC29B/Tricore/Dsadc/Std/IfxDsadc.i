# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dsadc/Std/IfxDsadc.c"
# 1 "C:\\Robot_Project\\Robot_Project_Bluetooth_V2//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dsadc/Std/IfxDsadc.c"
# 29 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dsadc/Std/IfxDsadc.c"
...
# 30 "0_Src/BaseSw/iLLD/TC29B/Tricore/Dsadc/Std/IfxDsadc.c" 2
...
{
    return &((*(Ifx_SRC*)0xF0038000u).DSADC.DSADC[channel].SRA);
}
...
{
    return &((*(Ifx_SRC*)0xF0038000u).DSADC.DSADC[channel].SRM);
}
...
void IfxDsadc_resetModule(Ifx_DSADC *dsadc)
{
    ...
    while (0 == dsadc->KRST0.B.RSTSTAT)

    {}

    IfxScuWdt_clearCpuEndinit(passwd);
    dsadc->KRSTCLR.B.CLR = 1;
    IfxScuWdt_setCpuEndinit(passwd);
}
