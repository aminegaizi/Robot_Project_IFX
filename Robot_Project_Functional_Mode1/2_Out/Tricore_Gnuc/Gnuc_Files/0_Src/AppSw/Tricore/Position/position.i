...
volatile float Encoder_Values[100][2];
volatile float Position_Values[100][2];
...
void position_data()
{
 Encoder_Values[iterator][0] = interruptLeft_counter;
 Encoder_Values[iterator][1] = interruptRight_counter;
...
void update_position()
{
 ...
 Delta.Position = (Encoder_Values[iterator-1][0] + Encoder_Values[iterator-1][1])*0.510/2;
 Delta.Angle = (Encoder_Values[iterator-1][0] - Encoder_Values[iterator-1][1])*0.510/(12.5);

 Old_position.x = Current_position.x;
 Old_position.y = Current_position.y;
 Old_position.theta = Current_position.theta;

 Current_position.x = Old_position.x + Delta.Position*cosf(Current_position.theta + (Delta.Angle/2));
 Current_position.y = Old_position.y + Delta.Position*sinf(Current_position.theta + (Delta.Angle/2));
 Current_position.theta = Old_position.theta + Delta.Angle;

 if (Current_position.theta <= -2*3.14159265358979323846)
 {
  Current_position.theta = fmod(Current_position.theta, 2*3.14159265358979323846);
 }
 if (Current_position.theta >= 2*3.14159265358979323846)
 {
  Current_position.theta = fmod(Current_position.theta, 2*3.14159265358979323846);
 }
 degree_angle = (Current_position.theta * 360)/(2*3.14159265358979323846);
}
...
void Find_error()
{
 ...
 Error.angular = atan2f(Delta_ref.dy,Delta_ref.dx) - Current_position.theta;
 Error.linear = sqrt(powf(Delta_ref.dx,2)+powf(Delta_ref.dy, 2))*cosf(atan2f(Delta_ref.dy,Delta_ref.dx)-Current_position.theta);
}
