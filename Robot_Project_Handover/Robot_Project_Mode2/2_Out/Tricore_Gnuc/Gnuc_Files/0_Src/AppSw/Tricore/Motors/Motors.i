...
P_coefficient Forward_correction = {-1.0,-1.0,-1.0};
P_coefficient Backward_correction = {-1.0,-1.0,-1.0};
P_coefficient Right_correction = {-1.0,-1.0,-1.0};
...
void STM_INTERRUPT_CORRECTION()
{
 ...
 if (command_movement == 5 || command_movement == 6)
 {
 ...
 if (command_movement == 7 || command_movement == 8)
 {
