...
.intr.entry.include:                                
.endif                                              
.intr.entry ISR_SensorFeedback,0,15
	.ifndef .intr.entry.include                        
.altmacro                                           
.macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code 
	.pushsection .\intEntryLabel,"ax",@progbits   
...
.LC1:
	.string	"E = %0.4f W.h"
#NO_APP
.section .text.ISR_SensorFeedback,"ax",@progbits
	.align 1
	.global	ISR_SensorFeedback
	.type	ISR_SensorFeedback, @function
ISR_SensorFeedback:
.LFB589:
...
.LVL0:
	.loc 1 39 0
	ld.w	%d4, [%a15] lo:I
	movh.a	%a12, hi:current
	st.w	[%a12] lo:current, %d4
	.loc 1 40 0
	call	__extendsfdf2
.LVL1:
	movh.a	%a5, hi:.LC0
...
.LVL12:
	.loc 1 47 0
	movh.a	%a4, hi:timerSensorFeedback
	lea	%a4, [%a4] lo:timerSensorFeedback
	call	IfxGtm_Atom_Timer_acknowledgeTimerIrq
.LVL13:
	rslcx
	rfe
.LFE589:
	.size	ISR_SensorFeedback, .-ISR_SensorFeedback
.section .text.ISR_SensorFeedBack_Config,"ax",@progbits
	.align 1
	.global	ISR_SensorFeedBack_Config
	.type	ISR_SensorFeedBack_Config, @function
...
.LVL14:
	...
	mov	%d15, 15
	.loc 1 68 0
	movh.a	%a15, hi:timerSensorFeedback
	.loc 1 63 0
	st.w	[%SP] 12, %d2
	.loc 1 61 0
	st.h	[%SP] 8, %d15
	...
	mov	%d15, 0
	.loc 1 68 0
	lea	%a15, [%a15] lo:timerSensorFeedback
	mov.aa	%a4, %a15
	lea	%a5, [%SP] 4
	.loc 1 62 0
	st.b	[%SP] 10, %d15
...
.LVL16:
.LFE590:
	.size	ISR_SensorFeedBack_Config, .-ISR_SensorFeedBack_Config
	.global	__nedf2
	.global	__gedf2
	.global	__ledf2
...
timerObstacleAvoidance:
	.zero	48
	.global	timerSensorFeedback
.section .bss.timerSensorFeedback,"aw",@nobits
	.align 2
	.type	timerSensorFeedback, @object
	.size	timerSensorFeedback, 48
timerSensorFeedback:
	.zero	48
...
.Letext0:
	...
	.file 11 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Std/IfxGtm_Cmu.h"
	...
	.file 19 "0_Src/AppSw/Tricore/VADC/VADC.h"
