...
# 41 "0_Src/AppSw/Tricore/Main/Cpu0_main.h" 2
...
void ISR_SensorFeedback(void)
{
 ...
 GLCD_displayStringLn(((((240 / 24) - (3)) * 24) - 1), ADCValue);

 energy += 8.0*current*(0.1/3600);
 sprintf(ENERGYValue, "E = %0.4f W.h", energy);
 GLCD_displayStringLn(((((240 / 24) - (4)) * 24) - 1), ENERGYValue);
