...
.intr.entry.include:                                
.endif                                              
.intr.entry STM_INTERRUPT_SERVO,0,4
#NO_APP
...
.LBE30:
	.loc 1 37 0
	movh.a	%a15, hi:Timers+120
	lea	%a15, [%a15] lo:Timers+120
...
.LVL10:
	.loc 1 58 0
	movh.a	%a4, hi:Timers+180
	lea	%a4, [%a4] lo:Timers+180
	mov	%d4, %d2
	j	PWM_setDuty
.LVL11:
.LFE300:
...
.LFB302:
	.loc 1 88 0
	.loc 1 89 0
	movh.a	%a15, hi:flag_limit
	ld.bu	%d15, [%a15] lo:flag_limit
	jz	%d15, .L7
	.loc 1 91 0
	mov	%d15, 0
	st.b	[%a15] lo:flag_limit, %d15
.L7:
	ret
.LFE302:
...
.L13:
	...
	ld.w	%d15, [%a15] lo:Servo_Enable
	movh.a	%a15, hi:duty3
	jeq	%d15, 1, .L26
.L15:
	.loc 1 124 0
	mov	%d15, 0
	movh.a	%a2, hi:flag_limit
	.loc 1 126 0
	movh.a	%a3, hi:global_duty_end
	.loc 1 124 0
	st.b	[%a2] lo:flag_limit, %d15
	.loc 1 126 0
	ld.w	%d15, [%a15] lo:duty3
	ld.w	%d2, [%a3] lo:global_duty_end
	cmp.f	%d15, %d15, %d2
	jnz.t	%d15, 2, .L27
	.loc 1 134 0
	movh.a	%a3, hi:global_duty_start
	ld.w	%d15, [%a15] lo:duty3
	ld.w	%d2, [%a3] lo:global_duty_start
	cmp.f	%d15, %d15, %d2
	jz.t	%d15, 0, .L18
	.loc 1 136 0
	movh	%d15, 16576
.L25:
	st.w	[%a15] lo:duty3, %d15
	.loc 1 137 0
	movh.a	%a3, hi:global_step
	ld.w	%d15, [%a3] lo:global_step
	addih	%d15, %d15, 0x8000
	st.w	[%a3] lo:global_step, %d15
	.loc 1 138 0
	ld.w	%d2, [%a3] lo:global_step
	ld.w	%d15, [%a15] lo:duty3
	add.f	%d15, %d2, %d15
	st.w	[%a15] lo:duty3, %d15
	.loc 1 139 0
...
.L26:
	...
	ld.w	%d15, [%a15] lo:duty3
	.loc 1 122 0
	movh.a	%a4, hi:Timers+120
	.loc 1 121 0
	add.f	%d15, %d2, %d15
	.loc 1 122 0
	lea	%a4, [%a4] lo:Timers+120
	.loc 1 121 0
	st.w	[%a15] lo:duty3, %d15
	.loc 1 122 0
	ld.w	%d4, [%a15] lo:duty3
	ftouz	%d4, %d4
	and	%d4, %d4, 255
	call	PWM_setDuty
.LVL19:
...
.section .text.SERVO_ISR_CONFIG,"ax",@progbits
	.align 1
	.global	SERVO_ISR_CONFIG
	.type	SERVO_ISR_CONFIG, @function
SERVO_ISR_CONFIG:
.LFB304:
	.loc 1 156 0
.LVL20:
...
.LBB38:
.LBB39:
	.file 4 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuCcu.h"
	.loc 4 1105 0
	movh.a	%a15, 61443
	lea	%a15, [%a15] 24628
...
.LBE51:
.LFE304:
	.size	SERVO_ISR_CONFIG, .-SERVO_ISR_CONFIG
	.global	temp
...
.Letext0:
	...
	.file 21 "0_Src/BaseSw/iLLD/TC29B/Tricore/_PinMap/IfxPort_pinMap.h"
