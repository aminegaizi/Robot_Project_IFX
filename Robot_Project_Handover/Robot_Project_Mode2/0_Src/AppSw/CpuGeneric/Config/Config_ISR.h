...
//---Servomotor priority
#define PRIORITY_ISR_SERVOMOTOR 4
...
//--GTM Timer interrupt: Sensor Feedback, Obstacle Avoidance, Gyroscope
#define PRIORITY_ISR_GYRO 12

#define PRIORITY_ISR_SENSOR_FEEDBACK 15

#define PRIORITY_ISR_OBSTACLE_AVOIDANCE 16

#define PRIORITY_ISR_TFT_SCREEN 17
