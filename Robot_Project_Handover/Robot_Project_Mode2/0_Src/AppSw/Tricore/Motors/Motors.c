...
extern volatile uint32 interruptLeft_counter;//Total number of rising/falling edges sent by the left encoder
extern volatile uint32 interruptRight_counter;//Total number of rising/falling edges sent by the right encoder
 ...
 */
 void Forward_1()
 {
	...
	/*Configuration of the General Purpose Outputs in Push Pull for the H-Bridge*/
	...
	//--Motors On, writting direclty in the register's bitfields
 ...
 void Backward_1()
 {
	...
	/*Config of the General Purpose Outputs in Push Pull for the H-Bridge*/
 ...
 /*
  *  void F_RightCurb()
  *  Function used to set the H-Bridge and PWM pins for going Forward, the left motor is set to go faster than the right one
  *   to have a curved trajectory towards the right
  */
 void F_RightCurb()
 {
	Left_duty_cycle = 60;
 ...
 /*
  *   void F_LeftCurb()
  *  Function used to set the H-Bridge and PWM pins for going Forward, the right motor is set to go faster than the left one
  *   to have a curved trajectory towards the left
  */
 void F_LeftCurb()
 {
 ...
 /*
  *  void B_RightCurb()
  *  Function used to set the H-Bridge and PWM pins for going backwards, the left motor is set to go faster than the right one
  *   to have a curved trajectory towards the right
  */
void B_RightCurb()
{
...
/*
 *   void B_LeftCurb()
 *  Function used to set the H-Bridge and PWM pins for going backwards, the right motor is set to go faster than the left one
 *   to have a curved trajectory towards the left
 */
void B_LeftCurb()
{
...
void STM_INTERRUPT_CORRECTION()
{
	...
	if (command_movement == 5 || command_movement == 6) //Curve turning Right or Left
	{
	...
	if (command_movement == 7 || command_movement == 8) //Curve turning Right or Left
	{
