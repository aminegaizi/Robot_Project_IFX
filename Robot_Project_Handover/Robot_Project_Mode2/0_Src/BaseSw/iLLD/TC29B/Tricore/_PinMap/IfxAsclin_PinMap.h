...
IFX_EXTERN IfxAsclin_Rx_In IfxAsclin0_RXA_P14_1_IN;  /**< \brief ASCLIN0_RXA: ASCLIN0 input   Recommended as Boot loader pin */
IFX_EXTERN IfxAsclin_Rx_In IfxAsclin0_RXB_P15_3_IN;  /**< \brief ASCLIN0_RXB: ASCLIN0 input */
IFX_EXTERN IfxAsclin_Rx_In IfxAsclin0_RXC_P01_8_IN;  /**< \brief ASCLIN0_RXC: ASCLIN0 input */
IFX_EXTERN IfxAsclin_Rx_In IfxAsclin0_RXD_P34_2_IN;  /**< \brief ASCLIN0_RXD: ASCLIN0 input */
IFX_EXTERN IfxAsclin_Rx_In IfxAsclin0_RXE_P13_11_IN;  /**< \brief ASCLIN0_RXE: ASCLIN0 input */
...
IFX_EXTERN IfxAsclin_Rx_In IfxAsclin2_RXC_P02_10_IN;  /**< \brief ASCLIN2_RXC: ASCLIN2 input */
...
IFX_EXTERN IfxAsclin_Rx_In IfxAsclin2_RXF_P32_6_IN;  /**< \brief ASCLIN2_RXF: ASCLIN2 input */
...
IFX_EXTERN IfxAsclin_Rx_In IfxAsclin3_RXB_P11_0_IN;  /**< \brief ASCLIN3_RXB: ASCLIN3 input */
...
IFX_EXTERN IfxAsclin_Rx_In IfxAsclin3_RXG_P21_2_IN;  /**< \brief ASCLIN3_RX3GN: ASCLIN3 input (LVDS) */
IFX_EXTERN IfxAsclin_Rx_In IfxAsclin3_RXG_P21_3_IN;  /**< \brief ASCLIN3_RX3GP: ASCLIN3 input (LVDS) */
IFX_EXTERN IfxAsclin_Rx_In IfxAsclin3_RXH_P13_12_IN;  /**< \brief ASCLIN3_RXH: ASCLIN3 input */
...
IFX_EXTERN IfxAsclin_Sclk_Out IfxAsclin3_SCLK_P11_1_OUT;  /**< \brief ASCLIN3_SCLK: ASCLIN3 output */
IFX_EXTERN IfxAsclin_Sclk_Out IfxAsclin3_SCLK_P11_4_OUT;  /**< \brief ASCLIN3_SCLK: ASCLIN3 output */
...
IFX_EXTERN IfxAsclin_Slso_Out IfxAsclin3_SLSO_P12_1_OUT;  /**< \brief ASCLIN3_SLSO: ASCLIN3 output */
...
IFX_EXTERN IfxAsclin_Tx_Out IfxAsclin0_TX_P01_13_OUT;  /**< \brief ASCLIN0_TX: ASCLIN0 output */
IFX_EXTERN IfxAsclin_Tx_Out IfxAsclin0_TX_P13_10_OUT;  /**< \brief ASCLIN0_TX: ASCLIN0 output */
...
IFX_EXTERN IfxAsclin_Tx_Out IfxAsclin0_TX_P34_1_OUT;  /**< \brief ASCLIN0_TX: ASCLIN0 output */
...
IFX_EXTERN IfxAsclin_Tx_Out IfxAsclin1_TX_P14_15_OUT;  /**< \brief ASCLIN1_TX: ASCLIN1 output */
...
IFX_EXTERN IfxAsclin_Tx_Out IfxAsclin2_TX_P02_9_OUT;  /**< \brief ASCLIN2_TX: ASCLIN2 output */
...
IFX_EXTERN IfxAsclin_Tx_Out IfxAsclin2_TX_P32_5_OUT;  /**< \brief ASCLIN2_TX: ASCLIN2 output */
...
IFX_EXTERN IfxAsclin_Tx_Out IfxAsclin3_TX_P11_0_OUT;  /**< \brief ASCLIN3_TX: ASCLIN3 output */
IFX_EXTERN IfxAsclin_Tx_Out IfxAsclin3_TX_P11_1_OUT;  /**< \brief ASCLIN3_TX: ASCLIN3 output */
IFX_EXTERN IfxAsclin_Tx_Out IfxAsclin3_TX_P13_9_OUT;  /**< \brief ASCLIN3_TX: ASCLIN3 output */
...
IFX_EXTERN IfxAsclin_Tx_Out IfxAsclin3_TX_P22_0_OUT;  /**< \brief ASCLIN3_TXN: ASCLIN3 output (LVDS) */
IFX_EXTERN IfxAsclin_Tx_Out IfxAsclin3_TX_P22_1_OUT;  /**< \brief ASCLIN3_TXP: ASCLIN3 output (LVDS) */
