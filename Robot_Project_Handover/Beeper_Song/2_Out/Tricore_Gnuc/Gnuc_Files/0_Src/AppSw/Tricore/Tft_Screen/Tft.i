...
# 9 "0_Src/AppSw/Tricore/Tft_Screen/Tft.c" 2
# 19 "0_Src/AppSw/Tricore/Tft_Screen/Tft.c"
...
# 1083 "0_Src/AppSw/Tricore/Tft_Screen/Tft.c"
void GLCD_displayStringLn(unsigned int ln, const char *s)
{
 unsigned int i = 0;
...
# 1161 "0_Src/AppSw/Tricore/Tft_Screen/Tft.c"
void GLCD_bitmap(unsigned int x, unsigned int y, unsigned int w, unsigned int h, const void *bitmap)
{
 unsigned int i;
