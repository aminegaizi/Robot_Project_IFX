# 1 "0_Src/AppSw/Tricore/Beeper/Beeper.c"
# 1 "C:\\Robot_Project_Handover\\Beeper_Song//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/Beeper/Beeper.c"
# 18 "0_Src/AppSw/Tricore/Beeper/Beeper.c"
# 1 "0_Src/AppSw/Tricore/Beeper/Beeper.h" 1
# 11 "0_Src/AppSw/Tricore/Beeper/Beeper.h"
...
# 110 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Tom/Pwm/IfxGtm_Tom_Pwm.h" 2
...
# 12 "0_Src/AppSw/Tricore/Beeper/Beeper.h" 2
...
# 16 "0_Src/AppSw/Tricore/Beeper/Beeper.h" 2


void happy_birthday(void);
void star_wars(void);
void Tft_HBD_Alex(void);
void Tft_Star_wars(void);
# 19 "0_Src/AppSw/Tricore/Beeper/Beeper.c" 2
...
void happy_birthday()
{
 ...
 initTime();
 Duty_Cycle = 10;
 Fsys = IfxStm_getFrequency((&(*(Ifx_STM*)0xF0000000u)));
 Tft_HBD_Alex();
 for (i=0; i<26; i++)
 {
  ...
  PWM_init(IfxGtm_TOM1_4_TOUT22_P33_0_OUT, &Beeper, freqs[i]);
...
void star_wars()
{
 ...
 for (i=0; i<9; i++)
 {
  ...
  PWM_init(IfxGtm_TOM1_4_TOUT22_P33_0_OUT, &Beeper, f_sw1_1[i]);
  PWM_setDuty(Beeper, Duty_Cycle);
 ...
 for (i=0; i<9; i++)
 {
  ...
  PWM_init(IfxGtm_TOM1_4_TOUT22_P33_0_OUT, &Beeper, f_sw1_2[i]);
  PWM_setDuty(Beeper, Duty_Cycle);
  waitTime(Fsys/(len_sw1_1[i]));
  PWM_setDuty(Beeper, 0);
  IfxGtm_Tom_Timer_stop(&Beeper);
 ...
 for (i=0; i<9; i++)
 {
  ...
  PWM_init(IfxGtm_TOM1_4_TOUT22_P33_0_OUT, &Beeper, f_sw_2_1[i]);
  PWM_setDuty(Beeper, Duty_Cycle);
 ...
 for (i=0; i<7; i++)
 {
  ...
  PWM_init(IfxGtm_TOM1_4_TOUT22_P33_0_OUT, &Beeper, f_sw_2_2[i]);
  PWM_setDuty(Beeper, Duty_Cycle);
 ...
 for (i=0; i<8; i++)
 {
  ...
  PWM_init(IfxGtm_TOM1_4_TOUT22_P33_0_OUT, &Beeper, f_sw3[i]);
  PWM_setDuty(Beeper, Duty_Cycle);
 ...
 for (i=0; i<9; i++)
 {
  ...
  PWM_init(IfxGtm_TOM1_4_TOUT22_P33_0_OUT, &Beeper, f_sw4[i]);
  PWM_setDuty(Beeper, Duty_Cycle);
...
void Tft_HBD_Alex()
{
    ...
    GLCD_displayStringLn(((((240 / 24) - (1)) * 24) - 1), "       HAPPY        ");
    GLCD_displayStringLn(((((240 / 24) - (2)) * 24) - 1), "      BIRTHDAY      ");
    GLCD_displayStringLn(((((240 / 24) - (3)) * 24) - 1), "       ALEX!        ");
}

void Tft_Star_wars()
{
    GLCD_clear(( (((((0)) * (1 << ((5)))) >> 8) << ((11))) | (((((0)) * (1 << ((6)))) >> 8) << ((5))) | (((((0)) * (1 << ((5)))) >> 8) << ((0)))));
    GLCD_displayStringLn(((((240 / 24) - (1)) * 24) - 1), "      MAY THE       ");
    GLCD_displayStringLn(((((240 / 24) - (2)) * 24) - 1), "      FORCE BE      ");
    GLCD_displayStringLn(((((240 / 24) - (3)) * 24) - 1), "      WITH YOU !    ");
}
