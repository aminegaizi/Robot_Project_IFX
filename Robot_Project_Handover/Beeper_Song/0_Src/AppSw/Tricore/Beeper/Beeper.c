 ...
 * It also displays "Happy Birthday Alex!" on the Tft screen
 */
void happy_birthday()
{
...
/*
 * void star_wars()
 * This function plays the star wars theme on the beeper of the application kit
 * It also displays "May the force be with you" on the Tft screen
 */
void star_wars()
{
	initTime(); //Initialize the time constants for the BSP timer delays
