...
/*
 * PWM_config(IfxGtm_Tom_ToutMap Output)
...
/*
 * PWM2_config(IfxGtm_Tom_ToutMap Output)
 * Configuration of a Generic Timer Module (GTM) Timer Ouput Module (TOM) PWM signal
 * This function takes in parameter the output pin in which you want the signal
 * the type of the output pin is IfxGtm_Tom_ToutMap
...
/*
 * PWM3_config(IfxGtm_Tom_ToutMap Output)
 * Configuration of a PWM used for the servomotor
 */
...
/*
 * void ClockConfig()
 * This function configures the clocks needed for the PWM configuration
 */
void ClockConfig()
{
