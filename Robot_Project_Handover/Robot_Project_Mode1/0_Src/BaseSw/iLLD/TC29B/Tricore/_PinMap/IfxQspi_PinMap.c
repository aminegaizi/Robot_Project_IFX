...
IfxQspi_Mrst_In IfxQspi4_MRSTB_P22_1_IN = {&MODULE_QSPI4, {&MODULE_P22, 1}, Ifx_RxSel_b};
IfxQspi_Mrst_In IfxQspi4_MRSTCN_P21_2_IN = {&MODULE_QSPI4, {&MODULE_P21, 2}, Ifx_RxSel_c};
IfxQspi_Mrst_In IfxQspi4_MRSTCP_P21_3_IN = {&MODULE_QSPI4, {&MODULE_P21, 3}, Ifx_RxSel_c};
IfxQspi_Mrst_In IfxQspi4_MRSTDN_P21_0_IN = {&MODULE_QSPI4, {&MODULE_P21, 0}, Ifx_RxSel_d};
IfxQspi_Mrst_In IfxQspi4_MRSTDP_P21_1_IN = {&MODULE_QSPI4, {&MODULE_P21, 1}, Ifx_RxSel_d};
IfxQspi_Mrst_In IfxQspi5_MRSTA_P15_10_IN = {&MODULE_QSPI5, {&MODULE_P15,10}, Ifx_RxSel_a};
...
IfxQspi_Mrst_Out IfxQspi5_MRST_P15_10_OUT = {&MODULE_QSPI5, {&MODULE_P15,10}, IfxPort_OutputIdx_alt3};
...
IfxQspi_Mtsr_In IfxQspi5_MTSRA_P15_14_IN = {&MODULE_QSPI5, {&MODULE_P15,14}, Ifx_RxSel_a};
...
IfxQspi_Mtsr_Out IfxQspi4_MTSRN_P22_2_OUT = {&MODULE_QSPI4, {&MODULE_P22, 2}, IfxPort_OutputIdx_alt4};
IfxQspi_Mtsr_Out IfxQspi4_MTSRP_P22_3_OUT = {&MODULE_QSPI4, {&MODULE_P22, 3}, IfxPort_OutputIdx_alt4};
IfxQspi_Mtsr_Out IfxQspi4_MTSR_P22_0_OUT = {&MODULE_QSPI4, {&MODULE_P22, 0}, IfxPort_OutputIdx_alt3};
IfxQspi_Mtsr_Out IfxQspi4_MTSR_P33_12_OUT = {&MODULE_QSPI4, {&MODULE_P33,12}, IfxPort_OutputIdx_alt3};
IfxQspi_Mtsr_Out IfxQspi5_MTSR_P15_14_OUT = {&MODULE_QSPI5, {&MODULE_P15,14}, IfxPort_OutputIdx_alt3};
...
IfxQspi_Sclk_In IfxQspi5_SCLKA_P15_15_IN = {&MODULE_QSPI5, {&MODULE_P15,15}, Ifx_RxSel_a};
...
IfxQspi_Sclk_Out IfxQspi4_SCLKN_P22_0_OUT = {&MODULE_QSPI4, {&MODULE_P22, 0}, IfxPort_OutputIdx_alt4};
IfxQspi_Sclk_Out IfxQspi4_SCLKP_P22_1_OUT = {&MODULE_QSPI4, {&MODULE_P22, 1}, IfxPort_OutputIdx_alt4};
IfxQspi_Sclk_Out IfxQspi4_SCLK_P22_3_OUT = {&MODULE_QSPI4, {&MODULE_P22, 3}, IfxPort_OutputIdx_alt3};
IfxQspi_Sclk_Out IfxQspi4_SCLK_P33_11_OUT = {&MODULE_QSPI4, {&MODULE_P33,11}, IfxPort_OutputIdx_alt3};
IfxQspi_Sclk_Out IfxQspi5_SCLK_P15_15_OUT = {&MODULE_QSPI5, {&MODULE_P15,15}, IfxPort_OutputIdx_alt3};
...
IfxQspi_Slsi_In IfxQspi5_SLSIA_P15_11_IN = {&MODULE_QSPI5, {&MODULE_P15,11}, Ifx_RxSel_a};
...
IfxQspi_Slso_Out IfxQspi3_SLSO5_P02_12_OUT = {&MODULE_QSPI3, 5, {&MODULE_P02,12}, IfxPort_OutputIdx_alt2};
...
IfxQspi_Slso_Out IfxQspi3_SLSO6_P02_15_OUT = {&MODULE_QSPI3, 6, {&MODULE_P02,15}, IfxPort_OutputIdx_alt2};
IfxQspi_Slso_Out IfxQspi3_SLSO7_P00_9_OUT = {&MODULE_QSPI3, 7, {&MODULE_P00, 9}, IfxPort_OutputIdx_alt2};
IfxQspi_Slso_Out IfxQspi3_SLSO7_P02_13_OUT = {&MODULE_QSPI3, 7, {&MODULE_P02,13}, IfxPort_OutputIdx_alt2};
...
IfxQspi_Slso_Out IfxQspi4_SLSO4_P02_12_OUT = {&MODULE_QSPI4, 4, {&MODULE_P02,12}, IfxPort_OutputIdx_alt3};
IfxQspi_Slso_Out IfxQspi4_SLSO4_P23_5_OUT = {&MODULE_QSPI4, 4, {&MODULE_P23, 5}, IfxPort_OutputIdx_alt3};
IfxQspi_Slso_Out IfxQspi4_SLSO5_P02_15_OUT = {&MODULE_QSPI4, 5, {&MODULE_P02,15}, IfxPort_OutputIdx_alt3};
IfxQspi_Slso_Out IfxQspi4_SLSO5_P23_4_OUT = {&MODULE_QSPI4, 5, {&MODULE_P23, 4}, IfxPort_OutputIdx_alt3};
IfxQspi_Slso_Out IfxQspi4_SLSO6_P02_13_OUT = {&MODULE_QSPI4, 6, {&MODULE_P02,13}, IfxPort_OutputIdx_alt3};
...
IfxQspi_Slso_Out IfxQspi5_SLSO0_P15_13_OUT = {&MODULE_QSPI5, 0, {&MODULE_P15,13}, IfxPort_OutputIdx_alt3};
IfxQspi_Slso_Out IfxQspi5_SLSO1_P15_12_OUT = {&MODULE_QSPI5, 1, {&MODULE_P15,12}, IfxPort_OutputIdx_alt3};
IfxQspi_Slso_Out IfxQspi5_SLSO2_P15_11_OUT = {&MODULE_QSPI5, 2, {&MODULE_P15,11}, IfxPort_OutputIdx_alt3};
IfxQspi_Slso_Out IfxQspi5_SLSO3_P15_6_OUT = {&MODULE_QSPI5, 3, {&MODULE_P15, 6}, IfxPort_OutputIdx_alt4};
IfxQspi_Slso_Out IfxQspi5_SLSO4_P13_14_OUT = {&MODULE_QSPI5, 4, {&MODULE_P13,14}, IfxPort_OutputIdx_alt3};
IfxQspi_Slso_Out IfxQspi5_SLSO5_P13_9_OUT = {&MODULE_QSPI5, 5, {&MODULE_P13, 9}, IfxPort_OutputIdx_alt3};
