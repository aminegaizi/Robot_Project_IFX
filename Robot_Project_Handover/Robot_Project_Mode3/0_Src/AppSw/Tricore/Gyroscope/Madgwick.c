 ...
 * Fetch 9 axis data from sensors, and update the quaternion values
 */
void Madgwick_update(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz) {
    float recipNorm;
    float s0, s1, s2, s3;
 ...
 * Same as Madgwick_update() but with group 2 implemented. Not fully functionnal -> not used
 */
void Madgwick_update2(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz) {
    float recipNorm;
    float s0, s1, s2, s3;
 ...
 * Implementation of Madgwick's algorithm using gyroscope and acceleromter only, in case the magnetometer is not responding
 */
void Madgwick_updateIMU(float gx, float gy, float gz, float ax, float ay, float az){
  float recipNorm;
  float s0, s1, s2, s3;
...
/*
 * void computeAngles()
 * Angle calculation based on quaternion values
 */
void computeAngles(){
