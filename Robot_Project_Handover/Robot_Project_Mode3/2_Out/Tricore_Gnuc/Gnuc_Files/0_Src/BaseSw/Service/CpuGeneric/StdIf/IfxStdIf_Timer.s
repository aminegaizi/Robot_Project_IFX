...
.LFB207:
	.file 1 "0_Src/BaseSw/Service/CpuGeneric/StdIf/IfxStdIf_Timer.c"
	.loc 1 48 0
.LVL0:
	.loc 1 50 0
	mov	%d2, 0
...
.LVL17:
	.loc 1 109 0
	movh	%d15, hi:IfxStdIf_Timer_nopGetFrequency
	addi	%d15, %d15, lo:IfxStdIf_Timer_nopGetFrequency
	.loc 1 108 0
	st.a	[%a4]0, %a5
	.loc 1 109 0
	st.w	[%a4] 4, %d15
	.loc 1 110 0
	movh	%d15, hi:IfxStdIf_Timer_nopGetPeriod
	addi	%d15, %d15, lo:IfxStdIf_Timer_nopGetPeriod
	st.w	[%a4] 8, %d15
	.loc 1 111 0
	movh	%d15, hi:IfxStdIf_Timer_nopGetResolution
	addi	%d15, %d15, lo:IfxStdIf_Timer_nopGetResolution
	st.w	[%a4] 12, %d15
	.loc 1 112 0
	movh	%d15, hi:IfxStdIf_Timer_nopGetTrigger
	addi	%d15, %d15, lo:IfxStdIf_Timer_nopGetTrigger
	st.w	[%a4] 16, %d15
	.loc 1 113 0
	movh	%d15, hi:IfxStdIf_Timer_nopSetFrequency
	addi	%d15, %d15, lo:IfxStdIf_Timer_nopSetFrequency
	st.w	[%a4] 20, %d15
	.loc 1 114 0
	movh	%d15, hi:IfxStdIf_Timer_nopUpdateInputFrequency
	addi	%d15, %d15, lo:IfxStdIf_Timer_nopUpdateInputFrequency
	st.w	[%a4] 24, %d15
	.loc 1 115 0
	movh	%d15, hi:IfxStdIf_Timer_nopApplyUpdate
	addi	%d15, %d15, lo:IfxStdIf_Timer_nopApplyUpdate
	st.w	[%a4] 28, %d15
	.loc 1 116 0
	movh	%d15, hi:IfxStdIf_Timer_nopDisableUpdate
	addi	%d15, %d15, lo:IfxStdIf_Timer_nopDisableUpdate
	st.w	[%a4] 32, %d15
	.loc 1 117 0
	movh	%d15, hi:IfxStdIf_Timer_nopGetInputFrequency
	addi	%d15, %d15, lo:IfxStdIf_Timer_nopGetInputFrequency
	st.w	[%a4] 36, %d15
	.loc 1 118 0
	movh	%d15, hi:IfxStdIf_Timer_nopRun
	addi	%d15, %d15, lo:IfxStdIf_Timer_nopRun
	st.w	[%a4] 40, %d15
	.loc 1 119 0
	movh	%d15, hi:IfxStdIf_Timer_nopSetPeriod
	addi	%d15, %d15, lo:IfxStdIf_Timer_nopSetPeriod
	st.w	[%a4] 44, %d15
	.loc 1 120 0
	movh	%d15, hi:IfxStdIf_Timer_nopSetSingleMode
	addi	%d15, %d15, lo:IfxStdIf_Timer_nopSetSingleMode
	st.w	[%a4] 48, %d15
	.loc 1 121 0
	movh	%d15, hi:IfxStdIf_Timer_nopSetTrigger
	addi	%d15, %d15, lo:IfxStdIf_Timer_nopSetTrigger
	st.w	[%a4] 52, %d15
	.loc 1 122 0
	movh	%d15, hi:IfxStdIf_Timer_nopStop
	addi	%d15, %d15, lo:IfxStdIf_Timer_nopStop
	st.w	[%a4] 56, %d15
	.loc 1 123 0
	movh	%d15, hi:IfxStdIf_Timer_nopAckTimerIrq
	addi	%d15, %d15, lo:IfxStdIf_Timer_nopAckTimerIrq
	st.w	[%a4] 60, %d15
	.loc 1 124 0
	movh	%d15, hi:IfxStdIf_Timer_nopAckTriggerIrq
	addi	%d15, %d15, lo:IfxStdIf_Timer_nopAckTriggerIrq
	st.w	[%a4] 64, %d15
	ret
.LFE223:
...
.Letext0:
	...
	.file 7 "0_Src/BaseSw/Service/CpuGeneric/StdIf/IfxStdIf_Timer.h"
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/BaseSw/Service/CpuGeneric/StdIf/IfxStdIf_Timer.c"
