...
{
    GLCD_init();
    GLCD_clear(( (((((255)) * (1 << ((5)))) >> 8) << ((11))) | (((((255)) * (1 << ((6)))) >> 8) << ((5))) | (((((255)) * (1 << ((5)))) >> 8) << ((0)))));
    GLCD_displayStringLn(((((240 / 24) - (0)) * 24) - 1), "       AURIX        ");
    GLCD_displayStringLn(((((240 / 24) - (1)) * 24) - 1), "  Autonomous Robot  ");
    GLCD_bitmap(100, 16, 120, 56, ifxlogo);
}
...
void Raspberry_rcv(char recv)
{
 switch(recv){
   case 'c':
    FSM_RaspberrySTATE = Raspberry_State_LABEL_temp;
    break;
   case 'x':
    i = 0;
    FSM_RaspberrySTATE = Raspberry_State_DISTANCEx_temp;
    break;
   case 'y':
    i = 0;
    FSM_RaspberrySTATE = Raspberry_State_DISTANCEy_temp;
    break;
   case 'w':
    FSM_RaspberrySTATE = Raspberry_State_LOAD;
    break;
   default:
    break;
  }
...
void Update_Object_Position(){
 ...
 {
  Desired_position.x = x_coord_target + 15;
 }
 else {
...
# 294 "0_Src/AppSw/Tricore/Main/Cpu0_Main.c"
void Save_Object_Position()
{
