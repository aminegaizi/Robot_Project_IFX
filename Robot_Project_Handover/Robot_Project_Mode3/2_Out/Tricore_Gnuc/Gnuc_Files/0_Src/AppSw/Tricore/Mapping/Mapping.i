# 1 "0_Src/AppSw/Tricore/Mapping/Mapping.c"
# 1 "C:\\Robot_Project_Handover\\Robot_Project_Mode3//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/Mapping/Mapping.c"
# 21 "0_Src/AppSw/Tricore/Mapping/Mapping.c"
...
# 22 "0_Src/AppSw/Tricore/Mapping/Mapping.c" 2
...
uint8 length = 200;
uint8 width = 200;
# 43 "0_Src/AppSw/Tricore/Mapping/Mapping.c"
uint8 ZoneDivider()
{
 uint8 Zone = 0;
...
# 80 "0_Src/AppSw/Tricore/Mapping/Mapping.c"
void GoToZone(uint8 Zone)
{
 uint8 c =0, r=0;
 switch(Zone){
