...
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/Gyroscope/Gyroscope_i2c.c"
# 11 "0_Src/AppSw/Tricore/Gyroscope/Gyroscope_i2c.c"
...
# 41 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Impl/IfxI2c_cfg.h"
...
# 42 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Impl/IfxI2c_cfg.h" 2
...
# 39 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxI2c_regdef.h"
# 1 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/Ifx_TypesReg.h" 1
# 40 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxI2c_regdef.h" 2
...
# 41 "0_Src/BaseSw/iLLD/TC29B/Tricore/I2c/Std/IfxI2c.h" 2
...
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Port/Std/IfxPort.h" 1
# 15 "0_Src/AppSw/Tricore/Gyroscope/Gyroscope_i2c.h" 2
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuCcu.h" 1
# 16 "0_Src/AppSw/Tricore/Gyroscope/Gyroscope_i2c.h" 2
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuWdt.h" 1
# 17 "0_Src/AppSw/Tricore/Gyroscope/Gyroscope_i2c.h" 2
...
# 19 "0_Src/AppSw/Tricore/Gyroscope/Gyroscope_i2c.h" 2
...
# 12 "0_Src/AppSw/Tricore/Gyroscope/Gyroscope_i2c.c" 2
# 21 "0_Src/AppSw/Tricore/Gyroscope/Gyroscope_i2c.c"
...
void Init_I2C (void)
{
...

    {
     ...
     i2cDeviceConfig.deviceAddress = 0x0C<<1;
...
void Init_MPU9250(uint8 scale_gyro,uint8 scale_acc)
{
 ...
 switch (scale_gyro){
        ...
        case (uint8) 0x10: Mpu.gyro_scale_factor = ((float)32.8f); break;
        case (uint8) 0x18: Mpu.gyro_scale_factor = ((float)16.4f); break;
        default: Mpu.gyro_scale_factor = ((float)131.0f);break;
 }

 switch (scale_acc){
         case 0x00: Mpu.acc_scale_factor = ((float)16384.0f); break;
         case 0x08: Mpu.acc_scale_factor = ((float)8192.0f); break;
         case 0x10: Mpu.acc_scale_factor = ((float)4096.0f); break;
...
void Init_Mag_AK8963(uint8 Adc_type)
{
 ...
 switch (Adc_type){
        case 0x06: Mpu.mag_scale_factor = ((float)1.7067f); break;
        case 0x16: Mpu.mag_scale_factor = ((float)6.8267f); break;
 }
}
...
void GetGyro()
{
 ...
 for(i=0;i<3;i++){
   Read_I2C_Register(&I2C_Masters_Slaves.drivers.i2cDev_Gyro_Accel,0x43 +2*i,2,I2C_Masters_Slaves.i2cBuffer.i2cTxBuffer,I2C_Masters_Slaves.i2cBuffer.i2cRxBuffer);
...
void GetAccel()
{
 ...
 int i;
 for(i=0;i<3;i++){
   Read_I2C_Register(&I2C_Masters_Slaves.drivers.i2cDev_Gyro_Accel,0x3B +2*i,2,I2C_Masters_Slaves.i2cBuffer.i2cTxBuffer,I2C_Masters_Slaves.i2cBuffer.i2cRxBuffer);
   bit_data = ((sint16)I2C_Masters_Slaves.i2cBuffer.i2cRxBuffer[0]<<8)|(sint16)I2C_Masters_Slaves.i2cBuffer.i2cRxBuffer[1];
   data[i] = (float)bit_data;
 }
...
void GetMag()
{
 ...
 do
   {
  size=sizeof(Ansbis);
  Read_Mag_Reg(&I2C_Masters_Slaves.drivers.i2cDev_Mag,0x02,size,I2C_Masters_Slaves.i2cBuffer.i2cTxBuffer,Ansbis);
  ST1=Ansbis[0];
 ...
 size=sizeof(Ans);
 Read_Mag_Reg(&I2C_Masters_Slaves.drivers.i2cDev_Mag,0x03,size,I2C_Masters_Slaves.i2cBuffer.i2cTxBuffer,Ans);
...
void GetYawPitchRoll()
{
 ...
 Read_I2C_Register(&I2C_Masters_Slaves.drivers.i2cDev_Gyro_Accel,0x75,0x01,I2C_Masters_Slaves.i2cBuffer.i2cTxBuffer,I2C_Masters_Slaves.i2cBuffer.i2cRxBuffer);
 ...
 YPR.pitch=Madgwick_getPitch();
 YPR.roll=Madgwick_getRoll();
 YPR.yaw=Madgwick_getYaw();

 IfxPort_togglePin(&(*(Ifx_P*)0xF003B300u), 2);
