...
.intr.entry.include:                                
.endif                                              
.intr.entry STM_INTERRUPT_SERVO,0,7
#NO_APP
...
.LFB305:
	.loc 1 103 0
	.loc 1 104 0
	movh.a	%a13, hi:stm_sfr
	movh.a	%a14, hi:config_servo
	ld.a	%a4, [%a13] lo:stm_sfr
	ld.bu	%d4, [%a14] lo:config_servo
.LBB36:
.LBB37:
	.loc 1 84 0
	movh.a	%a15, hi:flag_limit
...
.LBE39:
	.loc 1 107 0
	movh.a	%a12, hi:duty3
	ld.w	%d4, [%a12] lo:duty3
	movh	%d15, hi:Timers+120
	ftouz	%d4, %d4
	addi	%d15, %d15, lo:Timers+120
	mov.a	%a4, %d15
	and	%d4, %d4, 255
	call	PWM_setDuty
.LVL13:
	.loc 1 108 0
	movh.a	%a2, hi:Servo_Enable
	ld.w	%d2, [%a2] lo:Servo_Enable
	jeq	%d2, 1, .L26
.L14:
	.loc 1 113 0
	mov	%d15, 0
	...
	st.b	[%a15] lo:flag_limit, %d15
	.loc 1 115 0
	ld.w	%d15, [%a12] lo:duty3
	ld.w	%d2, [%a2] lo:global_duty_end
	movh.a	%a15, hi:duty3
	cmp.f	%d15, %d15, %d2
	jnz.t	%d15, 2, .L27
	.loc 1 123 0
	movh.a	%a2, hi:global_duty_start
	ld.w	%d15, [%a15] lo:duty3
	ld.w	%d2, [%a2] lo:global_duty_start
	cmp.f	%d15, %d15, %d2
	jz.t	%d15, 0, .L17
	.loc 1 125 0
	movh	%d15, 16576
...
.LVL14:
	ld.a	%a15, [%a13] lo:stm_sfr
	ld.bu	%d2, [%a14] lo:config_servo
	ftouz	%d15, %d15
.LVL15:
...
.L26:
	.loc 1 110 0
	movh.a	%a2, hi:global_step
	ld.w	%d3, [%a2] lo:global_step
	ld.w	%d2, [%a12] lo:duty3
	.loc 1 111 0
	mov.a	%a4, %d15
	.loc 1 110 0
	add.f	%d2, %d3, %d2
	st.w	[%a12] lo:duty3, %d2
	.loc 1 111 0
	ld.w	%d4, [%a12] lo:duty3
	ftouz	%d4, %d4
	and	%d4, %d4, 255
