# 1 "0_Src/AppSw/Tricore/Timer/GTM_ISR.c"
...
# 12 "0_Src/AppSw/Tricore/Timer/GTM_ISR.h"
...
# 13 "0_Src/AppSw/Tricore/Timer/GTM_ISR.h" 2
...
# 40 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Bsp.h" 2
...
# 14 "0_Src/AppSw/Tricore/Timer/GTM_ISR.h" 2
# 1 "0_Src/AppSw/Tricore/Encoders/Encoders_config.h" 1
# 14 "0_Src/AppSw/Tricore/Encoders/Encoders_config.h"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuWdt.h" 1
# 15 "0_Src/AppSw/Tricore/Encoders/Encoders_config.h" 2
...
# 12 "0_Src/AppSw/Tricore/Main/Cpu0_main.h"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/Std/IfxCpu.h" 1
...
# 14 "0_Src/AppSw/Tricore/Tft_Screen/Tft.h"
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Port/Std/IfxPort.h" 1
# 15 "0_Src/AppSw/Tricore/Tft_Screen/Tft.h" 2
...
# 13 "0_Src/AppSw/Tricore/Serial/serial.h" 2
...
void beep(void);
# 14 "0_Src/AppSw/Tricore/Serial/serial.h" 2
...
# 12 "0_Src/AppSw/Tricore/Enslavement/Enslavement.h"
# 1 "0_Src/AppSw/Tricore/Position/position.h" 1
# 18 "0_Src/AppSw/Tricore/Position/position.h"
...
# 27 "0_Src/AppSw/Tricore/Position/position.h"
void position_data();
void init_array();
...
# 13 "0_Src/AppSw/Tricore/Enslavement/Enslavement.h" 2
...
# 44 "0_Src/AppSw/Tricore/Main/Cpu0_main.h" 2
...
# 11 "0_Src/AppSw/Tricore/Mapping/Mapping.h"
# 1 "0_Src/AppSw/Tricore/Main/Cpu0_main.h" 1
# 12 "0_Src/AppSw/Tricore/Mapping/Mapping.h" 2
# 1 "0_Src/AppSw/Tricore/Position/Position.h" 1
...
void ISR_Gyro(void);
# 9 "0_Src/AppSw/Tricore/Timer/GTM_ISR.c" 2
...
uint8 Yaw_Absinit = 0;
boolean Gyro_stable = 0;

__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""ISR_CurrentMeasurement"",""0"",""15" );extern void __attribute__ ((interrupt_handler)) ISR_CurrentMeasurement(); void ISR_CurrentMeasurement (void);
__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""ISR_ObstacleAvoidance"",""0"",""16" );extern void __attribute__ ((interrupt_handler)) ISR_ObstacleAvoidance(); void ISR_ObstacleAvoidance (void);
__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""ISR_Gyro"",""0"",""12" );extern void __attribute__ ((interrupt_handler)) ISR_Gyro(); void ISR_Gyro (void);
# 36 "0_Src/AppSw/Tricore/Timer/GTM_ISR.c"
void ISR_CurrentMeasurement(void)
{
    IfxCpu_enableInterrupts();
 ...
 GLCD_displayStringLn(((((240 / 24) - (3)) * 24) - 1), DisplayTemp);

 energy += 8.0*I*(0.1/3600);
 snprintf(DisplayTemp, 20, "E = %0.4f W.h", energy);
 GLCD_displayStringLn(((((240 / 24) - (4)) * 24) - 1), DisplayTemp);
 ...
 if(!Gyro_stable)
 {
  ...
  {
   Gyro_stable = 1;
   GLCD_displayStringLn(((((240 / 24) - (0)) * 24) - 1), "READY");
...
void ISR_CurrentMeasurement_Config(void)
{
        ...
        IfxGtm_Atom_Timer_initConfig(&timerConfig, &(*(Ifx_GTM*)0xF0100000u));
        timerConfig.base.frequency = 10;
        timerConfig.base.isrPriority = 15;
        timerConfig.base.isrProvider = IfxSrc_Tos_cpu0;
        timerConfig.base.minResolution = (1.0 / timerConfig.base.frequency) / 1000;
        timerConfig.base.trigger.enabled = 0;
...
void ISR_ObstacleAvoidance(void)
{
 ...
 if(temp < 1e+06)
 {
  distance_obstacle = temp;
    ...
    else if(distance_obstacle != 0 && distance_obstacle<= 4e3 && distance_obstacle>= 4e2)
    {
     Right();
    }
...
void ISR_ObstacleAvoidance_Config(void)
{
        ...
        timerConfig.base.isrPriority = 16;
        timerConfig.base.isrProvider = IfxSrc_Tos_cpu0;
        timerConfig.base.minResolution = (1.0 / timerConfig.base.frequency) / 1000;
        timerConfig.base.trigger.enabled = 0;
...
void ISR_Gyro_Config(void)
{
        ...
        IfxGtm_Atom_Timer_initConfig(&timerConfig, &(*(Ifx_GTM*)0xF0100000u));
        timerConfig.base.frequency = 100;
        timerConfig.base.isrPriority = 12;
        timerConfig.base.isrProvider = IfxSrc_Tos_cpu0;
        timerConfig.base.minResolution = (1.0 / timerConfig.base.frequency) / 1000;
        timerConfig.base.trigger.enabled = 0;
...
# 176 "0_Src/AppSw/Tricore/Timer/GTM_ISR.c"
void ISR_Gyro(void)
{
    IfxCpu_enableInterrupts();
 GetYawPitchRoll();
