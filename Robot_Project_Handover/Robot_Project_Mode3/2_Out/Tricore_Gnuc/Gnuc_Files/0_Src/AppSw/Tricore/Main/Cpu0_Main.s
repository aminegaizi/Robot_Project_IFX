...
.LVL40:
	.loc 1 114 0
	call	ISR_CurrentMeasurement_Config
.LVL41:
	.loc 1 115 0
	call	ISR_Gyro_Config
.LVL42:
	.loc 1 117 0
...
.L21:
	.loc 1 219 0
	movh.a	%a15, hi:FSM_RaspberrySTATE
	ld.w	%d15, [%a15] lo:FSM_RaspberrySTATE
	add	%d15, -1
	jlt.u	%d15, 7, .L48
	.loc 1 262 0
	mov	%d15, 0
	st.w	[%a15] lo:FSM_RaspberrySTATE, %d15
	ret
.L47:
	.loc 1 200 0
	movh.a	%a15, hi:.L23
...
.L29:
	.loc 1 245 0
	movh.a	%a12, hi:x_target
	lea	%a12, [%a12] lo:x_target
	mov.aa	%a4, %a12
	.loc 1 246 0
	movh.a	%a15, hi:y_target
	.loc 1 245 0
	call	atoi
.LVL45:
	.loc 1 246 0
	lea	%a15, [%a15] lo:y_target
	.loc 1 245 0
	movh.a	%a13, hi:x_coord_target
	.loc 1 246 0
	mov.aa	%a4, %a15
	.loc 1 245 0
	st.w	[%a13] lo:x_coord_target, %d2
	.loc 1 246 0
	call	atoi
.LVL46:
	movh.a	%a2, hi:y_coord_target
	st.w	[%a2] lo:y_coord_target, %d2
	.loc 1 248 0
	movh.a	%a2, hi:enable_read
	ld.bu	%d15, [%a2] lo:enable_read
	jz	%d15, .L36
	.loc 1 248 0 is_stmt 0 discriminator 1
	movh.a	%a3, hi:Gyro_stable
	ld.bu	%d15, [%a3] lo:Gyro_stable
	jz	%d15, .L36
.LBB8:
.LBB9:
	.loc 1 275 0 is_stmt 1
	ld.w	%d15, [%a13] lo:x_coord_target
	.loc 1 277 0
	movh.a	%a3, hi:Desired_position
	.loc 1 275 0
	lt	%d3, %d15, 31
	jnz	%d3, .L37
	.loc 1 277 0
	addi	%d15, %d15, 15
	itof	%d15, %d15
	st.w	[%a3] lo:Desired_position, %d15
.L38:
.LBE9:
.LBE8:
	.loc 1 253 0
...
.L34:
	.loc 1 240 0
	movh.a	%a2, hi:y_target
	movh.a	%a15, hi:i
	lea	%a2, [%a2] lo:y_target
.L46:
	ld.a	%a3, [%a15] lo:i
	.loc 1 241 0
	mov.d	%d15, %a3
...
.L33:
	.loc 1 232 0
	movh.a	%a2, hi:x_target
	movh.a	%a15, hi:i
	lea	%a2, [%a2] lo:x_target
	j	.L46
.L32:
	.loc 1 225 0
	mov	%d15, 1
	...
	.loc 1 225 0
	movh.a	%a15, hi:BEEP_ENA
	st.b	[%a15] lo:BEEP_ENA, %d15
	.loc 1 226 0
	ret
.LVL48:
.L37:
...
.section .text.Update_Object_Position,"ax",@progbits
	.align 1
	.global	Update_Object_Position
	.type	Update_Object_Position, @function
Update_Object_Position:
.LFB644:
	.loc 1 273 0
	.loc 1 275 0
	movh.a	%a15, hi:x_coord_target
	ld.w	%d15, [%a15] lo:x_coord_target
	.loc 1 277 0
	movh.a	%a15, hi:Desired_position
	.loc 1 275 0
	lt	%d2, %d15, 31
	jz	%d2, .L52
	.loc 1 280 0
	...
	movh.a	%a2, hi:y_coord_target
	.loc 1 280 0
	st.w	[%a15] lo:Desired_position, %d15
	.loc 1 282 0
	ld.w	%d15, [%a2] lo:y_coord_target
	lea	%a15, [%a15] lo:Desired_position
	itof	%d15, %d15
	st.w	[%a15] 4, %d15
	ret
.L52:
	...
	ret
.LFE644:
	.size	Update_Object_Position, .-Update_Object_Position
.section .text.Save_Object_Position,"ax",@progbits
	.align 1
	.global	Save_Object_Position
	.type	Save_Object_Position, @function
Save_Object_Position:
.LFB645:
	.loc 1 295 0
	.loc 1 296 0
	movh.a	%a15, hi:position
	ld.w	%d15, [%a15] lo:position
	movh.a	%a3, hi:Objects_Positions_X
	sh	%d15, 2
	lea	%a3, [%a3] lo:Objects_Positions_X
	movh.a	%a2, hi:Current_position
	addsc.a	%a3, %a3, %d15, 0
	ld.w	%d2, [%a2] lo:Current_position
	lea	%a15, [%a2] lo:Current_position
	.loc 1 297 0
	movh.a	%a2, hi:Objects_Positions_Y
	.loc 1 296 0
	st.w	[%a3]0, %d2
	.loc 1 297 0
	lea	%a2, [%a2] lo:Objects_Positions_Y
	ld.w	%d2, [%a15] 4
	.loc 1 298 0
	movh.a	%a15, hi:Objects_Positions_Zones
	.loc 1 297 0
	addsc.a	%a2, %a2, %d15, 0
	.loc 1 298 0
	lea	%a15, [%a15] lo:Objects_Positions_Zones
...
.LVL49:
	...
	ret
.LFE645:
	.size	Save_Object_Position, .-Save_Object_Position
	.global	position
...
i:
	.zero	4
	.global	y_target
.section .bss.y_target,"aw",@nobits
	.type	y_target, @object
	.size	y_target, 4
y_target:
	.zero	4
	.global	x_target
.section .bss.x_target,"aw",@nobits
	.type	x_target, @object
	.size	x_target, 4
x_target:
	.zero	4
	.global	FSM_RaspberrySTATE
.section .bss.FSM_RaspberrySTATE,"aw",@nobits
	.align 2
	.type	FSM_RaspberrySTATE, @object
	.size	FSM_RaspberrySTATE, 4
FSM_RaspberrySTATE:
	.zero	4
	.global	BEEP_ENA
.section .bss.BEEP_ENA,"aw",@nobits
	.type	BEEP_ENA, @object
	.size	BEEP_ENA, 1
BEEP_ENA:
	.zero	1
	.global	enable_read
.section .data.enable_read,"aw",@progbits
	.type	enable_read, @object
	.size	enable_read, 1
enable_read:
	.byte	1
	.global	Objects_Positions_Zones
.section .bss.Objects_Positions_Zones,"aw",@nobits
	.align 2
	.type	Objects_Positions_Zones, @object
	.size	Objects_Positions_Zones, 28
Objects_Positions_Zones:
	.zero	28
	.global	Objects_Positions_Y
.section .bss.Objects_Positions_Y,"aw",@nobits
	.align 2
	.type	Objects_Positions_Y, @object
	.size	Objects_Positions_Y, 28
Objects_Positions_Y:
	.zero	28
	.global	Objects_Positions_X
.section .bss.Objects_Positions_X,"aw",@nobits
	.align 2
	.type	Objects_Positions_X, @object
	.size	Objects_Positions_X, 28
Objects_Positions_X:
	.zero	28
	.global	y_coord_target
.section .bss.y_coord_target,"aw",@nobits
	.align 2
	.type	y_coord_target, @object
	.size	y_coord_target, 4
y_coord_target:
	.zero	4
	.global	x_coord_target
.section .bss.x_coord_target,"aw",@nobits
	.align 2
	.type	x_coord_target, @object
	.size	x_coord_target, 4
x_coord_target:
	.zero	4
	.global	object_detect
.section .data.object_detect,"aw",@progbits
...
.Letext0:
	...
	.file 8 "0_Src/BaseSw/iLLD/TC29B/Tricore/Stm/Std/IfxStm.h"
	...
	.file 12 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h"
	.file 13 "0_Src/AppSw/Tricore/Position/position.h"
	.file 14 "0_Src/AppSw/Tricore/Enslavement/Enslavement.h"
	.file 15 "0_Src/AppSw/Tricore/Motors/Motors.h"
	.file 16 "0_Src/AppSw/Tricore/Tft_Screen/Tft.h"
	.file 17 "0_Src/AppSw/Tricore/Timer/GTM_ISR.h"
	.file 18 "0_Src/BaseSw/iLLD/TC29B/Tricore/Scu/Std/IfxScuWdt.h"
	.file 19 "0_Src/AppSw/Tricore/ResetReason/Reset_reason.h"
	.file 20 "0_Src/BaseSw/Service/CpuGeneric/SysSe/Bsp/Bsp.h"
	.file 21 "0_Src/AppSw/Tricore/PWM/PWM_config.h"
	.file 22 "0_Src/AppSw/Tricore/Gyroscope/Gyroscope_i2c.h"
	.file 23 "0_Src/AppSw/Tricore/Encoders/encoders_config.h"
	.file 24 "0_Src/AppSw/Tricore/Servomotor/servomotor.h"
	.file 25 "0_Src/AppSw/Tricore/Ultrasonic_sensor/ultrasonic_sensor.h"
	.file 26 "0_Src/AppSw/Tricore/Serial/serial.h"
	.file 27 "0_Src/AppSw/Tricore/Serial/serial_Raspberry.h"
	.file 28 "0_Src/AppSw/Tricore/VADC/VADC.h"
	.file 29 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-2.0\\tricore\\include\\stdlib.h"
	.file 30 "0_Src/AppSw/Tricore/Mapping/Mapping.h"
	.file 31 "0_Src/AppSw/Tricore/Tft_Screen/IFX_logo.h"
...
.Ldebug_info0:
	...
	.uaword	0x1eb42
	.uleb128 0xd
	.string	"Raspberry_State_WAIT"
	.sleb128 0
	.uleb128 0xd
	.string	"Raspberry_State_LABEL_temp"
	.sleb128 1
	.uleb128 0xd
	.string	"Raspberry_State_LABEL"
	.sleb128 2
	.uleb128 0xd
	.string	"Raspberry_State_DISTANCEx_temp"
	.sleb128 3
	.uleb128 0xd
	.string	"Raspberry_State_DISTANCEx"
	.sleb128 4
	.uleb128 0xd
	.string	"Raspberry_State_DISTANCEy_temp"
	.sleb128 5
	.uleb128 0xd
	.string	"Raspberry_State_DISTANCEy"
	.sleb128 6
	.uleb128 0xd
	.string	"Raspberry_State_LOAD"
	.sleb128 7
	.byte	0
	.uleb128 0x24
	...
	.byte	0x5
	.byte	0x3
	.uaword	x_coord_target
	.uleb128 0x37
	.string	"y_coord_target"
	.byte	0x1
	.byte	0x2e
	.uaword	0x18b
	.byte	0x1
	...
	.byte	0x5
	.byte	0x3
	.uaword	Objects_Positions_X
	.uleb128 0x37
	.string	"Objects_Positions_Y"
	.byte	0x1
	.byte	0x30
	.uaword	0x1f04a
	.byte	0x1
	...
	.byte	0
	.uleb128 0x37
	.string	"Objects_Positions_Zones"
	.byte	0x1
	.byte	0x31
	.uaword	0x1f09e
	.byte	0x1
	.byte	0x5
	.byte	0x3
	.uaword	Objects_Positions_Zones
	.uleb128 0x37
	.string	"enable_read"
	.byte	0x1
	.byte	0x32
	...
	.uleb128 0x3a
	.byte	0x1
	.string	"ISR_CurrentMeasurement_Config"
	.byte	0x11
	.byte	0x1d
	.byte	0x1
	.byte	0x1
...
.LASF127:
	.string	"DID_EN11"
	.extern	ZoneDivider,STT_FUNC,0
	.extern	Current_position,STT_OBJECT,12
	.extern	FSM_AurixSTATE,STT_OBJECT,4
	.extern	Desired_position,STT_OBJECT,12
	.extern	Gyro_stable,STT_OBJECT,1
	.extern	atoi,STT_FUNC,0
	.extern	VadcAutoScanDemo_init,STT_FUNC,0
	.extern	ISR_Gyro_Config,STT_FUNC,0
	.extern	ISR_CurrentMeasurement_Config,STT_FUNC,0
