# 1 "0_Src/AppSw/Tricore/VADC/VADC.c"
# 1 "C:\\Robot_Project_Handover\\Robot_Project_Mode3//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/VADC/VADC.c"
# 9 "0_Src/AppSw/Tricore/VADC/VADC.c"
...
# 10 "0_Src/AppSw/Tricore/VADC/VADC.c" 2
...
# 11 "0_Src/AppSw/Tricore/VADC/VADC.c" 2
...
# 12 "0_Src/AppSw/Tricore/VADC/VADC.c" 2
...
float I = 0.0f;
float I_1,I_2 = 0.0f;
# 28 "0_Src/AppSw/Tricore/VADC/VADC.c"
void VadcAutoScanDemo_init(void)
{
    ...
    IfxVadc_Adc_initModuleConfig(&adcConfig, &(*(Ifx_VADC*)0xF0020000u));
    ...
    adcGroupConfig.arbiter.requestSlotScanEnabled = 1;


    adcGroupConfig.scanRequest.autoscanEnabled = 1;
...
# 69 "0_Src/AppSw/Tricore/VADC/VADC.c"
void VadcAutoScanDemo_run(void)
{
 ...
 float G_nonInverseur2 = (1 + 82/1.2);

    {
        ...
        ADC1 = (((float) ((*(volatile Ifx_VADC_G_RES*)0xF0020700u)).B.RESULT*5)/4095);
        I_1 = fabs(((ADC1)/(G_nonInverseur1*DivBridge1*Rshunt))-0.1);



        ADC2 = (((float) ((*(volatile Ifx_VADC_G_RES*)0xF0020708u)).B.RESULT*5)/4095);
        I_2 = fabs(((ADC2)/(G_nonInverseur2*DivBridge2*Rshunt))-0.2);
