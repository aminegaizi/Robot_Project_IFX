# 1 "0_Src/AppSw/Tricore/Gyroscope/Madgwick.c"
# 1 "C:\\Robot_Project_Handover\\Robot_Project_Mode3//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/Gyroscope/Madgwick.c"
# 9 "0_Src/AppSw/Tricore/Gyroscope/Madgwick.c"
# 1 "0_Src/AppSw/Tricore/Gyroscope/Madgwick.h" 1
# 11 "0_Src/AppSw/Tricore/Gyroscope/Madgwick.h"
...
# 12 "0_Src/AppSw/Tricore/Gyroscope/Madgwick.h" 2
...
# 10 "0_Src/AppSw/Tricore/Gyroscope/Madgwick.c" 2
# 43 "0_Src/AppSw/Tricore/Gyroscope/Madgwick.c"
...
void Madgwick_init() {
  ...
  gyc=0.0f;
  gzc=0.0f;
# 85 "0_Src/AppSw/Tricore/Gyroscope/Madgwick.c"
  invSampleFreq = 1.0f / 512.0f;
  anglesComputed = 0;
  Madgwick_begin(100.0f);
}
...
void Madgwick_update(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz) {
    ...
    if(!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f))) {
        ...
        recipNorm = Madgwick_invSqrt(s0 * s0 + s1 * s1 + s2 * s2 + s3 * s3);
        s0 *= recipNorm;
        s1 *= recipNorm;
        s2 *= recipNorm;
        s3 *= recipNorm;
...
# 242 "0_Src/AppSw/Tricore/Gyroscope/Madgwick.c"
    if((mx == 0.0f) && (my == 0.0f) && (mz == 0.0f)) {
        Madgwick_updateIMU(gx, gy, gz, ax, ay, az);
            return;
    }
