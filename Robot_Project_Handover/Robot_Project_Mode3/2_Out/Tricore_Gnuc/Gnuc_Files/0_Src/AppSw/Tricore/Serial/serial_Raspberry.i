# 1 "0_Src/AppSw/Tricore/Serial/serial_Raspberry.c"
# 1 "C:\\Robot_Project_Handover\\Robot_Project_Mode3//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "0_Src/AppSw/Tricore/Serial/serial_Raspberry.c"
# 9 "0_Src/AppSw/Tricore/Serial/serial_Raspberry.c"
...
# 7 "0_Src/AppSw/Tricore/Serial/serial_Raspberry.h" 2
...
# 8 "0_Src/AppSw/Tricore/Serial/serial_Raspberry.h" 2
...
# 44 "0_Src/BaseSw/iLLD/TC29B/Tricore/Cpu/Irq/IfxCpu_Irq.h" 2
...
# 9 "0_Src/AppSw/Tricore/Serial/serial_Raspberry.h" 2
...
# 13 "0_Src/AppSw/Tricore/Serial/serial_Raspberry.h" 2
...
# 22 "0_Src/AppSw/Tricore/Encoders/encoders_config.h"
# 1 "0_Src/BaseSw/Infra/Sfr/TC29B/_Reg/IfxSrc_regdef.h" 1
...
# 1 "0_Src/BaseSw/iLLD/TC29B/Tricore/Port/Std/IfxPort.h" 1
# 16 "0_Src/AppSw/Tricore/Servomotor/servomotor.h" 2
# 1 "0_Src/AppSw/CpuGeneric/Config/Config_ISR.h" 1
...
# 21 "0_Src/AppSw/Tricore/Gyroscope/Gyroscope_i2c.h" 2
...
# 10 "0_Src/AppSw/Tricore/Serial/serial_Raspberry.c" 2

__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""serialTxISR_Raspberry"",""0"",""9" );extern void __attribute__ ((interrupt_handler)) serialTxISR_Raspberry(); void serialTxISR_Raspberry (void);
__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""serialRxISR_Raspberry"",""0"",""10" );extern void __attribute__ ((interrupt_handler)) serialRxISR_Raspberry(); void serialRxISR_Raspberry (void);
__asm__ (".ifndef .intr.entry.include                        \n" ".altmacro                                           \n" ".macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code \n" "	.pushsection .\\intEntryLabel,\"ax\",@progbits   \n" "	__\\intEntryLabel :                              \n" "		svlcx                                        \n" "		movh.a  %a14, hi:\\name                      \n" "		lea     %a14, [%a14]lo:\\name                \n" "		ji      %a14                                 \n" "	.popsection                                      \n" ".endm                                               \n" ".macro .int_entry.1 prio,vectabNum,u,name           \n" ".int_entry.2 intvec_tc\\vectabNum\\u\\prio,(name) # build the unique name \n" ".endm                                               \n" "                                                    \n" ".macro .intr.entry name,vectabNum,prio              \n" ".int_entry.1 %(prio),%(vectabNum),_,name # evaluate the priority and the cpu number \n" ".endm                                               \n" ".intr.entry.include:                                \n" ".endif                                              \n" ".intr.entry ""serialErISR_Raspberry"",""0"",""11" );extern void __attribute__ ((interrupt_handler)) serialErISR_Raspberry(); void serialErISR_Raspberry (void);
...
void serial_config_Raspberry() {
 ...
 IfxAsclin_Asc_initModuleConfig(&ascConfig, IfxAsclin3_RXA_P15_7_IN.module);
 ...
 ascConfig.interrupt.txPriority = 9;
 ascConfig.interrupt.rxPriority = 10;
 ascConfig.interrupt.erPriority = 11;
 ascConfig.interrupt.typeOfService = IfxCpu_Irq_getTos(IfxSrc_Tos_cpu2);
 ...
 const IfxAsclin_Asc_Pins pins = {
  ...
  &IfxAsclin3_RXA_P15_7_IN, IfxPort_InputMode_pullUp,
  ((void *)0), IfxPort_OutputMode_pushPull,
  &IfxAsclin3_TX_P15_6_OUT, IfxPort_OutputMode_pushPull,
...
void serialRxISR_Raspberry() {
 message_Rasp=(char) (*(volatile Ifx_ASCLIN_RXDATA*)0xF0000948u).U;
