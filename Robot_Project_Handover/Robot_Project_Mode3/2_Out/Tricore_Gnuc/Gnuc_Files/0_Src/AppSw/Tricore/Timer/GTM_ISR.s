...
.intr.entry.include:                                
.endif                                              
.intr.entry ISR_CurrentMeasurement,0,15
	.ifndef .intr.entry.include                        
.altmacro                                           
.macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code 
	.pushsection .\intEntryLabel,"ax",@progbits   
...
.intr.entry.include:                                
.endif                                              
.intr.entry ISR_ObstacleAvoidance,0,16
	.ifndef .intr.entry.include                        
.altmacro                                           
.macro .int_entry.2 intEntryLabel, name # define the section and inttab entry code 
	.pushsection .\intEntryLabel,"ax",@progbits   
...
.LC2:
	.string	"READY"
#NO_APP
.section .text.ISR_CurrentMeasurement,"ax",@progbits
	.align 1
	.global	ISR_CurrentMeasurement
	.type	ISR_CurrentMeasurement, @function
ISR_CurrentMeasurement:
.LFB639:
	.file 1 "0_Src/AppSw/Tricore/Timer/GTM_ISR.c"
	.loc 1 37 0
	sub.a	%SP, 32
.LCFI0:
.LBB8:
...
.LBE8:
	...
	movh.a	%a12, hi:I
	.loc 1 41 0
	call	VadcAutoScanDemo_run
.LVL0:
	.loc 1 43 0
	ld.w	%d4, [%a12] lo:I
	.loc 1 46 0
	movh.a	%a15, hi:energy
	.loc 1 43 0
	call	__extendsfdf2
.LVL1:
	movh.a	%a5, hi:.LC0
...
.LVL3:
	.loc 1 46 0
	ld.w	%d4, [%a15] lo:energy
	.loc 1 50 0
	movh.a	%a13, hi:Gyro_stable
	.loc 1 46 0
	call	__extendsfdf2
.LVL4:
	ld.w	%d4, [%a12] lo:I
...
.LVL12:
	.loc 1 50 0
	ld.bu	%d15, [%a13] lo:Gyro_stable
	jnz	%d15, .L2
	.loc 1 52 0
	movh.a	%a12, hi:Yaw_initvalue
	ld.w	%d4, [%a12] lo:Yaw_initvalue
	movh.a	%a15, hi:YPR
	call	__extendsfdf2
.LVL13:
	mov	%e4, %d3, %d2
...
.L3:
	.loc 1 60 0
	ld.w	%d15, [%a15] lo:YPR
	st.w	[%a12] lo:Yaw_initvalue, %d15
	.loc 1 61 0
	ld.w	%d15, [%a15] lo:YPR
	movh.a	%a15, hi:Yaw_Absinit
	ftouz	%d15, %d15
	st.b	[%a15] lo:Yaw_Absinit, %d15
.L2:
	.loc 1 65 0
	call	beep
.LVL17:
...
.LVL19:
	.loc 1 69 0
	movh.a	%a4, hi:timerCurrentMeasurement
	lea	%a4, [%a4] lo:timerCurrentMeasurement
	call	IfxGtm_Atom_Timer_acknowledgeTimerIrq
.LVL20:
	rslcx
	rfe
.L9:
...
.LVL23:
	...
	lea	%a4, [%a4] lo:.LC2
	.loc 1 54 0
	st.b	[%a13] lo:Gyro_stable, %d15
	.loc 1 55 0
	call	GLCD_displayStringLn
.LVL24:
	j	.L2
.LFE639:
	.size	ISR_CurrentMeasurement, .-ISR_CurrentMeasurement
.section .text.ISR_CurrentMeasurement_Config,"ax",@progbits
	.align 1
	.global	ISR_CurrentMeasurement_Config
	.type	ISR_CurrentMeasurement_Config, @function
...
.LVL25:
	...
	mov	%d15, 15
	.loc 1 89 0
	movh.a	%a15, hi:timerCurrentMeasurement
	.loc 1 84 0
	st.w	[%SP] 12, %d2
	.loc 1 82 0
	st.h	[%SP] 8, %d15
	...
	mov	%d15, 0
	.loc 1 89 0
	lea	%a15, [%a15] lo:timerCurrentMeasurement
	mov.aa	%a4, %a15
	lea	%a5, [%SP] 4
	.loc 1 83 0
	st.b	[%SP] 10, %d15
...
.LVL27:
.LFE640:
	.size	ISR_CurrentMeasurement_Config, .-ISR_CurrentMeasurement_Config
	.global	__fixunsdfdi
	.global	__floatundidf
	.global	__gedf2
	.global	__ledf2
.section .text.ISR_ObstacleAvoidance,"ax",@progbits
	.align 1
	.global	ISR_ObstacleAvoidance
	.type	ISR_ObstacleAvoidance, @function
ISR_ObstacleAvoidance:
.LFB641:
	.loc 1 101 0
	sub.a	%SP, 8
.LCFI2:
...
.LBE10:
	.loc 1 103 0
	mov	%e2, 0
	movh.a	%a15, hi:distance_obstacle
	lea	%a15, [%a15] lo:distance_obstacle
	st.d	[%SP]0, %e2
	.loc 1 104 0
	call	returnDistance
.LVL28:
...
.LVL44:
	...
	rfe
.LFE641:
	.size	ISR_ObstacleAvoidance, .-ISR_ObstacleAvoidance
.section .text.ISR_ObstacleAvoidance_Config,"ax",@progbits
	.align 1
	.global	ISR_ObstacleAvoidance_Config
	.type	ISR_ObstacleAvoidance_Config, @function
...
.LVL45:
	...
	mov	%d15, 16
	.loc 1 141 0
	movh.a	%a15, hi:timerObstacleAvoidance
	.loc 1 136 0
	st.w	[%SP] 12, %d2
	.loc 1 134 0
	st.h	[%SP] 8, %d15
	...
	mov	%d15, 0
	.loc 1 141 0
	lea	%a15, [%a15] lo:timerObstacleAvoidance
	mov.aa	%a4, %a15
	lea	%a5, [%SP] 4
	.loc 1 135 0
	st.b	[%SP] 10, %d15
...
.LVL47:
.LFE642:
	.size	ISR_ObstacleAvoidance_Config, .-ISR_ObstacleAvoidance_Config
.section .text.ISR_Gyro_Config,"ax",@progbits
	.align 1
	.global	ISR_Gyro_Config
	.type	ISR_Gyro_Config, @function
ISR_Gyro_Config:
.LFB643:
	.loc 1 152 0
	sub.a	%SP, 56
...
.LVL50:
.LFE643:
	.size	ISR_Gyro_Config, .-ISR_Gyro_Config
.section .text.ISR_Gyro,"ax",@progbits
	.align 1
	.global	ISR_Gyro
	.type	ISR_Gyro, @function
ISR_Gyro:
.LFB644:
	.loc 1 177 0
.LBB12:
...
.LVL51:
	.loc 1 180 0
	movh.a	%a4, hi:timerGyro
	lea	%a4, [%a4] lo:timerGyro
	call	IfxGtm_Atom_Timer_acknowledgeTimerIrq
.LVL52:
	rslcx
	rfe
.LFE644:
	.size	ISR_Gyro, .-ISR_Gyro
	.global	Gyro_stable
.section .bss.Gyro_stable,"aw",@nobits
	.type	Gyro_stable, @object
	.size	Gyro_stable, 1
Gyro_stable:
	.zero	1
	.global	Yaw_Absinit
.section .bss.Yaw_Absinit,"aw",@nobits
	.type	Yaw_Absinit, @object
	.size	Yaw_Absinit, 1
Yaw_Absinit:
	.zero	1
	.global	Yaw_initvalue
.section .bss.Yaw_initvalue,"aw",@nobits
	.align 2
	.type	Yaw_initvalue, @object
	.size	Yaw_initvalue, 4
Yaw_initvalue:
	.zero	4
	.global	energy
.section .bss.energy,"aw",@nobits
	.align 2
	.type	energy, @object
	.size	energy, 4
energy:
	.zero	4
	.global	timerObstacleAvoidance
.section .bss.timerObstacleAvoidance,"aw",@nobits
	.align 2
	.type	timerObstacleAvoidance, @object
	.size	timerObstacleAvoidance, 48
timerObstacleAvoidance:
	.zero	48
	.global	timerGyro
.section .bss.timerGyro,"aw",@nobits
	.align 2
	.type	timerGyro, @object
	.size	timerGyro, 48
timerGyro:
	.zero	48
	.global	timerCurrentMeasurement
.section .bss.timerCurrentMeasurement,"aw",@nobits
	.align 2
	.type	timerCurrentMeasurement, @object
	.size	timerCurrentMeasurement, 48
...
.Letext0:
	...
	.file 15 "0_Src/BaseSw/iLLD/TC29B/Tricore/Gtm/Atom/Timer/IfxGtm_Atom_Timer.h"
	.file 16 "0_Src/AppSw/Tricore/Gyroscope/Gyroscope_i2c.h"
	.file 17 "0_Src/AppSw/Tricore/Tft_Screen/IFX_logo.h"
	.file 18 "0_Src/BaseSw/iLLD/TC29B/Tricore/_Impl/IfxCpu_cfg.h"
	.file 19 "0_Src/BaseSw/iLLD/TC29B/Tricore/_PinMap/IfxPort_pinMap.h"
	.file 20 "0_Src/AppSw/Tricore/VADC/VADC.h"
	.file 21 "0_Src/AppSw/Tricore/Beeper/Beeper.h"
	.file 22 "0_Src/AppSw/Tricore/Position/position.h"
	.file 23 "c:\\hightec\\toolchains\\tricore\\v4.9.1.0-infineon-2.0\\tricore\\include\\stdio.h"
	.file 24 "0_Src/AppSw/Tricore/Tft_Screen/Tft.h"
	.file 25 "0_Src/AppSw/Tricore/Ultrasonic_sensor/ultrasonic_sensor.h"
	.file 26 "0_Src/AppSw/Tricore/Motors/Motors.h"
...
.Ldebug_info0:
	...
	.byte	0x1
	.string	"0_Src/AppSw/Tricore/Timer/GTM_ISR.c"
	...
	.byte	0x5
	.byte	0x3
	.uaword	timerCurrentMeasurement
	.byte	0
	.uleb128 0x2a
	.uaword	.LVL24
	.uaword	0x23511
	...
	.uaword	0x26a
	.uleb128 0x30
	.string	"timerCurrentMeasurement"
	.byte	0x1
	.byte	0xc
	.uaword	0x1f9d9
	.byte	0x1
...
.LASF129:
	...
	.extern	distance_obstacle,STT_OBJECT,8
	...
	.extern	IfxGtm_Atom_Timer_acknowledgeTimerIrq,STT_FUNC,0
	.extern	Find_error,STT_FUNC,0
	.extern	position_data,STT_FUNC,0
	.extern	beep,STT_FUNC,0
	.extern	YPR,STT_OBJECT,12
	.extern	GLCD_displayStringLn,STT_FUNC,0
	.extern	snprintf,STT_FUNC,0
	.extern	VadcAutoScanDemo_run,STT_FUNC,0
	.extern	I,STT_OBJECT,4
