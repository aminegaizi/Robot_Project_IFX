# 1 "0_Src/AppSw/Tricore/Encoders/Encoders_config.c"
...
void ISR_ENCODER_L();
void ISR_ENCODER_R();
# 9 "0_Src/AppSw/Tricore/Encoders/Encoders_config.c" 2
...
int positionRwheel = 0;
int positionLwheel = 0;
...
void Encoders_config()
{
 ...
 IfxSrc_init(src, IfxCpu_Irq_getTos(IfxCpu_getCoreId()), 2);
 IfxSrc_enable(src);
