...
void Init_Mag_AK8963(uint8 Adc_type){
 ...
 Mpu.temp_scale_factor=((float)333.87);
}
...
void GetGyro()
{
 ...
 float data[3];
 for(i = 0; i < 3; i++) {
   Read_I2C_Register(&I2C_Masters_Slaves.drivers.i2cDev_Gyro_Accel,0x43 +2*i,2);
...
void GetAccel()
{
 ...
 float data[3];
 for(i = 0; i < 3; i++) {
   Read_I2C_Register(&I2C_Masters_Slaves.drivers.i2cDev_Gyro_Accel,0x3B +2*i,2);
         bit_data = ((sint16)I2C_Masters_Slaves.i2cBuffer.i2cRxBuffer[0]<<8)|(sint16)I2C_Masters_Slaves.i2cBuffer.i2cRxBuffer[1];
         data[i] = (float)bit_data;
     }
...
void GetMag()
{
 ...
 float data[3];
 for(i = 0; i < 3; i++) {
   Read_I2C_Register(&I2C_Masters_Slaves.drivers.i2cDev_Mag,0x03 +2*i,2);
   bit_data = ((sint16)I2C_Masters_Slaves.i2cBuffer.i2cRxBuffer[0]<<8)|(sint16)I2C_Masters_Slaves.i2cBuffer.i2cRxBuffer[1];
   data[i] = (float)bit_data;
  }
