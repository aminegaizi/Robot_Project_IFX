...
{
    return (Ifx_SRC_SRCR *const)(&MODULE_SRC.ASCLIN.ASCLIN[IfxAsclin_getIndex(asclin)].ERR);
}


volatile Ifx_SRC_SRCR *const IfxAsclin_getSrcPointerRx(Ifx_ASCLIN *asclin)
{
    return (Ifx_SRC_SRCR *const)(&MODULE_SRC.ASCLIN.ASCLIN[IfxAsclin_getIndex(asclin)].RX);
}


volatile Ifx_SRC_SRCR *const IfxAsclin_getSrcPointerTx(Ifx_ASCLIN *asclin)
{
    return (Ifx_SRC_SRCR *const)(&MODULE_SRC.ASCLIN.ASCLIN[IfxAsclin_getIndex(asclin)].TX);
}
